...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/en/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
| passport | Authentication using “strategies” such as OAuth, OpenID and many others.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/en/resources/utils.md          )
...
For more details about routing, see the [routing guide](https://expressjs.com/en/guide/routing.html).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/en/starter/basic-routing.md          )
