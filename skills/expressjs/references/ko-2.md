...
> Express.js 4.x의 API 레퍼런스를 확인하여, 이 버전으로 웹 애플리케이션을 구축할 때 사용할 수 있는 모든 모듈, 메서드, 속성에 대해 자세히 알아봅니다.
...
and [Using middleware - Built-in middleware](https://expressjs.com/ko/guide/using-middleware.html#middleware.built-in).
...
For more information, see the [routing guide](https://expressjs.com/ko/guide/routing.html).
...
For more information on routing, see the [routing guide](https://expressjs.com/ko/guide/routing.html).

### app.param([name], callback)

Add callback triggers to [route parameters](https://expressjs.com/ko/guide/routing.html#route-parameters), where `name` is the name of the parameter or an array of them, and `callback` is the callback function. The parameters of the callback function are the request object, the response object, the next middleware, the value of the parameter and the name of the parameter, in that order.
...
Read [Express behind proxies](https://expressjs.com/ko/guide/behind-proxies.html) for more
  information.
...
Mounts the specified [middleware](https://expressjs.com/ko/guide/using-middleware.html) function or functions
...
Following are some examples of using the [express.static](https://expressjs.com/ko/guide/using-middleware.html#middleware.built-in)
...
using [app.set](https://expressjs.com/ko/4x/api.html#app.set).
