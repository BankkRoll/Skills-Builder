# 撰寫中介軟體以用於 Express 應用程式中 and more
...
*Middleware* functions are functions that have access to the [request object](https://expressjs.com/zh-tw/5x/api.html#req) (`req`), the [response object](https://expressjs.com/zh-tw/5x/api.html#res) (`res`), and the `next` function in the application’s request-response cycle. The `next` function is a function in the Express router which, when invoked, executes the middleware succeeding the current middleware.
...
|  | HTTP method for which the middleware function applies.</tbody>Path (route) for which the middleware function applies.The middleware function.中介軟體函數的回呼引數，依慣例，稱為 "next"。HTTPresponseargument to the middleware function, called "res" by convention.HTTPrequestargument to the middleware function, called "req" by convention. |
| --- | --- |

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/zh-tw/guide/writing-middleware.md          )
...
我們的熱情活躍的社群已建立各式各樣的延伸項目、[中介軟體模組](https://expressjs.com/zh-tw/resources/middleware.html)，以及更高層次的架構。相關資訊請參閱 [Wiki](https://github.com/expressjs/express/wiki)。

Additionally, the Express community maintains modules in these two GitHub orgs:

- [jshttp](https://github.com/jshttp) modules providing useful utility functions; see [Utility modules](https://expressjs.com/zh-tw/resources/utils.html).
...
### Logomark
       ...
       [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/zh-tw/resources/community.md          )
...
The Express technical committee consists of active project members, and guides development and maintenance of the Express project. For more information, see [Express Community - Technical committee](https://expressjs.com/zh-tw/resources/community.html#technical-committee).
...
3. [Start translating](https://support.crowdin.com/online-editor/)
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/zh-tw/resources/contributing.md          )
...
In general, one or more programs that are designed to carry out operations for a specific purpose.  通常是指設計成實行作業以達特定目的的一或多個程式。就 Express 環境定義來說，是指使用 Express API（在 Node.js 平台上執行）的程式。亦可稱為[應用程式物件 (app object)](https://expressjs.com/zh-tw/api.html#express)。  Might also refer to an [app object](https://expressjs.com/zh-tw/api.html#express).
...
請參閱 API 參照中的[路由器](https://expressjs.com/zh-tw/4x/api.html#router)。

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/zh-tw/resources/glossary.md          )
