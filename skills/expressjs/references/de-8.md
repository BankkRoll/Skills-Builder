...
The [Express application generator](https://expressjs.com/de/starter/generator.html) uses [Pug](https://pugjs.org/api/getting-started.html) as its default, but it also supports [Handlebars](https://www.npmjs.com/package/handlebars), and [EJS](https://www.npmjs.com/package/ejs), among others.

To render template files, set the following [application setting properties](https://expressjs.com/de/4x/api.html#app.set), in the default `app.js` created by the generator:
...
The view engine cache does not cache the contents of the template’s output, only the underlying template itself. The view is still re-rendered with every request even when the cache is on.
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/de/guide/using-template-engines.md          )

---

# Middleware für die Verwendung in Express
...
*Middleware* functions are functions that have access to the [request object](https://expressjs.com/de/5x/api.html#req) (`req`), the [response object](https://expressjs.com/de/5x/api.html#res) (`res`), and the `next` function in the application’s request-response cycle. Die nächste Middlewarefunktion wird im Allgemeinen durch die Variable `next` bezeichnet.
...
|  | HTTP-Methode, für die die Middlewarefunktion angewendet wird.</tbody>Pfad (Weiterleitung), für den die Middlewarefunktion angewendet wird.Die Middlewarefunktion.Callback-Argument zur Middlewarefunktion, die nach der geltenden Konvention als "next" bezeichnet wird.HTTPresponseargument to the middleware function, called "res" by convention.HTTPrequestargument to the middleware function, called "req" by convention. |
| --- | --- |

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/de/guide/writing-middleware.md          )
...
Unsere lebhafte Community hat zu einer Vielzahl von Erweiterungen, [Middlewaremodulen](https://expressjs.com/de/resources/middleware.html) und Frameworks der höheren Ebene geführt.

Additionally, the Express community maintains modules in these two GitHub orgs:

- [jshttp](https://github.com/jshttp) modules providing useful utility functions; see [Utility modules](https://expressjs.com/de/resources/utils.html).
...
### Logomark
       ...
       [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/de/resources/community.md          )
...
The Express technical committee consists of active project members, and guides development and maintenance of the Express project. For more information, see [Express Community - Technical committee](https://expressjs.com/de/resources/community.html#technical-committee).
...
3. [Start translating](https://support.crowdin.com/online-editor/)
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/de/resources/contributing.md          )
...
Siehe [Router](https://expressjs.com/de/4x/api.html#router) in der API-Referenz.

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/de/resources/glossary.md          )
