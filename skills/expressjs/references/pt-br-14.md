...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/pt-br/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
[MIT](https://expressjs.com/pt-br/resources/middleware/LICENSE)
...
> Explore uma lista de módulos de middleware Express.js mantidos pela equipe Express e pela comunidade, incluindo módulos de intermediários e de terceiros populares.
...
| cookie-parser | Analisar cabeçalho de cookie e preencherreq.cookies. Ver tambémcookies. |
...
| passport: módulo middleware do Express para autenticação. | Authentication using “strategies” such as OAuth, OpenID and many others.  Vejapassportjs.orgpara obter mais informações. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/pt-br/resources/utils.md          )
...
de um aplicativo, consulte o [exemplo Hello world](https://expressjs.com/pt-br/starter/hello-world.html).
...
Para obter mais detalhes sobre roteamento, consulte o [guia de roteamento](https://expressjs.com/pt-br/guide/routing.html).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/pt-br/starter/basic-routing.md          )
