...
and [Using middleware - Built-in middleware](https://expressjs.com/en/guide/using-middleware.html#middleware.built-in).
...
Read [Express behind proxies](https://expressjs.com/en/guide/behind-proxies.html) for more
  information.
...
Mounts the specified [middleware](https://expressjs.com/en/guide/using-middleware.html) function or functions
...
Following are some examples of using the [express.static](https://expressjs.com/en/guide/using-middleware.html#middleware.built-in)
...
using [app.set](https://expressjs.com/en/4x/api.html#app.set).
