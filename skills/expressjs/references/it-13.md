...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/it/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
[MIT](https://expressjs.com/it/resources/middleware/LICENSE)
...
| Middleware module | Descrizione |
| --- | --- |
| helmet: modulo che aiuta a proteggere le applicazioni impostando varie intestazioni HTTP. | Helps secure your apps by setting various HTTP headers. |
| passport: modulo middleware Express per l’autenticazione. | Authentication using “strategies” such as OAuth, OpenID and many others.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/it/resources/utils.md          )
...
Questo tutorial presume che un’istanza di `express` denominata `app` sia stata creata e che il server sia in esecuzione. Se non si è in grado di creare un’applicazione e avviarla, consultare la sezione [Esempio di Hello world](https://expressjs.com/it/starter/hello-world.html).
...
Per ulteriori dettagli sul routing, consultare il [Manuale routing](https://expressjs.com/it/guide/routing.html).

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/it/starter/basic-routing.md          )
