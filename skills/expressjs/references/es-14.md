...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/es/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
[MIT](https://expressjs.com/es/resources/middleware/LICENSE)
...
| express-slash: módulo de middleware de Express para aquellos que son estrictos sobre las barras inclinadas finales. | Description |
| --- | --- |
...
| express-slash: módulo de middleware de Express para aquellos que son estrictos sobre las barras inclinadas finales. | Description |
| --- | --- |
| helmet: módulo para ayudar a proteger las aplicaciones estableciendo varias cabeceras HTTP. | Helps secure your apps by setting various HTTP headers. |
| passport: módulo de middleware de Express para la autenticación. | Authentication using “strategies” such as OAuth, OpenID and many others.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/es/resources/utils.md          )
...
En esta guía de aprendizaje se supone que se crea una instancia de `express` denominada `app` y que el servidor está en ejecución. Si no está familiarizado con la creación y el inicio de una aplicación, consulte el [Ejemplo Hello world](https://expressjs.com/es/starter/hello-world.html).
...
Para obtener más detalles sobre el direccionamiento, consulte la [guía de direccionamiento](https://expressjs.com/es/guide/routing.html).

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/es/starter/basic-routing.md          )
