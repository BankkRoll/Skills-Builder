...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/fr/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
| passport: module de middleware Express dédié à l’authentification. | Authentication using “strategies” such as OAuth, OpenID and many others.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/fr/resources/utils.md          )
...
Ce tutoriel suppose qu’une instance d’`express` appelée `app` soit créée et que le serveur soit en cours d’exécution. Si vous ne savez pas créer et démarrer une application, reportez-vous à l’[exemple Hello world](https://expressjs.com/fr/starter/hello-world.html).
...
Pour plus de détails sur le routage, reportez-vous au [guide de routage](https://expressjs.com/fr/guide/routing.html).

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/fr/starter/basic-routing.md          )
