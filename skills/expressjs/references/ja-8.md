...
The Express technical committee consists of active project members, and guides development and maintenance of the Express project. For more information, see [Express Community - Technical committee](https://expressjs.com/ja/resources/community.html#technical-committee).
...
3. [Start translating](https://support.crowdin.com/online-editor/)
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/ja/resources/contributing.md          )
...
In general, one or more programs that are designed to carry out operations for a specific purpose.  一般に、特定の目的で操作を実行するよう設計された 1 つ以上のプログラム。Express のコンテキストでは、Node.js プラットフォームで稼働する Express API を使用するプログラム。[アプリケーション・オブジェクト](https://expressjs.com/ja/api.html#express)と呼ばれることもある。  Might also refer to an [app object](https://expressjs.com/ja/api.html#express).
...
API リファレンスで[ルーター](https://expressjs.com/ja/4x/api.html#router)を参照。

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/ja/resources/glossary.md          )
