...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/de/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
| passport: Express-Middlewaremodul für die Authentifizierung. | Authentication using “strategies” such as OAuth, OpenID and many others.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/de/resources/utils.md          )
...
In diesem Lernprogramm wird vorausgesetzt, dass eine Instanz von `express` namens `app` erstellt und der Server ausgeführt wird. Wenn Sie mit dem Erstellen und Starten von Anwendungen nicht vertraut sind, spielen Sie das [Beispiel “Hello World”](https://expressjs.com/de/starter/hello-world.html) durch.
...
Details zum Thema Routing finden Sie in der entsprechenden [Routinganleitung](https://expressjs.com/de/guide/routing.html).

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/de/starter/basic-routing.md          )
