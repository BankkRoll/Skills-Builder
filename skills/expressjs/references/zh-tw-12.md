...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/zh-tw/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
| Middleware module | Description |
| --- | --- |
| helmet：此模組會設定各種 HTTP 標頭，有助於保護您應用程式的安全。 | Helps secure your apps by setting various HTTP headers. |
| passport：鑑別用的 Express 中介軟體模組。 | Authentication using “strategies” such as OAuth, OpenID and many others.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/zh-tw/resources/utils.md          )
...
這項指導教學假設已建立名稱為 `app` 的 `express` 實例，且伺服器正在執行。如果您不熟悉如何建立和啟動應用程式，請參閱 [Hello world 範例](https://expressjs.com/zh-tw/starter/hello-world.html)。
...
如需路由的詳細資料，請參閱[路由手冊](https://expressjs.com/zh-tw/guide/routing.html)。

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/zh-tw/starter/basic-routing.md          )
