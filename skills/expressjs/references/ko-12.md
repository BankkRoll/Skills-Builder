...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/ko/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
| cookie-parser | 쿠키 헤더를 파싱하고req.cookies에 할당합니다. See alsocookies. |
...
| passport | OAuth, OpenID 같은 방법들을 사용하는 인증 체계입니다.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/ko/resources/utils.md          )
...
이 학습서에서는 `app`이라는 이름의 `express` 인스턴스가 작성되며 서버가 실행 중인 것으로 가정합니다. 앱의 작성 및 시작에 익숙하지 않은 경우에는 [Hello world 예제](https://expressjs.com/ko/starter/hello-world.html)를 참조하십시오.
...
라우팅에 대한 자세한 내용을 확인하려면 [라우팅 안내서](https://expressjs.com/ko/guide/routing.html)를 참조하십시오.

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/ko/starter/basic-routing.md          )
