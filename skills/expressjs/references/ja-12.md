...
Specifies the `boolean` value for the [PartitionedSet-Cookie](https://expressjs.com/ja/resources/middleware/rfc-cutler-httpbis-partitioned-cookies)
...
| passport: 認証のための Express ミドルウェア・モジュール。 | Authentication using “strategies” such as OAuth, OpenID and many others.  Seepassportjs.orgfor more information. |
...
For additional low-level HTTP-related modules, see [jshttp](http://jshttp.github.io/).
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/ja/resources/utils.md          )
...
このチュートリアルでは、`app` という名前の `express` のインスタンスが作成されていて、サーバーが稼働中であることを想定しています。アプリケーションの作成と開始に慣れていない場合は、[Hello World の例](https://expressjs.com/ja/starter/hello-world.html) を参照してください。
...
ルーティングについて詳しくは、[ルーティング・ガイド](https://expressjs.com/ja/guide/routing.html)を参照してください。

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/ja/starter/basic-routing.md          )
