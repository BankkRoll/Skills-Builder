...
and [Using middleware - Built-in middleware](https://expressjs.com/fr/guide/using-middleware.html#middleware.built-in).
...
For more information, see the [routing guide](https://expressjs.com/fr/guide/routing.html).
...
For more information on routing, see the [routing guide](https://expressjs.com/fr/guide/routing.html).

### app.param([name], callback)

Add callback triggers to [route parameters](https://expressjs.com/fr/guide/routing.html#route-parameters), where `name` is the name of the parameter or an array of them, and `callback` is the callback function. The parameters of the callback function are the request object, the response object, the next middleware, the value of the parameter and the name of the parameter, in that order.
...
Read [Express behind proxies](https://expressjs.com/fr/guide/behind-proxies.html) for more
  information.
...
Mounts the specified [middleware](https://expressjs.com/fr/guide/using-middleware.html) function or functions
...
Following are some examples of using the [express.static](https://expressjs.com/fr/guide/using-middleware.html#middleware.built-in)
...
This property is an object containing properties mapped to the [named route “parameters”](https://expressjs.com/fr/guide/routing.html#route-parameters). For example, if you have the route `/user/:name`, then the “name” property is available as `req.params.name`. This object defaults to `{}`.
...
If you need to make changes to a key in `req.params`, use the [app.param](https://expressjs.com/fr/4x/api.html#app.param) handler. Changes are applicable only to [parameters](https://expressjs.com/fr/guide/routing.html#route-parameters) already defined in the route path.
...
using [app.set](https://expressjs.com/fr/4x/api.html#app.set).
