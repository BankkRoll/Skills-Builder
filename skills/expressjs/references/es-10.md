...
The Express technical committee consists of active project members, and guides development and maintenance of the Express project. For more information, see [Express Community - Technical committee](https://expressjs.com/es/resources/community.html#technical-committee).
...
3. [Start translating](https://support.crowdin.com/online-editor/)
  ...
  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/es/resources/contributing.md          )
...
### ConsulteOpen source software en la Wikipedia.
...
Consulte [direccionador](https://expressjs.com/es/4x/api.html#router) en la referencia de API.

  [Edit this page](https://github.com/expressjs/expressjs.com/edit/gh-pages/es/resources/glossary.md          )
