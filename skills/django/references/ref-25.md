...
guide](https://docs.djangoproject.com/en/topics/settings/).
...
[DEBUG=False](#std-setting-DEBUG) and [AdminEmailHandler](https://docs.djangoproject.com/en/5.0/logging/#django.utils.log.AdminEmailHandler)
...
serve. This is a security measure to prevent [HTTP Host header attacks](https://docs.djangoproject.com/en/topics/security/#host-headers-virtual-hosting), which are possible even under many
...
list, the [django.http.HttpRequest.get_host()](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest.get_host) method will raise
[SuspiciousOperation](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.SuspiciousOperation).

When [DEBUG](#std-setting-DEBUG) is `True` and `ALLOWED_HOSTS` is empty, the host
is validated against `['.localhost', '127.0.0.1', '[::1]']`.

`ALLOWED_HOSTS` is also [checked when running tests](https://docs.djangoproject.com/en/topics/testing/advanced/#topics-testing-advanced-multiple-hosts).

This validation only applies via [get_host()](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest.get_host);
...
[CommonMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.common.CommonMiddleware) is installed
(see [Middleware](https://docs.djangoproject.com/en/topics/http/middleware/)). See also [PREPEND_WWW](#std-setting-PREPEND_WWW).
...
See the [cache documentation](https://docs.djangoproject.com/en/topics/cache/#cache-key-transformation) for more
information.
...
See the [cache documentation](https://docs.djangoproject.com/en/topics/cache/#cache-key-prefixing) for more information.
...
[cache arguments](https://docs.djangoproject.com/en/topics/cache/#cache-arguments) documentation. For more information,
...
See the [cache documentation](https://docs.djangoproject.com/en/topics/cache/#cache-versioning) for more information.

### CACHE_MIDDLEWARE_ALIAS¶

Default: `'default'`

The cache connection to use for the [cache middleware](https://docs.djangoproject.com/en/topics/cache/#the-per-site-cache).
...
middleware](https://docs.djangoproject.com/en/topics/cache/#the-per-site-cache). This prefix is combined with the
[KEY_PREFIX](#std-setting-CACHES-KEY_PREFIX) setting; it does not replace it.

See [Django’s cache framework](https://docs.djangoproject.com/en/topics/cache/).
...
[cache middleware](https://docs.djangoproject.com/en/topics/cache/#the-per-site-cache).
...
[CSRF limitations](https://docs.djangoproject.com/en/5.0/csrf/#csrf-limitations) section.
...
form input](https://docs.djangoproject.com/en/howto/csrf/#acquiring-csrf-token-from-html) instead of [from the cookie](https://docs.djangoproject.com/en/howto/csrf/#acquiring-csrf-token-from-cookie).
...
your application). See [Cross Site Request Forgery protection](https://docs.djangoproject.com/en/5.0/csrf/).
...
It requires the use of [django.contrib.sessions](https://docs.djangoproject.com/en/topics/http/sessions/#module-django.contrib.sessions).
...
Since the [default error views](https://docs.djangoproject.com/en/5.0/views/#error-views) require the CSRF token,
[SessionMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.contrib.sessions.middleware.SessionMiddleware) must appear in
[MIDDLEWARE](#std-setting-MIDDLEWARE) before any middleware that may raise an exception to
trigger an error view (such as [PermissionDenied](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.PermissionDenied))
if you’re using `CSRF_USE_SESSIONS`. See [Middleware ordering](https://docs.djangoproject.com/en/5.0/middleware/#middleware-ordering).
...
rejected by the [CSRF protection](https://docs.djangoproject.com/en/5.0/csrf/). The function should have
this signature:
...
an [HttpResponseForbidden](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpResponseForbidden).
...
For a [secure](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest.is_secure) unsafe
...
[Tying transactions to HTTP requests](https://docs.djangoproject.com/en/topics/db/transactions/#tying-transactions-to-http-requests).
...
management](https://docs.djangoproject.com/en/topics/db/transactions/#deactivate-transaction-management) and implement your own.
...
behavior — and `None` for unlimited [persistent database connections](https://docs.djangoproject.com/en/5.0/databases/#persistent-database-connections).

#### CONN_HEALTH_CHECKS¶

Default: `False`

If set to `True`, existing [persistent database connections](https://docs.djangoproject.com/en/5.0/databases/#persistent-database-connections) will be health checked before they are
...
Some information on available parameters can be found in the
[Database Backends](https://docs.djangoproject.com/en/5.0/databases/) documentation. For more information,
consult your backend module’s own documentation.
...
[QuerySet.iterator()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.iterator). [Transaction pooling and server-side cursors](https://docs.djangoproject.com/en/5.0/databases/#transaction-pooling-server-side-cursors)
...
creation and use of test databases, see [The test database](https://docs.djangoproject.com/en/topics/testing/overview/#the-test-database).
...
on [controlling the creation order of test databases](https://docs.djangoproject.com/en/topics/testing/advanced/#topics-testing-creation-dependencies) for details.
...
[TransactionTestCase](https://docs.djangoproject.com/en/topics/testing/tools/#django.test.TransactionTestCase) instead of
[TestCase](https://docs.djangoproject.com/en/topics/testing/tools/#django.test.TestCase).

This setting exists to allow for testing of primary/replica
(referred to as master/slave by some databases)
configurations of multiple databases. See the documentation on
[testing primary/replica configurations](https://docs.djangoproject.com/en/topics/testing/advanced/#topics-testing-primaryreplica) for details.
...
See [The test database](https://docs.djangoproject.com/en/topics/testing/overview/#the-test-database).
...
[SuspiciousOperation](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.SuspiciousOperation) (`RequestDataTooBig`) is
...
[SuspiciousOperation](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.SuspiciousOperation) (`TooManyFields`) is
...
[SuspiciousOperation](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.SuspiciousOperation) (`TooManyFiles`) is
raised. You can set this to `None` to disable the check. Applications that
...
database configurations](https://docs.djangoproject.com/en/topics/db/multi-db/#topics-db-multi-db-routing).
...
applied instead. See [alloweddateformatstrings](https://docs.djangoproject.com/en/5.0/templates/builtins/#std-templatefilter-date).
...
format strings use Python’s [datetime module syntax](https://docs.python.org/3/library/datetime.html#strftime-strptime-behavior), not the format strings from the [date](https://docs.djangoproject.com/en/5.0/templates/builtins/#std-templatefilter-date)
template filter.
...
these format strings use Python’s [datetime module syntax](https://docs.python.org/3/library/datetime.html#strftime-strptime-behavior), not the format strings from the [date](https://docs.djangoproject.com/en/5.0/templates/builtins/#std-templatefilter-date)
...
The default `settings.py` file created by [django-adminstartproject](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-startproject) sets `DEBUG = True` for convenience.
...
([handler500](https://docs.djangoproject.com/en/5.0/urls/#django.conf.urls.handler500), or the debug view if [DEBUG](#std-setting-DEBUG)
is `True`) and logging of 500 responses ([django.request](https://docs.djangoproject.com/en/5.0/logging/#django-request-logger)) is
...
Default: `'`[django.db.models.AutoField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.AutoField)`'`

Default primary key field type to use for models that don’t have a field with
[primary_key=True](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.Field.primary_key).
...
[RunSQL](https://docs.djangoproject.com/en/5.0/migration-operations/#django.db.migrations.operations.RunSQL) operation to your
...
Default: `'`[django.views.debug.ExceptionReporter](https://docs.djangoproject.com/en/howto/error-reporting/#django.views.debug.ExceptionReporter)`'`

Default exception reporter class to be used if none has been assigned to the
[HttpRequest](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest) instance yet. See
[Custom error reports](https://docs.djangoproject.com/en/howto/error-reporting/#custom-error-reports).

### DEFAULT_EXCEPTION_REPORTER_FILTER¶

Default: `'`[django.views.debug.SafeExceptionReporterFilter](https://docs.djangoproject.com/en/howto/error-reporting/#django.views.debug.SafeExceptionReporterFilter)`'`

Default exception reporter filter class to be used if none has been assigned to
the [HttpRequest](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest) instance yet.
See [Filtering error reports](https://docs.djangoproject.com/en/howto/error-reporting/#filtering-error-reports).

### DEFAULT_FILE_STORAGE¶

Default: `'`[django.core.files.storage.FileSystemStorage](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.FileSystemStorage)`'`

Default file storage class to be used for any file-related operations that don’t
specify a particular storage system. See [Managing files](https://docs.djangoproject.com/en/topics/files/).

Deprecated since version 4.2: This setting is deprecated. Starting with Django 4.2, default file storage
engine can be configured with the [STORAGES](#std-setting-STORAGES) setting under the
`default` key.
...
one, if the backend supports it (see [Tablespaces](https://docs.djangoproject.com/en/topics/db/tablespaces/)).
...
backend supports it (see [Tablespaces](https://docs.djangoproject.com/en/topics/db/tablespaces/)).
...
[Middleware](https://docs.djangoproject.com/en/topics/http/middleware/)).

### EMAIL_BACKEND¶

Default: `'`[django.core.mail.backends.smtp.EmailBackend](https://docs.djangoproject.com/en/topics/email/#django.core.mail.backends.smtp.EmailBackend)`'`

The backend to use for sending emails. For the list of available backends see
[Email backends](https://docs.djangoproject.com/en/topics/email/#topic-email-backends).

### EMAIL_FILE_PATH¶

Default: Not defined

The directory used by the [file email backend](https://docs.djangoproject.com/en/topics/email/#topic-email-file-backend)
...
See [Managing files](https://docs.djangoproject.com/en/topics/files/) for details.
...
the file system. See [Managing files](https://docs.djangoproject.com/en/topics/files/) for details.
...
directories when using the [collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) management command. See
[collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) for details on overriding it.
...
when using the [collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) management command. See
[collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) for details on overriding it.
...
List of directories searched for [fixture](https://docs.djangoproject.com/en/topics/db/fixtures/#fixtures-explanation) files,
in addition to the `fixtures` directory of each application, in search order.

Note that these paths should use Unix-style forward slashes, even on Windows.

See [Provide data with fixtures](https://docs.djangoproject.com/en/howto/initial-data/#initial-data-via-fixtures) and [Fixture loading](https://docs.djangoproject.com/en/topics/testing/tools/#topics-testing-fixtures).
...
[django.setup()](https://docs.djangoproject.com/en/5.0/applications/#django.setup) to set the URL resolver script prefix outside of the
request/response cycle (e.g. in management commands and standalone scripts) to
generate correct URLs when `FORCE_SCRIPT_NAME` is provided.

### FORM_RENDERER¶

Default: `'`[django.forms.renderers.DjangoTemplates](https://docs.djangoproject.com/en/5.0/forms/renderers/#django.forms.renderers.DjangoTemplates)`'`

The class that renders forms and form widgets. It must implement
[the low-level render API](https://docs.djangoproject.com/en/5.0/forms/renderers/#low-level-widget-render-api). Included form
renderers are:

- `'`[django.forms.renderers.DjangoTemplates](https://docs.djangoproject.com/en/5.0/forms/renderers/#django.forms.renderers.DjangoTemplates)`'`
- `'`[django.forms.renderers.Jinja2](https://docs.djangoproject.com/en/5.0/forms/renderers/#django.forms.renderers.Jinja2)`'`
- `'`[django.forms.renderers.TemplatesSetting](https://docs.djangoproject.com/en/5.0/forms/renderers/#django.forms.renderers.TemplatesSetting)`'`
...
new default value of [URLField.assume_scheme](https://docs.djangoproject.com/en/5.0/forms/fields/#django.forms.URLField.assume_scheme) during the Django 5.x release cycle.
...
named using [locale name](https://docs.djangoproject.com/en/topics/i18n/#term-locale-name) notation, for example `de`, `pt_BR`,
`en_US`, etc.
...
[How to manage error reporting](https://docs.djangoproject.com/en/howto/error-reporting/)). Regular expressions are matched against
[request'sfullpaths](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest.get_full_path) (including
query string, if any). Use this if your site does not provide a commonly
requested file such as `favicon.ico` or `robots.txt`.

This is only used if
[BrokenLinkEmailsMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.common.BrokenLinkEmailsMiddleware) is enabled (see
[Middleware](https://docs.djangoproject.com/en/topics/http/middleware/)).
...
[Learn more about application configurations](https://docs.djangoproject.com/en/5.0/applications/).
...
[django.apps.apps](https://docs.djangoproject.com/en/5.0/applications/#django.apps.apps) instead.

Application names and labels must be unique in
            [INSTALLED_APPS](#std-setting-INSTALLED_APPS)

Application [names](https://docs.djangoproject.com/en/5.0/applications/#django.apps.AppConfig.name) — the dotted Python
...
Application [labels](https://docs.djangoproject.com/en/5.0/applications/#django.apps.AppConfig.label) — by default the
...
different [label](https://docs.djangoproject.com/en/5.0/applications/#django.apps.AppConfig.label).
...
- Allow the [debug()](https://docs.djangoproject.com/en/5.0/templates/api/#django.template.context_processors.debug) context processor
  to add some variables to the template context.
- Can use the [admindocs bookmarklets](https://docs.djangoproject.com/en/5.0/contrib/admin/admindocs/#admindocs-bookmarklets) even if
  not logged in as a staff user.
- Are marked as “internal” (as opposed to “EXTERNAL”) in
  [AdminEmailHandler](https://docs.djangoproject.com/en/5.0/logging/#django.utils.log.AdminEmailHandler) emails.
...
standard [language ID format](https://docs.djangoproject.com/en/topics/i18n/#term-language-code). For example, U.S. English
is `"en-us"`. See also the [list of language identifiers](http://www.i18nguy.com/unicode/language-identifiers.html) and
[Internationalization and localization](https://docs.djangoproject.com/en/topics/i18n/).

[USE_I18N](#std-setting-USE_I18N) must be active for this setting to have any effect.
...
See [How Django discovers language preference](https://docs.djangoproject.com/en/topics/i18n/translation/#how-django-discovers-language-preference) for more details.
...
application). See [Internationalization and localization](https://docs.djangoproject.com/en/topics/i18n/).
...
([language code](https://docs.djangoproject.com/en/topics/i18n/#term-language-code), `language name`) – for example,
`('ja', 'Japanese')`.
...
[gettext_lazy()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.translation.gettext_lazy) function.
...
The list contains [language codes](https://docs.djangoproject.com/en/topics/i18n/#term-language-code) for languages that are
...
See [How Django discovers translations](https://docs.djangoproject.com/en/topics/i18n/translation/#how-django-discovers-translations).
...
[Configuring logging](https://docs.djangoproject.com/en/topics/logging/#configuring-logging).
...
[BrokenLinkEmailsMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.common.BrokenLinkEmailsMiddleware) is enabled.
...
files](https://docs.djangoproject.com/en/topics/files/).
...
for [managing stored files](https://docs.djangoproject.com/en/topics/files/). It must end in a slash if set
to a non-empty value. You will need to [configure these files to be served](https://docs.djangoproject.com/en/howto/static-files/#serving-uploaded-files-in-development) in both development and production
environments.
...
[User-uploaded content](https://docs.djangoproject.com/en/topics/security/#user-uploaded-content-security) for mitigation details.
...
A list of middleware to use. See [Middleware](https://docs.djangoproject.com/en/topics/http/middleware/).
...
If you provide the `app_label` argument, [makemigrations](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-makemigrations) will
...
the [migrate--run-syncdb](https://docs.djangoproject.com/en/5.0/django-admin/#cmdoption-migrate-run-syncdb) option if you want to create tables for the
app.
...
See [alloweddateformatstrings](https://docs.djangoproject.com/en/5.0/templates/builtins/#std-templatefilter-date). See also
...
used if [CommonMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.common.CommonMiddleware) is installed
(see [Middleware](https://docs.djangoproject.com/en/topics/http/middleware/)). See also [APPEND_SLASH](#std-setting-APPEND_SLASH).
...
object. See [How Django processes a request](https://docs.djangoproject.com/en/topics/http/urls/#how-django-processes-a-request) for details.
...
[cryptographic signing](https://docs.djangoproject.com/en/topics/signing/), and should be set to a unique,
unpredictable value.

[django-adminstartproject](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-startproject) automatically adds a
randomly-generated `SECRET_KEY` to each new project.

Uses of the key shouldn’t assume that it’s text or bytes. Every use should go
through [force_str()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.encoding.force_str) or
[force_bytes()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.encoding.force_bytes) to convert it to the desired type.
...
- All [sessions](https://docs.djangoproject.com/en/topics/http/sessions/) if you are using
...
- All [messages](https://docs.djangoproject.com/en/5.0/contrib/messages/) if you are using
  [CookieStorage](https://docs.djangoproject.com/en/5.0/contrib/messages/#django.contrib.messages.storage.cookie.CookieStorage) or
  [FallbackStorage](https://docs.djangoproject.com/en/5.0/contrib/messages/#django.contrib.messages.storage.fallback.FallbackStorage).
- All [PasswordResetView](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.views.PasswordResetView) tokens.
- Any usage of [cryptographic signing](https://docs.djangoproject.com/en/topics/signing/), unless a
...
The default `settings.py` file created by [django-adminstartproject](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-startproject) creates a unique `SECRET_KEY` for
convenience.
...
Every use should go through [force_str()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.encoding.force_str) or
[force_bytes()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.encoding.force_bytes) to convert it to the desired type.
...
If `True`, the [SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware)
sets the [X-Content-Type-Options: nosniff](https://docs.djangoproject.com/en/5.0/middleware/#x-content-type-options) header on all responses that do not
already have it.
...
[SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware) sets the
[Cross-Origin Opener Policy](https://docs.djangoproject.com/en/5.0/middleware/#cross-origin-opener-policy) header on all responses that do not already
...
If `True`, the [SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware) adds
the `includeSubDomains` directive to the [HTTP Strict Transport Security](https://docs.djangoproject.com/en/5.0/middleware/#http-strict-transport-security)
...
[HTTP Strict Transport Security](https://docs.djangoproject.com/en/5.0/middleware/#http-strict-transport-security) documentation first.
...
If `True`, the [SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware) adds
the `preload` directive to the [HTTP Strict Transport Security](https://docs.djangoproject.com/en/5.0/middleware/#http-strict-transport-security)
header. It has no effect unless [SECURE_HSTS_SECONDS](#std-setting-SECURE_HSTS_SECONDS) is set to a
non-zero value.
...
[SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware) sets the
[HTTP Strict Transport Security](https://docs.djangoproject.com/en/5.0/middleware/#http-strict-transport-security) header on all responses that do not
already have it.

Warning

Setting this incorrectly can irreversibly (for some time) break your site.
Read the [HTTP Strict Transport Security](https://docs.djangoproject.com/en/5.0/middleware/#http-strict-transport-security) documentation first.
...
[SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware) strips leading slashes
...
If configured, the [SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware) sets
the [Referrer Policy](https://docs.djangoproject.com/en/5.0/middleware/#referrer-policy) header on all responses that do not already have it
...
If `True`, the [SecurityMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.security.SecurityMiddleware) [redirects](https://docs.djangoproject.com/en/5.0/middleware/#ssl-redirect) all non-HTTPS requests to HTTPS (except for
...
regular email messages sent with [send_mail()](https://docs.djangoproject.com/en/topics/email/#django.core.mail.send_mail)
...
[alloweddateformatstrings](https://docs.djangoproject.com/en/5.0/templates/builtins/#std-templatefilter-date).
...
See also the [Cryptographic signing](https://docs.djangoproject.com/en/topics/signing/) documentation.
...
See also the [System check framework](https://docs.djangoproject.com/en/5.0/checks/) documentation.
...
- `default` for [managing files](https://docs.djangoproject.com/en/topics/files/).
  `'`[django.core.files.storage.FileSystemStorage](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.FileSystemStorage)`'` is the
  default storage engine.
- `staticfiles` for [managing static files](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/).
  `'`[django.contrib.staticfiles.storage.StaticFilesStorage](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django.contrib.staticfiles.storage.StaticFilesStorage)`'` is
...
[django.core.files.storage.storages](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.storages). Use a key corresponding to the
...
The default `settings.py` file created by [django-adminstartproject](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-startproject) sets `'APP_DIRS': True`.
...
[DjangoTemplates](https://docs.djangoproject.com/en/topics/templates/#django.template.backends.django.DjangoTemplates) and
[Jinja2](https://docs.djangoproject.com/en/topics/templates/#django.template.backends.jinja2.Jinja2) for the options of the
built-in backends.
...
[Using different testing frameworks](https://docs.djangoproject.com/en/topics/testing/advanced/#other-testing-frameworks).
...
will [serialize the contents of all apps](https://docs.djangoproject.com/en/topics/testing/overview/#test-case-serialized-rollback)
...
described in [manually configuring settings](https://docs.djangoproject.com/en/topics/settings/#settings-without-django-settings-module). If Django doesn’t set the `TZ`
...
The default `settings.py` file created by [django-adminstartproject](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-startproject) includes `USE_I18N = True` for convenience.
...
servers (e.g. [runserver](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-runserver)) will use. The [django-adminstartproject](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-startproject) management command will create a standard
`wsgi.py` file with an `application` callable in it, and point this setting
to that `application`.

If not set, the return value of `django.core.wsgi.get_wsgi_application()`
will be used. In this case, the behavior of [runserver](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-runserver) will be
...
[XFrameOptionsMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.middleware.clickjacking.XFrameOptionsMiddleware). See the
[clickjacking protection](https://docs.djangoproject.com/en/5.0/clickjacking/) documentation.

## ¶

Settings for [django.contrib.auth](https://docs.djangoproject.com/en/topics/auth/#module-django.contrib.auth).
...
authenticate a user. See the [authentication backends documentation](https://docs.djangoproject.com/en/topics/auth/customizing/#authentication-backends) for details.

### AUTH_USER_MODEL¶

Default: `'auth.User'`

The model to use to represent a User. See [Substituting a custom User model](https://docs.djangoproject.com/en/topics/auth/customizing/#auth-custom-user).
...
See [Substituting a custom User model](https://docs.djangoproject.com/en/topics/auth/customizing/#auth-custom-user) for more details.

### LOGIN_REDIRECT_URL¶

Default: `'/accounts/profile/'`

The URL or [named URL pattern](https://docs.djangoproject.com/en/topics/http/urls/#naming-url-patterns) where requests are
redirected after login when the [LoginView](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.views.LoginView)
...
[login_required()](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.decorators.login_required) decorator,
[LoginRequiredMixin](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.mixins.LoginRequiredMixin), or
[AccessMixin](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.mixins.AccessMixin).
...
The URL or [named URL pattern](https://docs.djangoproject.com/en/topics/http/urls/#naming-url-patterns) where requests are
redirected after logout if [LogoutView](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.views.LogoutView)
...
Used by the [PasswordResetConfirmView](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.views.PasswordResetConfirmView).
...
See [How Django stores passwords](https://docs.djangoproject.com/en/topics/auth/passwords/#auth-password-storage).
...
See [Password validation](https://docs.djangoproject.com/en/topics/auth/passwords/#password-validation) for more details. By default, no validation is
performed and all passwords are accepted.

## ¶

Settings for [django.contrib.messages](https://docs.djangoproject.com/en/5.0/contrib/messages/#module-django.contrib.messages).
...
framework. See [message levels](https://docs.djangoproject.com/en/5.0/contrib/messages/#message-level) for more details.
...
according to the values in the above [constants table](https://docs.djangoproject.com/en/5.0/contrib/messages/#message-level-constants).
...
See [message storage backends](https://docs.djangoproject.com/en/5.0/contrib/messages/#message-storage-backends) for more details.

The backends that use cookies –
[CookieStorage](https://docs.djangoproject.com/en/5.0/contrib/messages/#django.contrib.messages.storage.cookie.CookieStorage) and
[FallbackStorage](https://docs.djangoproject.com/en/5.0/contrib/messages/#django.contrib.messages.storage.fallback.FallbackStorage) –
...
to override. See [Displaying messages](https://docs.djangoproject.com/en/5.0/contrib/messages/#message-displaying) above for more details.
...
Settings for [django.contrib.sessions](https://docs.djangoproject.com/en/topics/http/sessions/#module-django.contrib.sessions).

### SESSION_CACHE_ALIAS¶

Default: `'default'`

If you’re using [cache-based session storage](https://docs.djangoproject.com/en/topics/http/sessions/#cached-sessions-backend),
...
This setting also affects cookies set by [django.contrib.messages](https://docs.djangoproject.com/en/5.0/contrib/messages/#module-django.contrib.messages).
...
See [Configuring the session engine](https://docs.djangoproject.com/en/topics/http/sessions/#configuring-sessions) for more details.
...
[Browser-length sessions vs. persistent sessions](https://docs.djangoproject.com/en/topics/http/sessions/#browser-length-vs-persistent-sessions).
...
See [Session serialization](https://docs.djangoproject.com/en/topics/http/sessions/#session-serialization) for details.

## ¶

Settings for [django.contrib.sites](https://docs.djangoproject.com/en/5.0/contrib/sites/#module-django.contrib.sites).
...
Settings for [django.contrib.staticfiles](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#module-django.contrib.staticfiles).

### STATIC_ROOT¶

Default: `None`

The absolute path to the directory where [collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) will collect
static files for deployment.

Example: `"/var/www/example.com/static/"`

If the [staticfiles](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/) contrib app is enabled
(as in the default project template), the [collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) management
command will collect static files into this directory. See the how-to on
[managing static files](https://docs.djangoproject.com/en/howto/static-files/) for more details about
usage.
...
[staticfiles](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/)’s
...
[asset definitions](https://docs.djangoproject.com/en/topics/forms/media/#form-asset-paths) (the `Media` class) and the
[staticfiles app](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/).

It must end in a slash if set to a non-empty value.

You may need to [configure these files to be served in development](https://docs.djangoproject.com/en/howto/static-files/#serving-static-files-in-development) and will definitely need to do so
[in production](https://docs.djangoproject.com/en/howto/static-files/deployment/).
...
[collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) or [findstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-findstatic) management command or use the
...
[collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) management command would collect the “stats” files
...
[collectstatic](https://docs.djangoproject.com/en/5.0/contrib/staticfiles/#django-admin-collectstatic) management command.

A ready-to-use instance of the storage backend defined in this setting
can be found under `staticfiles` key in `django.core.files.storage.storages`.

For an example, see [Serving static files from a cloud service or CDN](https://docs.djangoproject.com/en/howto/static-files/deployment/#staticfiles-from-cdn).

Deprecated since version 4.2: This setting is deprecated. Starting with Django 4.2, static files storage
engine can be configured with the [STORAGES](#std-setting-STORAGES) setting under the
`staticfiles` key.
...
- [FORMS_URLFIELD_ASSUME_HTTPS](#std-setting-FORMS_URLFIELD_ASSUME_HTTPS)
