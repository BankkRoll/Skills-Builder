# Password management in Django¶ and more
...
eavesdrop on their connections. Use [HTTPS](https://docs.djangoproject.com/en/5.0/security/#security-recommendation-ssl) to avoid sending passwords (or any other
...
The [password](https://docs.djangoproject.com/en/ref/contrib/auth/#django.contrib.auth.models.User.password) attribute of a
[User](https://docs.djangoproject.com/en/ref/contrib/auth/#django.contrib.auth.models.User) object is a string in this format:
...
[PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS) setting. This is a list of hashing algorithm
classes that this Django installation supports.

For storing passwords, Django will use the first hasher in
[PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS). To store new passwords with a different algorithm,
put your preferred algorithm first in [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS).
...
algorithm not found in [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS), trying to verify it will
raise `ValueError`.

The default for [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS) is:
...
2. Modify [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS) to list `Argon2PasswordHasher` first.
...
1. Install the [bcrypt](https://pypi.org/project/bcrypt/) package. This can be done by running
  ...
  Django’s `setup.cfg`).
2. Modify [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS) to list `BCryptSHA256PasswordHasher`
...
1. Modify [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS) to list `ScryptPasswordHasher` first.
...
2. Add your new hasher as the first entry in [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS):
  ```
  PASSWORD_HASHERS = [
...
[PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS), so as you upgrade to new systems you should make
...
The data migration might look something like:
  ...
  `accounts/migrations/0002_migrate_md5_passwords.py`[¶](#id5)
...
Finally, we’ll add a [PASSWORD_HASHERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-PASSWORD_HASHERS) setting:

  `mysite/settings.py`[¶](#id6)
...
from the `User` model.
   ...
   check_password(*password*, *encoded*, *setter=None*, *preferred='default'*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/hashers/#check_password)[¶](#django.contrib.auth.hashers.check_password)    acheck_password(*password*, *encoded*, *asetter=None*, *preferred='default'*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/hashers/#acheck_password)[¶](#django.contrib.auth.hashers.acheck_password)
...
`acheck_password()` method was added.
     ...
     make_password(*password*, *salt=None*, *hasher='default'*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/hashers/#make_password)[¶](#django.contrib.auth.hashers.make_password)
...
returned (one that will never be accepted by [check_password()](#django.contrib.auth.hashers.check_password)).
    ...
    is_password_usable(*encoded_password*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/hashers/#is_password_usable)[¶](#django.contrib.auth.hashers.is_password_usable)

Returns `False` if the password is a result of
[User.set_unusable_password()](https://docs.djangoproject.com/en/ref/contrib/auth/#django.contrib.auth.models.User.set_unusable_password).
...
Validation is controlled by the [AUTH_PASSWORD_VALIDATORS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTH_PASSWORD_VALIDATORS) setting.
The default for the setting is an empty list, which means no validators are
applied. In new projects created with the default [startproject](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-startproject)
...
in the [createsuperuser](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-createsuperuser) and [changepassword](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-changepassword) management
...
[AUTH_PASSWORD_VALIDATORS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTH_PASSWORD_VALIDATORS) setting:
...
the order they are listed in [AUTH_PASSWORD_VALIDATORS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTH_PASSWORD_VALIDATORS).

### Included validators¶

Django includes four validators:

   *class*MinimumLengthValidator(*min_length=8*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#MinimumLengthValidator)[¶](#django.contrib.auth.password_validation.MinimumLengthValidator)

Validates that the password is of a minimum length.
The minimum length can be customized with the `min_length` parameter.

    *class*UserAttributeSimilarityValidator(*user_attributes=DEFAULT_USER_ATTRIBUTES*, *max_similarity=0.7*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#UserAttributeSimilarityValidator)[¶](#django.contrib.auth.password_validation.UserAttributeSimilarityValidator)
...
The `max_similarity` parameter was limited to a minimum value of 0.1.
     ...
     *class*CommonPasswordValidator(*password_list_path=DEFAULT_PASSWORD_LIST_PATH*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#CommonPasswordValidator)[¶](#django.contrib.auth.password_validation.CommonPasswordValidator)
...
version.
     ...
     *class*NumericPasswordValidator[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#NumericPasswordValidator)[¶](#django.contrib.auth.password_validation.NumericPasswordValidator)
...
or if you have API calls that allow passwords to be set, for example.
   ...
   validate_password(*password*, *user=None*, *password_validators=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#validate_password)[¶](#django.contrib.auth.password_validation.validate_password)
...
[ValidationError](https://docs.djangoproject.com/en/ref/exceptions/#django.core.exceptions.ValidationError) with all the error messages
from the validators.
...
not be able to perform any validation and will accept any password.
    ...
    password_changed(*password*, *user=None*, *password_validators=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#password_changed)[¶](#django.contrib.auth.password_validation.password_changed)
...
For subclasses of [AbstractBaseUser](https://docs.djangoproject.com/en/5.0/topics/customizing/#django.contrib.auth.models.AbstractBaseUser),
the password field will be marked as “dirty” when calling
[set_password()](https://docs.djangoproject.com/en/5.0/topics/customizing/#django.contrib.auth.models.AbstractBaseUser.set_password) which
triggers a call to `password_changed()` after the user is saved.

    password_validators_help_texts(*password_validators=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#password_validators_help_texts)[¶](#django.contrib.auth.password_validation.password_validators_help_texts)

Returns a list of the help texts of all validators. These explain the
password requirements to the user.

    password_validators_help_text_html(*password_validators=None*)[¶](#django.contrib.auth.password_validation.password_validators_help_text_html)
...
output directly to the `help_text` parameter of a form field.
    ...
    get_password_validators(*validator_config*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/auth/password_validation/#get_password_validators)[¶](#django.contrib.auth.password_validation.get_password_validators)
...
[AUTH_PASSWORD_VALIDATORS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTH_PASSWORD_VALIDATORS), but by calling this function with an
...
from [AUTH_PASSWORD_VALIDATORS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTH_PASSWORD_VALIDATORS) is used by default.

The structure of `validator_config` is identical to the
structure of [AUTH_PASSWORD_VALIDATORS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTH_PASSWORD_VALIDATORS). The return value of
...
- `validate(self, password, user=None)`: validate a password. Return
  ...
  [ValidationError](https://docs.djangoproject.com/en/ref/exceptions/#django.core.exceptions.ValidationError) with an error message if the
...
Any items in the `OPTIONS` in [AUTH_PASSWORD_VALIDATORS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTH_PASSWORD_VALIDATORS) for your
...
well as how to [extend and customize](https://docs.djangoproject.com/en/5.0/topics/customizing/) it to
...
included in the `settings.py` generated by [django-adminstartproject](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-startproject), these consist of two items listed in your
...
2. `'django.contrib.contenttypes'` is the Django [content type system](https://docs.djangoproject.com/en/ref/contrib/contenttypes/), which allows permissions to be associated with
  models you create.

and these items in your [MIDDLEWARE](https://docs.djangoproject.com/en/ref/settings/#std-setting-MIDDLEWARE) setting:

1. [SessionMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.contrib.sessions.middleware.SessionMiddleware) manages
  [sessions](https://docs.djangoproject.com/en/5.0/http/sessions/) across requests.
2. [AuthenticationMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.contrib.auth.middleware.AuthenticationMiddleware) associates
...
[Using Django’s default implementation](https://docs.djangoproject.com/en/5.0/topics/default/)

- [Working with User objects](https://docs.djangoproject.com/en/5.0/topics/default/#user-objects)
- [Permissions and authorization](https://docs.djangoproject.com/en/5.0/topics/default/#topic-authorization)
- [Authentication in web requests](https://docs.djangoproject.com/en/5.0/topics/default/#auth-web-requests)
- [Managing users in the admin](https://docs.djangoproject.com/en/5.0/topics/default/#auth-admin)

[API reference for the default implementation](https://docs.djangoproject.com/en/ref/contrib/auth/)

[Customizing Users and authentication](https://docs.djangoproject.com/en/5.0/topics/customizing/)

[Password management in Django](https://docs.djangoproject.com/en/5.0/topics/passwords/)
