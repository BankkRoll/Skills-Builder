...
[CONN_MAX_AGE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-CONN_MAX_AGE) parameter which defines the maximum lifetime of a
connection. It can be set independently for each database.

The default value is `0`, preserving the historical behavior of closing the
database connection at the end of each request. To enable persistent
connections, set [CONN_MAX_AGE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-CONN_MAX_AGE) to a positive integer of seconds. For
...
[CONN_MAX_AGE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-CONN_MAX_AGE) or when it isn’t usable any longer.
...
some time, you should set [CONN_MAX_AGE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-CONN_MAX_AGE) to a lower value, so that
...
Setting [CONN_HEALTH_CHECKS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-CONN_HEALTH_CHECKS) to `True` can be used to improve the
...
In such cases, you should set [CONN_MAX_AGE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-CONN_MAX_AGE) to a low value or even
...
Django supports PostgreSQL 12 and higher. [psycopg](https://www.psycopg.org/psycopg3/) 3.1.8+ or [psycopg2](https://www.psycopg.org/)
...
See [HOST](https://docs.djangoproject.com/en/5.0/settings/#std-setting-HOST) for details.
...
[OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS) part of your database configuration in [DATABASES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASES):
...
The PostgreSQL backend passes the content of [OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS) as keyword
...
- `timezone`:
  - when [USE_TZ](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ) is `True`, `'UTC'` by default, or the
    [TIME_ZONE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASE-TIME_ZONE) value set for the connection,
  - when [USE_TZ](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ) is `False`, the value of the global
    [TIME_ZONE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-TIME_ZONE) setting.
...
`SERIALIZABLE`, set it in the [OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS) part of your database
configuration in [DATABASES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASES):
...
to establish the connection, set it in the [OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS) part of your
database configuration in [DATABASES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASES):
...
[OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS) part of your database configuration in
...
[CreateExtension](https://docs.djangoproject.com/en/5.0/contrib/postgres/operations/#django.contrib.postgres.operations.CreateExtension) operation.

### Server-side cursors¶

When using [QuerySet.iterator()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.iterator), Django opens a [server-side
...
transaction when [AUTOCOMMIT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASE-AUTOCOMMIT) is `True`. A
...
[DATABASES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASES) by setting [DISABLE_SERVER_SIDE_CURSORS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASE-DISABLE_SERVER_SIDE_CURSORS) to `True`.

To benefit from server-side cursors in transaction pooling mode, you could set
up [another connection to the database](https://docs.djangoproject.com/en/topics/db/multi-db/) in order to
...
[atomic()](https://docs.djangoproject.com/en/topics/db/transactions/#django.db.transaction.atomic) block, because it disables `autocommit`
...
reusing a value that’s already in the table. The [sqlsequencereset](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-sqlsequencereset)
management command generates the SQL statements to do that.

### Test database templates¶

You can use the [TEST['TEMPLATE']](https://docs.djangoproject.com/en/5.0/settings/#std-setting-TEST_TEMPLATE) setting to specify
...
This may result in an inadvertent reuse of [AutoField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.AutoField)
values.
...
If you plan on using Django’s [timezone support](https://docs.djangoproject.com/en/topics/i18n/timezones/),
...
[CharField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.CharField.db_collation) and
[TextField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.TextField.db_collation).
...
Refer to the [settings documentation](https://docs.djangoproject.com/en/5.0/settings/).

Connection settings are used in this order:

1. [OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS).
2. [NAME](https://docs.djangoproject.com/en/5.0/settings/#std-setting-NAME), [USER](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USER), [PASSWORD](https://docs.djangoproject.com/en/5.0/settings/#std-setting-PASSWORD), [HOST](https://docs.djangoproject.com/en/5.0/settings/#std-setting-HOST),
  [PORT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-PORT)
3. MySQL option files.

In other words, if you set the name of the database in [OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS),
this will take precedence over [NAME](https://docs.djangoproject.com/en/5.0/settings/#std-setting-NAME), which would override
...
`'isolation_level'` entry in the [OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-OPTIONS) part of your database
configuration in [DATABASES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASES). Valid values for
...
you may see cases where [get_or_create()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.get_or_create)
will raise an [IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError) but the object won’t appear in
a subsequent [get()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.get) call.
...
via the [db_table](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.db_table) parameter.

### Savepoints¶

Both the Django ORM and MySQL (when using the InnoDB [storage engine](#mysql-storage-engines)) support database [savepoints](https://docs.djangoproject.com/en/topics/db/transactions/#topics-db-transactions-savepoints).

If you use the MyISAM storage engine please be aware of the fact that you will
receive database-generated errors if you try to use the [savepoint-related
methods of the transactions API](https://docs.djangoproject.com/en/topics/db/transactions/#topics-db-transactions-savepoints). The reason
...
for the field. This affects [CharField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.CharField),
[SlugField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.SlugField). See [the MySQL documentation](https://dev.mysql.com/doc/refman/en/create-index.html#create-index-column-prefixes) for more
details.
...
or using a [RunSQL](https://docs.djangoproject.com/en/5.0/migration-operations/#django.db.migrations.operations.RunSQL) operation in a
[data migration](https://docs.djangoproject.com/en/topics/migrations/#data-migrations).

#### TIMESTAMPcolumns¶

If you are using a legacy database that contains `TIMESTAMP` columns, you must
set [USE_TZ=False](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ) to avoid data corruption.
[inspectdb](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-inspectdb) maps these columns to
[DateTimeField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.DateTimeField) and if you enable timezone support,
...
a [NotSupportedError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.NotSupportedError) is raised.
...
[Field](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.Field) directly, are overriding
[get_prep_value()](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.Field.get_prep_value), or use
[RawSQL](https://docs.djangoproject.com/en/5.0/models/expressions/#django.db.models.expressions.RawSQL),
[extra()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.extra), or
[raw()](https://docs.djangoproject.com/en/topics/db/sql/#django.db.models.Manager.raw), you should ensure that you perform
...
[iexact](https://docs.djangoproject.com/en/5.0/models/querysets/#std-fieldlookup-iexact) or [contains](https://docs.djangoproject.com/en/5.0/models/querysets/#std-fieldlookup-contains) filters in Querysets. The behavior
...
are passed into the query. So the [iexact](https://docs.djangoproject.com/en/5.0/models/querysets/#std-fieldlookup-iexact) filter will behave exactly
the same as the [exact](https://docs.djangoproject.com/en/5.0/models/querysets/#std-fieldlookup-exact) filter in these cases.
...
modifying a table while iterating over it using [QuerySet.iterator()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.iterator). If
...
To use [JSONField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.JSONField) on SQLite, you need to enable the
...
In this case, you should leave both [HOST](https://docs.djangoproject.com/en/5.0/settings/#std-setting-HOST) and [PORT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-PORT) empty.
...
[HOST](https://docs.djangoproject.com/en/5.0/settings/#std-setting-HOST) and [PORT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-PORT) like so:
...
You should either supply both [HOST](https://docs.djangoproject.com/en/5.0/settings/#std-setting-HOST) and [PORT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-PORT), or leave
both as empty strings. Django will use a different connect descriptor depending
on that choice.

#### Full DSN and Easy Connect¶

A Full DSN or Easy Connect string can be used in [NAME](https://docs.djangoproject.com/en/5.0/settings/#std-setting-NAME) if both
[HOST](https://docs.djangoproject.com/en/5.0/settings/#std-setting-HOST) and [PORT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-PORT) are empty. This format is required when
...
`allows_group_by_selected_pks_on_model`:
  ...
  `mysite/mydbengine/base.py`[¶](#id18)
...
Finally, you must specify a [DATABASE-ENGINE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASE-ENGINE) in your `settings.py`
file:
