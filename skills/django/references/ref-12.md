...
# Form fields¶
   ...
   *class*Field[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#Field)[¶](#django.forms.Field)

When you create a `Form` class, the most important part is defining the
fields of the form. Each field has custom validation logic, along with a few
other hooks.

   Field.clean(*value*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#Field.clean)[¶](#django.forms.Field.clean)
...
### required¶
   ...
   Field.required[¶](#django.forms.Field.required)
...
[Form.use_required_attribute](https://docs.djangoproject.com/en/5.0/ref/api/#django.forms.Form.use_required_attribute) attribute to `False` to disable it. The
...
### label¶
   ...
   Field.label[¶](#django.forms.Field.label)
...
### label_suffix¶
   ...
   Field.label_suffix[¶](#django.forms.Field.label_suffix)

The `label_suffix` argument lets you override the form’s
[label_suffix](https://docs.djangoproject.com/en/5.0/ref/api/#django.forms.Form.label_suffix) on a per-field basis:
...
### initial¶
   ...
   Field.initial[¶](#django.forms.Field.initial)

The `initial` argument lets you specify the initial value to use when
rendering this `Field` in an unbound `Form`.

To specify dynamic initial data, see the [Form.initial](https://docs.djangoproject.com/en/5.0/ref/api/#django.forms.Form.initial) parameter.
...
### widget¶
   ...
   Field.widget[¶](#django.forms.Field.widget)

The `widget` argument lets you specify a `Widget` class to use when
rendering this `Field`. See [Widgets](https://docs.djangoproject.com/en/5.0/ref/widgets/) for more information.

### help_text¶

   Field.help_text[¶](#django.forms.Field.help_text)
...
Like the model field’s [help_text](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.Field.help_text), this value
...
### error_messages¶
   ...
   Field.error_messages[¶](#django.forms.Field.error_messages)
...
In the [built-in Field classes](#built-in-field-classes) section below, each `Field` defines the
error message keys it uses.

### validators¶

   Field.validators[¶](#django.forms.Field.validators)

The `validators` argument lets you provide a list of validation functions
for this field.

See the [validators documentation](https://docs.djangoproject.com/en/5.0/validators/) for more information.

### localize¶

   Field.localize[¶](#django.forms.Field.localize)

The `localize` argument enables the localization of form data input, as well
as the rendered output.

See the [format localization](https://docs.djangoproject.com/en/topics/i18n/formatting/) documentation for
more information.

### disabled¶

   Field.disabled[¶](#django.forms.Field.disabled)
...
### template_name¶
   ...
   Field.template_name[¶](#django.forms.Field.template_name)   New in Django 5.0.

The `template_name` argument allows a custom template to be used when the
field is rendered with [as_field_group()](https://docs.djangoproject.com/en/5.0/ref/api/#django.forms.BoundField.as_field_group). By
...
template, see also [Overriding built-in field templates](https://docs.djangoproject.com/en/5.0/ref/renderers/#overriding-built-in-field-templates).

## Checking if the field data has changed¶

### has_changed()¶

   Field.has_changed()[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#Field.has_changed)[¶](#django.forms.Field.has_changed)

The `has_changed()` method is used to determine if the field value has changed
from the initial value. Returns `True` or `False`.

See the [Form.has_changed()](https://docs.djangoproject.com/en/5.0/ref/api/#django.forms.Form.has_changed) documentation for more information.
...
### BooleanField¶
   ...
   *class*BooleanField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#BooleanField)[¶](#django.forms.BooleanField)

- Default widget: [CheckboxInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.CheckboxInput)
- Empty value: `False`
...
### CharField¶
   ...
   *class*CharField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#CharField)[¶](#django.forms.CharField)

- Default widget: [TextInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.TextInput)
- Empty value: Whatever you’ve given as [empty_value](#django.forms.CharField.empty_value).
- Normalizes to: A string.
- Uses [MaxLengthValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MaxLengthValidator) and
  [MinLengthValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MinLengthValidator) if `max_length` and
  `min_length` are provided. Otherwise, all inputs are valid.
- Error message keys: `required`, `max_length`, `min_length`

Has the following optional arguments for validation:

   max_length[¶](#django.forms.CharField.max_length)    min_length[¶](#django.forms.CharField.min_length)

If provided, these arguments ensure that the string is at most or at
least the given length.

    strip[¶](#django.forms.CharField.strip)

If `True` (default), the value will be stripped of leading and
trailing whitespace.

    empty_value[¶](#django.forms.CharField.empty_value)

The value to use to represent “empty”. Defaults to an empty string.

### ChoiceField¶

   *class*ChoiceField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#ChoiceField)[¶](#django.forms.ChoiceField)

- Default widget: [Select](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.Select)
...
Takes one extra argument:
   ...
   choices[¶](#django.forms.ChoiceField.choices)

Either an [iterable](https://docs.python.org/3/glossary.html#term-iterable) of 2-tuples to use as choices for this
field, [enumeration type](https://docs.djangoproject.com/en/5.0/models/fields/#field-choices-enum-types), or a
...
[model field reference documentation on choices](https://docs.djangoproject.com/en/5.0/models/fields/#field-choices)
...
[enumeration types](https://docs.djangoproject.com/en/5.0/models/fields/#field-choices-enum-types) directly in
`choices` was added.

### DateField¶

   *class*DateField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#DateField)[¶](#django.forms.DateField)

- Default widget: [DateInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.DateInput)
- Empty value: `None`
...
Takes one optional argument:
   ...
   input_formats[¶](#django.forms.DateField.input_formats)
...
[DATE_INPUT_FORMATS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATE_INPUT_FORMATS) if localization is disabled. See also
[format localization](https://docs.djangoproject.com/en/topics/i18n/formatting/).

### DateTimeField¶

   *class*DateTimeField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#DateTimeField)[¶](#django.forms.DateTimeField)

- Default widget: [DateTimeInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.DateTimeInput)
- Empty value: `None`
...
Takes one optional argument:
   ...
   input_formats[¶](#django.forms.DateTimeField.input_formats)
...
recognized by [parse_datetime()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.dateparse.parse_datetime). Some examples
are:
...
`DATE_INPUT_FORMATS` keys, or from [DATETIME_INPUT_FORMATS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATETIME_INPUT_FORMATS) and
[DATE_INPUT_FORMATS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATE_INPUT_FORMATS) if localization is disabled. See also
[format localization](https://docs.djangoproject.com/en/topics/i18n/formatting/).

### DecimalField¶

   *class*DecimalField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#DecimalField)[¶](#django.forms.DecimalField)

- Default widget: [NumberInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.NumberInput) when [Field.localize](#django.forms.Field.localize) is
  `False`, else [TextInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.TextInput).
- Empty value: `None`
- Normalizes to: A Python `decimal`.
- Validates that the given value is a decimal. Uses
  [MaxValueValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MaxValueValidator) and
  [MinValueValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MinValueValidator) if `max_value` and
  `min_value` are provided. Uses
  [StepValueValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.StepValueValidator) if `step_size` is
...
Takes five optional arguments:
   ...
   max_value[¶](#django.forms.DecimalField.max_value)    min_value[¶](#django.forms.DecimalField.min_value)

These control the range of values permitted in the field, and should be
given as `decimal.Decimal` values.

    max_digits[¶](#django.forms.DecimalField.max_digits)

The maximum number of digits (those before the decimal point plus those
after the decimal point, with leading zeros stripped) permitted in the
value.

    decimal_places[¶](#django.forms.DecimalField.decimal_places)

The maximum number of decimal places permitted.

    step_size[¶](#django.forms.DecimalField.step_size)
...
### DurationField¶
   ...
   *class*DurationField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#DurationField)[¶](#django.forms.DurationField)
...
[parse_duration()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.dateparse.parse_duration).

### EmailField¶

   *class*EmailField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#EmailField)[¶](#django.forms.EmailField)

- Default widget: [EmailInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.EmailInput)
- Empty value: Whatever you’ve given as `empty_value`.
- Normalizes to: A string.
- Uses [EmailValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.EmailValidator) to validate that
...
### FileField¶
   ...
   *class*FileField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#FileField)[¶](#django.forms.FileField)

- Default widget: [ClearableFileInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.ClearableFileInput)
- Empty value: `None`
...
documentation](https://docs.djangoproject.com/en/topics/http/file-uploads/).

When you use a `FileField` in a form, you must also remember to
[bind the file data to the form](https://docs.djangoproject.com/en/5.0/ref/api/#binding-uploaded-files).
...
### FilePathField¶
   ...
   *class*FilePathField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#FilePathField)[¶](#django.forms.FilePathField)
...
extra arguments; only `path` is required:
   ...
   path[¶](#django.forms.FilePathField.path)

The absolute path to the directory whose contents you want listed. This
directory must exist.

    recursive[¶](#django.forms.FilePathField.recursive)

If `False` (the default) only the direct contents of `path` will be
offered as choices. If `True`, the directory will be descended into
recursively and all descendants will be listed as choices.

    match[¶](#django.forms.FilePathField.match)

A regular expression pattern; only files with names matching this expression
will be allowed as choices.

    allow_files[¶](#django.forms.FilePathField.allow_files)

Optional.  Either `True` or `False`.  Default is `True`.  Specifies
whether files in the specified location should be included.  Either this or
[allow_folders](#django.forms.FilePathField.allow_folders) must be `True`.

    allow_folders[¶](#django.forms.FilePathField.allow_folders)
...
### FloatField¶
   ...
   *class*FloatField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#FloatField)[¶](#django.forms.FloatField)
...
Takes three optional arguments:
   ...
   max_value[¶](#django.forms.FloatField.max_value)    min_value[¶](#django.forms.FloatField.min_value)

These control the range of values permitted in the field.

    step_size[¶](#django.forms.FloatField.step_size)
...
### GenericIPAddressField¶
   ...
   *class*GenericIPAddressField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#GenericIPAddressField)[¶](#django.forms.GenericIPAddressField)
...
Takes three optional arguments:
   ...
   protocol[¶](#django.forms.GenericIPAddressField.protocol)

Limits valid inputs to the specified protocol.
Accepted values are `both` (default), `IPv4`
or `IPv6`. Matching is case insensitive.

    unpack_ipv4[¶](#django.forms.GenericIPAddressField.unpack_ipv4)
...
when `protocol` is set to `'both'`.
    ...
    max_length[¶](#django.forms.GenericIPAddressField.max_length)
...
### ImageField¶
   ...
   *class*ImageField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#ImageField)[¶](#django.forms.ImageField)
...
- Validates that file data has been bound to the form. Also uses
  [FileExtensionValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.FileExtensionValidator) to validate that
...
### IntegerField¶
   ...
   *class*IntegerField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#IntegerField)[¶](#django.forms.IntegerField)
...
Takes three optional arguments for validation:
   ...
   max_value[¶](#django.forms.IntegerField.max_value)    min_value[¶](#django.forms.IntegerField.min_value)

These control the range of values permitted in the field.

    step_size[¶](#django.forms.IntegerField.step_size)
...
### JSONField¶
   ...
   *class*JSONField(*encoder=None*, *decoder=None*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#JSONField)[¶](#django.forms.JSONField)

A field which accepts JSON encoded data for a
[JSONField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.JSONField).

- Default widget: [Textarea](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.Textarea)
- Empty value: `None`
...
Takes two optional arguments:
   ...
   encoder[¶](#django.forms.JSONField.encoder)
...
Defaults to `json.JSONEncoder`.
    ...
    decoder[¶](#django.forms.JSONField.decoder)
...
If you use a [ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm), the
`encoder` and `decoder` from [JSONField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.JSONField)
will be used.
...
### MultipleChoiceField¶
   ...
   *class*MultipleChoiceField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#MultipleChoiceField)[¶](#django.forms.MultipleChoiceField)

- Default widget: [SelectMultiple](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.SelectMultiple)
...
### NullBooleanField¶
   ...
   *class*NullBooleanField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#NullBooleanField)[¶](#django.forms.NullBooleanField)

- Default widget: [NullBooleanSelect](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.NullBooleanSelect)
- Empty value: `None`
- Normalizes to: A Python `True`, `False` or `None` value.
- Validates nothing (i.e., it never raises a `ValidationError`).

`NullBooleanField` may be used with widgets such as
[Select](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.Select) or [RadioSelect](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.RadioSelect)
...
### RegexField¶
   ...
   *class*RegexField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#RegexField)[¶](#django.forms.RegexField)

- Default widget: [TextInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.TextInput)
- Empty value: Whatever you’ve given as `empty_value`.
- Normalizes to: A string.
- Uses [RegexValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.RegexValidator) to validate that
  the given value matches a certain regular expression.
- Error message keys: `required`, `invalid`

Takes one required argument:

   regex[¶](#django.forms.RegexField.regex)
...
which work just as they do for [CharField](#django.forms.CharField).
   ...
   strip[¶](#django.forms.RegexField.strip)
...
### SlugField¶
   ...
   *class*SlugField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#SlugField)[¶](#django.forms.SlugField)

- Default widget: [TextInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.TextInput)
- Empty value: Whatever you’ve given as [empty_value](#django.forms.SlugField.empty_value).
- Normalizes to: A string.
- Uses [validate_slug](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.validate_slug) or
  [validate_unicode_slug](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.validate_unicode_slug) to validate that
  the given value contains only letters, numbers, underscores, and hyphens.
- Error messages: `required`, `invalid`

This field is intended for use in representing a model
[SlugField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.SlugField) in forms.

Takes two optional parameters:

   allow_unicode[¶](#django.forms.SlugField.allow_unicode)

A boolean instructing the field to accept Unicode letters in addition
to ASCII letters. Defaults to `False`.

    empty_value[¶](#django.forms.SlugField.empty_value)

The value to use to represent “empty”. Defaults to an empty string.

### TimeField¶

   *class*TimeField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#TimeField)[¶](#django.forms.TimeField)

- Default widget: [TimeInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.TimeInput)
- Empty value: `None`
...
Takes one optional argument:
   ...
   input_formats[¶](#django.forms.TimeField.input_formats)
...
[TIME_INPUT_FORMATS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-TIME_INPUT_FORMATS) if localization is disabled. See also
[format localization](https://docs.djangoproject.com/en/topics/i18n/formatting/).

### TypedChoiceField¶

   *class*TypedChoiceField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#TypedChoiceField)[¶](#django.forms.TypedChoiceField)
...
Takes extra arguments:
   ...
   coerce[¶](#django.forms.TypedChoiceField.coerce)
...
`choices`.
    ...
    empty_value[¶](#django.forms.TypedChoiceField.empty_value)
...
### TypedMultipleChoiceField¶
   ...
   *class*TypedMultipleChoiceField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#TypedMultipleChoiceField)[¶](#django.forms.TypedMultipleChoiceField)
...
### URLField¶
   ...
   *class*URLField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#URLField)[¶](#django.forms.URLField)

- Default widget: [URLInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.URLInput)
- Empty value: Whatever you’ve given as `empty_value`.
- Normalizes to: A string.
- Uses [URLValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.URLValidator) to validate that the
...
which work just as they do for [CharField](#django.forms.CharField), and one more argument:
   ...
   assume_scheme[¶](#django.forms.URLField.assume_scheme)  New in Django 5.0.
...
`"https"` in Django 6.0. Set [FORMS_URLFIELD_ASSUME_HTTPS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-FORMS_URLFIELD_ASSUME_HTTPS)
transitional setting to `True` to opt into using `"https"` during
the Django 5.x release cycle.

### UUIDField¶

   *class*UUIDField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#UUIDField)[¶](#django.forms.UUIDField)
...
### ComboField¶
   ...
   *class*ComboField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#ComboField)[¶](#django.forms.ComboField)
...
Takes one extra required argument:
   ...
   fields[¶](#django.forms.ComboField.fields)
...
### MultiValueField¶
   ...
   *class*MultiValueField(*fields=()*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#MultiValueField)[¶](#django.forms.MultiValueField)
...
Takes one extra required argument:
   ...
   fields[¶](#django.forms.MultiValueField.fields)
...
Also takes some optional arguments:
   ...
   require_all_fields[¶](#django.forms.MultiValueField.require_all_fields)
...
```
     ...
     widget[¶](#django.forms.MultiValueField.widget)

Must be a subclass of [django.forms.MultiWidget](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.MultiWidget).
Default value is [TextInput](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.TextInput), which
probably is not very useful in this case.

    compress(*data_list*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#MultiValueField.compress)[¶](#django.forms.MultiValueField.compress)
...
### SplitDateTimeField¶
   ...
   *class*SplitDateTimeField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/fields/#SplitDateTimeField)[¶](#django.forms.SplitDateTimeField)

- Default widget: [SplitDateTimeWidget](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.SplitDateTimeWidget)
- Empty value: `None`
- Normalizes to: A Python `datetime.datetime` object.
...
Takes two optional arguments:
   ...
   input_date_formats[¶](#django.forms.SplitDateTimeField.input_date_formats)
...
for [DateField](#django.forms.DateField) are used.
   ...
   input_time_formats[¶](#django.forms.SplitDateTimeField.input_time_formats)
...
### ModelChoiceField¶
   ...
   *class*ModelChoiceField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/models/#ModelChoiceField)[¶](#django.forms.ModelChoiceField)
...
A single argument is required:
   ...
   queryset[¶](#django.forms.ModelChoiceField.queryset)
...
`ModelChoiceField` also takes several optional arguments:
   ...
   empty_label[¶](#django.forms.ModelChoiceField.empty_label)
...
[RadioSelect](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.RadioSelect) and the
[blank](#django.forms.ModelChoiceField.blank) argument is `False`.

    to_field_name[¶](#django.forms.ModelChoiceField.to_field_name)
...
```
     ...
     blank[¶](#django.forms.ModelChoiceField.blank)

When using the [RadioSelect](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.RadioSelect) widget, this optional
...
`ModelChoiceField` also has the attribute:
   ...
   iterator[¶](#django.forms.ModelChoiceField.iterator)
...
### ModelMultipleChoiceField¶
   ...
   *class*ModelMultipleChoiceField(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/forms/models/#ModelMultipleChoiceField)[¶](#django.forms.ModelMultipleChoiceField)
...
A single argument is required:
   ...
   queryset[¶](#django.forms.ModelMultipleChoiceField.queryset)

Same as [ModelChoiceField.queryset](#django.forms.ModelChoiceField.queryset).

Takes one optional argument:

   to_field_name[¶](#django.forms.ModelMultipleChoiceField.to_field_name)
...
`ModelMultipleChoiceField` also has the attribute:
   ...
   iterator[¶](#django.forms.ModelMultipleChoiceField.iterator)
...
You can use a [Select](https://docs.djangoproject.com/en/5.0/ref/widgets/#django.forms.Select) widget subclass to include
...
#### ModelChoiceIterator¶
   ...
   *class*ModelChoiceIterator(*field*)[¶](#django.forms.ModelChoiceIterator)
...
A single argument is required:
   ...
   field[¶](#django.forms.ModelChoiceIterator.field)
...
`ModelChoiceIterator` has the following method:
   ...
   __iter__()[¶](#django.forms.ModelChoiceIterator.__iter__)
...
#### ModelChoiceIteratorValue¶
   ...
   *class*ModelChoiceIteratorValue(*value*, *instance*)[¶](#django.forms.ModelChoiceIteratorValue)

Two arguments are required:

   value[¶](#django.forms.ModelChoiceIteratorValue.value)

The value of the choice. This value is used to render the `value`
attribute of an HTML `<option>` element.

    instance[¶](#django.forms.ModelChoiceIteratorValue.instance)
...
`ModelChoiceIteratorValue` has the following method:
   ...
   __str__()[¶](#django.forms.ModelChoiceIteratorValue.__str__)
...
[get_bound_field()](https://docs.djangoproject.com/en/5.0/ref/api/#django.forms.Field.get_bound_field).
