...
changes” section of the [release note](https://docs.djangoproject.com/en/releases/) for the version
...
- If, for some reason, an API declared stable must be removed or replaced, it
  ...
  called.
  See [Official releases](https://docs.djangoproject.com/en/internals/release-process/#official-releases) for more details on how Django’s version
...
anything in the [internals area](https://docs.djangoproject.com/en/internals/) is considered stable.
...
[security reporting policy](https://docs.djangoproject.com/en/internals/security/#reporting-security-issues) – we’ll do
...
This is the reasoning behind the [APPEND_SLASH](https://docs.djangoproject.com/en/ref/settings/#std-setting-APPEND_SLASH) setting.
...
This is the philosophy behind [template inheritance](https://docs.djangoproject.com/en/ref/templates/language/#template-inheritance).
...
Language (DTL)](https://docs.djangoproject.com/en/topics/templates/#template-language-intro) aims to avoid advanced logic.
...
The core goals of Django’s [cache framework](https://docs.djangoproject.com/en/topics/cache/) are:
...
developer’s needs (for example, see [Cache key transformation](https://docs.djangoproject.com/en/topics/cache/#cache-key-transformation)).
...
instructions for [installing the development version](https://docs.djangoproject.com/en/topics/install/#installing-development-version) from our Git repository.
...
Please join the [django-developers](https://docs.djangoproject.com/en/internals/mailing-lists/#django-developers-mailing-list) mailing list and introduce yourself.

We also encourage all distributors to subscribe to the [django-announce](https://docs.djangoproject.com/en/internals/mailing-lists/#django-announce-mailing-list) mailing
