...
- **Asynchronous iteration.** A `QuerySet` can also be iterated over using
  ...
  underlying cache.
- **Slicing.** As explained in [Limiting QuerySets](https://docs.djangoproject.com/en/topics/db/queries/#limiting-querysets), a `QuerySet` can
...
If you recreate [QuerySet.values_list()](#django.db.models.query.QuerySet.values_list) using the pickled `query`
attribute, it will be converted to [QuerySet.values()](#django.db.models.query.QuerySet.values):
...
Here’s the formal declaration of a `QuerySet`:
   ...
   *class*QuerySet(*model=None*, *query=None*, *using=None*, *hints=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/query/#QuerySet)[¶](#django.db.models.query.QuerySet)

Usually when you’ll interact with a `QuerySet` you’ll use it by
[chaining filters](https://docs.djangoproject.com/en/topics/db/queries/#chaining-filters). To make this work, most
...
These methods do not run database queries, therefore they are **safe to** **run in asynchronous code**, and do not have separate asynchronous
versions.

#### filter()¶

   filter(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.filter)

Returns a new `QuerySet` containing objects that match the given lookup
parameters.

The lookup parameters (`**kwargs`) should be in the format described in
[Field lookups](#id4) below. Multiple parameters are joined via `AND` in the
underlying SQL statement.

If you need to execute more complex queries (for example, queries with `OR` statements),
you can use [Qobjects](#django.db.models.Q) (`*args`).

#### exclude()¶

   exclude(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.exclude)
...
#### annotate()¶
   ...
   annotate(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.annotate)

Annotates each object in the `QuerySet` with the provided list of [query
expressions](https://docs.djangoproject.com/en/5.0/ref/expressions/). An expression may be a simple value, a
...
in [Aggregation Functions](#id6) below.
...
Aggregation](https://docs.djangoproject.com/en/topics/db/aggregation/).

#### alias()¶

   alias(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.alias)
...
#### order_by()¶
   ...
   order_by(**fields*)[¶](#django.db.models.query.QuerySet.order_by)
...
primary key if there is no [Meta.ordering](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.ordering) specified. For example, since the `Blog`
...
You can also order by [query expressions](https://docs.djangoproject.com/en/5.0/ref/expressions/) by
calling [asc()](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.Expression.asc) or [desc()](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.Expression.desc) on the
expression:
...
[asc()](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.Expression.asc) and [desc()](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.Expression.desc) have arguments
...
(for example, a [ManyToManyField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ManyToManyField) field, or the
reverse relation of a [ForeignKey](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey) field).
...
[Lower](https://docs.djangoproject.com/en/5.0/ref/database-functions/#django.db.models.functions.Lower) which will achieve case-consistent
ordering:
...
#### reverse()¶
   ...
   reverse()[¶](#django.db.models.query.QuerySet.reverse)
...
#### distinct()¶
   ...
   distinct(**fields*)[¶](#django.db.models.query.QuerySet.distinct)
...
the `Blog` model defined an [ordering](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.ordering) by
`name`:
...
#### values()¶
   ...
   values(**fields*, ***expressions*)[¶](#django.db.models.query.QuerySet.values)
...
You can use built-in and [custom lookups](https://docs.djangoproject.com/en/howto/custom-lookups/) in
...
- If you have a field called `foo` that is a
  [ForeignKey](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey), the default `values()` call
...
Because [ManyToManyField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ManyToManyField) attributes and reverse
...
[JSONField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.JSONField) key transforms.

#### values_list()¶

   values_list(**fields*, *flat=False*, *named=False*)[¶](#django.db.models.query.QuerySet.values_list)
...
[ManyToManyField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ManyToManyField):
...
#### dates()¶
   ...
   dates(*field*, *kind*, *order='ASC'*)[¶](#django.db.models.query.QuerySet.dates)
...
#### datetimes()¶
   ...
   datetimes(*field_name*, *kind*, *order='ASC'*, *tzinfo=None*)[¶](#django.db.models.query.QuerySet.datetimes)
...
object. If it’s `None`, Django uses the [current time zone](https://docs.djangoproject.com/en/topics/i18n/timezones/#default-current-time-zone). It has no effect when [USE_TZ](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ) is
`False`.
...
#### none()¶
   ...
   none()[¶](#django.db.models.query.QuerySet.none)
...
#### all()¶
   ...
   all()[¶](#django.db.models.query.QuerySet.all)
...
#### union()¶
   ...
   union(**other_qs*, *all=False*)[¶](#django.db.models.query.QuerySet.union)
...
#### intersection()¶
   ...
   intersection(**other_qs*)[¶](#django.db.models.query.QuerySet.intersection)
...
#### difference()¶
   ...
   difference(**other_qs*)[¶](#django.db.models.query.QuerySet.difference)
...
#### select_related()¶
   ...
   select_related(**fields*)[¶](#django.db.models.query.QuerySet.select_related)
...
You can refer to any [ForeignKey](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey) or
[OneToOneField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.OneToOneField) relation in the list of fields
passed to `select_related()`.

You can also refer to the reverse direction of a
[OneToOneField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.OneToOneField) in the list of fields passed to
`select_related` — that is, you can traverse a
[OneToOneField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.OneToOneField) back to the object on which the field
is defined. Instead of specifying the field name, use the [related_name](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey.related_name) for the field on the related object.
...
#### prefetch_related()¶
   ...
   prefetch_related(**lookups*)[¶](#django.db.models.query.QuerySet.prefetch_related)
...
[GenericRelation](https://docs.djangoproject.com/en/5.0/contrib/contenttypes/#django.contrib.contenttypes.fields.GenericRelation) objects which
...
[GenericForeignKey](https://docs.djangoproject.com/en/5.0/contrib/contenttypes/#django.contrib.contenttypes.fields.GenericForeignKey), however, the
queryset for each `ContentType` must be provided in the `querysets`
parameter of [GenericPrefetch](https://docs.djangoproject.com/en/5.0/contrib/contenttypes/#django.contrib.contenttypes.prefetch.GenericPrefetch).

  Changed in Django 5.0:

Support for prefetching
[GenericForeignKey](https://docs.djangoproject.com/en/5.0/contrib/contenttypes/#django.contrib.contenttypes.fields.GenericForeignKey) with
...
[add()](https://docs.djangoproject.com/en/5.0/ref/relations/#django.db.models.fields.related.RelatedManager.add),
[remove()](https://docs.djangoproject.com/en/5.0/ref/relations/#django.db.models.fields.related.RelatedManager.remove),
[clear()](https://docs.djangoproject.com/en/5.0/ref/relations/#django.db.models.fields.related.RelatedManager.clear) or
[set()](https://docs.djangoproject.com/en/5.0/ref/relations/#django.db.models.fields.related.RelatedManager.set), on
[relatedmanagers](https://docs.djangoproject.com/en/5.0/ref/relations/#django.db.models.fields.related.RelatedManager),
...
- You want to use performance optimization techniques like
  [deferredfields](#django.db.models.query.QuerySet.defer):
  ```
...
#### extra()¶
   ...
   extra(*select=None*, *where=None*, *params=None*, *tables=None*, *order_by=None*, *select_params=None*)[¶](#django.db.models.query.QuerySet.extra)

Sometimes, the Django query syntax by itself can’t easily express a complex
`WHERE` clause. For these edge cases, Django provides the `extra()` `QuerySet` modifier — a hook for injecting specific clauses into the SQL
...
keyword](https://code.djangoproject.com/query?status=assigned&status=new&keywords=~QuerySet.extra)
...
The main benefit of using [RawSQL](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.expressions.RawSQL) is
...
You can read more about how Django’s [SQL injection protection](https://docs.djangoproject.com/en/topics/security/#sql-injection-protection) works.
...
#### defer()¶
   ...
   defer(**fields*)[¶](#django.db.models.query.QuerySet.defer)
...
Even if you think you are in the advanced use-case situation, **only use** `defer()` **when you cannot, at queryset load time, determine if you will
...
[managedattribute](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.managed) documentation)
...
When calling [save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save) for instances with
deferred fields, only the loaded fields will be saved. See
[save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save) for more details.

#### only()¶

   only(**fields*)[¶](#django.db.models.query.QuerySet.only)
...
Using `only()` and omitting a field requested using [select_related()](#django.db.models.query.QuerySet.select_related) is
...
#### using()¶
   ...
   using(*alias*)[¶](#django.db.models.query.QuerySet.using)

This method is for controlling which database the `QuerySet` will be
evaluated against if you are using more than one database.  The only argument
this method takes is the alias of a database, as defined in
[DATABASES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASES).
...
#### select_for_update()¶
   ...
   select_for_update(*nowait=False*, *skip_locked=False*, *of=()*, *no_key=False*)[¶](#django.db.models.query.QuerySet.select_for_update)
...
another transaction, [DatabaseError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.DatabaseError) will be raised when the
...
If you want to lock parents models when using [multi-table inheritance](https://docs.djangoproject.com/en/topics/db/models/#multi-table-inheritance), you must specify parent link fields (by default
...
[values()](#django.db.models.query.QuerySet.values), you must select at least one field from each model in the
...
options, such as MySQL, raises a [NotSupportedError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.NotSupportedError). This
prevents code from unexpectedly blocking.

Evaluating a queryset with `select_for_update()` in autocommit mode on
backends which support `SELECT ... FOR UPDATE` is a
[TransactionManagementError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.transaction.TransactionManagementError) error because the
...
[TestCase](https://docs.djangoproject.com/en/topics/testing/tools/#django.test.TestCase) automatically wraps each test in a
transaction, calling `select_for_update()` in a `TestCase` even outside
an [atomic()](https://docs.djangoproject.com/en/topics/db/transactions/#django.db.transaction.atomic) block will (perhaps unexpectedly)
pass without raising a `TransactionManagementError`. To properly test
`select_for_update()` you should use
[TransactionTestCase](https://docs.djangoproject.com/en/topics/testing/tools/#django.test.TransactionTestCase).

Certain expressions may not be supported

PostgreSQL doesn’t support `select_for_update()` with
[Window](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.expressions.Window) expressions.

#### raw()¶

   raw(*raw_query*, *params=()*, *translations=None*, *using=None*)[¶](#django.db.models.query.QuerySet.raw)
...
See the [Performing raw SQL queries](https://docs.djangoproject.com/en/topics/db/sql/) for more information.
...
### Operators that return newQuerySets¶
...
These methods do not use a cache (see [Caching and QuerySets](https://docs.djangoproject.com/en/topics/db/queries/#caching-and-querysets)). Rather,
...
#### get()¶
   ...
   get(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.get)    aget(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.aget)

*Asynchronous version*: `aget()`

Returns the object matching the given lookup parameters, which should be in
the format described in [Field lookups](#id4). You should use lookups that are
...
If `get()` doesn’t find any object, it raises a [Model.DoesNotExist](https://docs.djangoproject.com/en/5.0/ref/class/#django.db.models.Model.DoesNotExist) exception:
...
[Model.MultipleObjectsReturned](https://docs.djangoproject.com/en/5.0/ref/class/#django.db.models.Model.MultipleObjectsReturned) exception:
...
can use [django.core.exceptions.ObjectDoesNotExist](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.ObjectDoesNotExist)  to handle
[DoesNotExist](https://docs.djangoproject.com/en/5.0/ref/class/#django.db.models.Model.DoesNotExist) exceptions from multiple models:
...
#### create()¶
   ...
   create(***kwargs*)[¶](#django.db.models.query.QuerySet.create)    acreate(***kwargs*)[¶](#django.db.models.query.QuerySet.acreate)
...
The [force_insert](https://docs.djangoproject.com/en/5.0/ref/instances/#ref-models-force-insert) parameter is documented
elsewhere, but all it means is that a new object will always be created.
Normally you won’t need to worry about this. However, if your model contains a
manual primary key value that you set and if that value already exists in the
database, a call to `create()` will fail with an
[IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError) since primary keys must be unique. Be
prepared to handle the exception if you are using manual primary keys.

#### get_or_create()¶

   get_or_create(*defaults=None*, ***kwargs*)[¶](#django.db.models.query.QuerySet.get_or_create)    aget_or_create(*defaults=None*, ***kwargs*)[¶](#django.db.models.query.QuerySet.aget_or_create)
...
keyword arguments (see [unique](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.Field.unique) or
[unique_together](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.unique_together)). If the fields used in the
...
`get_or_create()` with `filter()` and using [Qobjects](#django.db.models.Q). For example, to retrieve Robert or Bob Marley if either
...
[MultipleObjectsReturned](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.MultipleObjectsReturned). If an object is *not*
...
[IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError) will be raised.
...
You can use `get_or_create()` through [ManyToManyField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ManyToManyField)
...
#### update_or_create()¶
   ...
   update_or_create(*defaults=None*, *create_defaults=None*, ***kwargs*)[¶](#django.db.models.query.QuerySet.update_or_create)    aupdate_or_create(*defaults=None*, *create_defaults=None*, ***kwargs*)[¶](#django.db.models.query.QuerySet.aupdate_or_create)
...
exists in the database, an [IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError) is raised.

  Changed in Django 4.2:

In older versions, `update_or_create()` didn’t specify `update_fields`
when calling [Model.save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save).
...
- If the model’s primary key is an [AutoField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.AutoField) and
...
#### bulk_update()¶
   ...
   bulk_update(*objs*, *fields*, *batch_size=None*)[¶](#django.db.models.query.QuerySet.bulk_update)    abulk_update(*objs*, *fields*, *batch_size=None*)[¶](#django.db.models.query.QuerySet.abulk_update)
...
[QuerySet.update()](#django.db.models.query.QuerySet.update) is used to save the changes, so this is more efficient
than iterating through the list of models and calling `save()` on each of
them, but it has a few caveats:

- You cannot update the model’s primary key.
- Each model’s `save()` method isn’t called, and the
  [pre_save](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.pre_save) and
  [post_save](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.post_save) signals aren’t sent.
...
#### count()¶
   ...
   count()[¶](#django.db.models.query.QuerySet.count)    acount()[¶](#django.db.models.query.QuerySet.acount)
...
#### in_bulk()¶
   ...
   in_bulk(*id_list=None*, ***, *field_name='pk'*)[¶](#django.db.models.query.QuerySet.in_bulk)    ain_bulk(*id_list=None*, ***, *field_name='pk'*)[¶](#django.db.models.query.QuerySet.ain_bulk)
...
[django.core.exceptions.ObjectDoesNotExist](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.ObjectDoesNotExist) exceptions will ever be raised
...
#### iterator()¶
   ...
   iterator(*chunk_size=None*)[¶](#django.db.models.query.QuerySet.iterator)    aiterator(*chunk_size=None*)[¶](#django.db.models.query.QuerySet.aiterator)
...
Oracle and [PostgreSQL](https://docs.djangoproject.com/en/5.0/databases/#postgresql-server-side-cursors) use server-side
...
[DISABLE_SERVER_SIDE_CURSORS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DATABASE-DISABLE_SERVER_SIDE_CURSORS)
setting is `False`. Read [Transaction pooling and server-side cursors](https://docs.djangoproject.com/en/5.0/databases/#transaction-pooling-server-side-cursors) if
...
writing to the table being iterated over. See [Isolation when using QuerySet.iterator()](https://docs.djangoproject.com/en/5.0/databases/#sqlite-isolation) for
more information.
...
#### latest()¶
   ...
   latest(**fields*)[¶](#django.db.models.query.QuerySet.latest)    alatest(**fields*)[¶](#django.db.models.query.QuerySet.alatest)
...
If your model’s [Meta](https://docs.djangoproject.com/en/topics/db/models/#meta-options) specifies
[get_latest_by](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.get_latest_by), you can omit any arguments to
`earliest()` or `latest()`. The fields specified in
[get_latest_by](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.get_latest_by) will be used by default.

Like [get()](#django.db.models.query.QuerySet.get), `earliest()` and `latest()` raise
[DoesNotExist](https://docs.djangoproject.com/en/5.0/ref/class/#django.db.models.Model.DoesNotExist) if there is no object with the
given parameters.
...
#### earliest()¶
   ...
   earliest(**fields*)[¶](#django.db.models.query.QuerySet.earliest)    aearliest(**fields*)[¶](#django.db.models.query.QuerySet.aearliest)
...
#### first()¶
   ...
   first()[¶](#django.db.models.query.QuerySet.first)    afirst()[¶](#django.db.models.query.QuerySet.afirst)
...
aggregation results as described in [Interaction with order_by()](https://docs.djangoproject.com/en/topics/db/aggregation/#aggregation-ordering-interaction).
...
#### last()¶
   ...
   last()[¶](#django.db.models.query.QuerySet.last)    alast()[¶](#django.db.models.query.QuerySet.alast)
...
#### aggregate()¶
   ...
   aggregate(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.aggregate)    aaggregate(**args*, ***kwargs*)[¶](#django.db.models.query.QuerySet.aaggregate)
...
[Aggregation Functions](#id6) below. Since aggregates are also [query
expressions](https://docs.djangoproject.com/en/5.0/ref/expressions/), you may combine aggregates with other
...
#### exists()¶
   ...
   exists()[¶](#django.db.models.query.QuerySet.exists)    aexists()[¶](#django.db.models.query.QuerySet.aexists)
...
[exists()](#django.db.models.query.QuerySet.exists) is useful for searches relating to the existence of
...
#### contains()¶
   ...
   contains(*obj*)[¶](#django.db.models.query.QuerySet.contains)    acontains(*obj*)[¶](#django.db.models.query.QuerySet.acontains)
...
Like [exists()](#django.db.models.query.QuerySet.exists), if `some_queryset` has not yet been evaluated, but you
...
#### update()¶
   ...
   update(***kwargs*)[¶](#django.db.models.query.QuerySet.update)    aupdate(***kwargs*)[¶](#django.db.models.query.QuerySet.aupdate)
...
[pre_save](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.pre_save) or
[post_save](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.post_save) signals (which are a consequence of
calling [Model.save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save)). If you want to
update a bunch of records for a model that has a custom
[save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save) method, loop over them and call
[save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save), like this:
...
#### delete()¶
   ...
   delete()[¶](#django.db.models.query.QuerySet.delete)    adelete()[¶](#django.db.models.query.QuerySet.adelete)
...
By default, Django’s [ForeignKey](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey) emulates the SQL
...
[on_delete](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey.on_delete) argument to the
[ForeignKey](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey).

The `delete()` method does a bulk delete and does not call any `delete()`
methods on your models. It does, however, emit the
[pre_delete](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.pre_delete) and
[post_delete](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.post_delete) signals for all deleted objects
...
ForeignKeys which are set to [on_delete](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.ForeignKey.on_delete) `DO_NOTHING` do not prevent taking the fast-path in deletion.
...
#### as_manager()¶
   ...
   *classmethod*as_manager()[¶](#django.db.models.query.QuerySet.as_manager)

Class method that returns an instance of [Manager](https://docs.djangoproject.com/en/topics/db/managers/#django.db.models.Manager)
with a copy of the `QuerySet`’s methods. See
[Creating a manager with QuerySet methods](https://docs.djangoproject.com/en/topics/db/managers/#create-manager-with-queryset-methods) for more details.
...
#### explain()¶
   ...
   explain(*format=None*, ***options*)[¶](#django.db.models.query.QuerySet.explain)    aexplain(*format=None*, ***options*)[¶](#django.db.models.query.QuerySet.aexplain)
...
For an introduction, see [models and database queries documentation](https://docs.djangoproject.com/en/topics/db/queries/#field-lookups-intro).

Django’s built-in lookups are listed below. It is also possible to write
[custom lookups](https://docs.djangoproject.com/en/howto/custom-lookups/) for model fields.

As a convenience when no lookup type is provided (like in
`Entry.objects.get(id=14)`) the lookup type is assumed to be [exact](#std-fieldlookup-exact).
...
information about this, see the [collation section](https://docs.djangoproject.com/en/5.0/databases/#mysql-collation)
in the [databases](https://docs.djangoproject.com/en/5.0/databases/) documentation.

#### iexact¶

Case-insensitive exact match. If the value provided for comparison is `None`,
it will be interpreted as an SQL `NULL` (see [isnull](#std-fieldlookup-isnull) for more
details).
...
[database note](https://docs.djangoproject.com/en/5.0/databases/#sqlite-string-matching) about string comparisons.
...
acts like `icontains` for SQLite. See the [database note](https://docs.djangoproject.com/en/5.0/databases/#sqlite-string-matching) for more information.
...
[QuerySets are lazy](https://docs.djangoproject.com/en/topics/db/queries/#querysets-are-lazy).
...
acts like `iendswith` for SQLite. Refer to the [database note](https://docs.djangoproject.com/en/5.0/databases/#sqlite-string-matching) documentation for more.
...
When [USE_TZ](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ) is `True`, fields are converted to the current time
...
When [USE_TZ](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ) is `True`, datetime fields are converted to the
...
to [ISO-8601](https://en.wikipedia.org/wiki/ISO-8601), i.e., weeks start
...
lookups. Takes a [datetime.time](https://docs.python.org/3/library/datetime.html#datetime.time) value.
...
aggregate functions, see [the topic guide on aggregation](https://docs.djangoproject.com/en/topics/db/aggregation/). See the [Aggregate](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.Aggregate)
...
[query expressions](https://docs.djangoproject.com/en/5.0/ref/expressions/).

#### output_field¶

An optional argument that represents the [model field](https://docs.djangoproject.com/en/5.0/ref/fields/)
of the return value
...
An optional [Qobject](#django.db.models.Q) that’s used to filter the
rows that are aggregated.

See [Conditional aggregation](https://docs.djangoproject.com/en/5.0/ref/conditional-expressions/#conditional-aggregation) and [Filtering on annotations](https://docs.djangoproject.com/en/topics/db/aggregation/#filtering-on-annotations) for
example usage.
...
#### Avg¶
   ...
   *class*Avg(*expression*, *output_field=None*, *distinct=False*, *filter=None*, *default=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#Avg)[¶](#django.db.models.Avg)
...
- Return type: `float` if input is `int`, otherwise same as input
  ...
  empty, `default` is returned.
   ...
   distinct[¶](#django.db.models.Avg.distinct)
...
#### Count¶
   ...
   *class*Count(*expression*, *distinct=False*, *filter=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#Count)[¶](#django.db.models.Count)
...
- Return type: `int`
   ...
   distinct[¶](#django.db.models.Count.distinct)
...
#### Max¶
   ...
   *class*Max(*expression*, *output_field=None*, *filter=None*, *default=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#Max)[¶](#django.db.models.Max)
...
#### Min¶
   ...
   *class*Min(*expression*, *output_field=None*, *filter=None*, *default=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#Min)[¶](#django.db.models.Min)
...
#### StdDev¶
   ...
   *class*StdDev(*expression*, *output_field=None*, *sample=False*, *filter=None*, *default=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#StdDev)[¶](#django.db.models.StdDev)
...
- Return type: `float` if input is `int`, otherwise same as input
  ...
  empty, `default` is returned.
   ...
   sample[¶](#django.db.models.StdDev.sample)
...
#### Sum¶
   ...
   *class*Sum(*expression*, *output_field=None*, *distinct=False*, *filter=None*, *default=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#Sum)[¶](#django.db.models.Sum)
...
- Return type: same as input field, or `output_field` if supplied. If the
  queryset or grouping is empty, `default` is returned.
   ...
   distinct[¶](#django.db.models.Sum.distinct)
...
#### Variance¶
   ...
   *class*Variance(*expression*, *output_field=None*, *sample=False*, *filter=None*, *default=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#Variance)[¶](#django.db.models.Variance)
...
- Return type: `float` if input is `int`, otherwise same as input
  ...
  empty, `default` is returned.
   ...
   sample[¶](#django.db.models.Variance.sample)
...
### Q()objects¶
   ...
   *class*Q[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/query_utils/#Q)[¶](#django.db.models.Q)

A `Q()` object represents an SQL condition that can be used in
database-related operations. It’s similar to how an
[F()](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.F) object represents the value of a model field
...
[Complex lookups with Q objects](https://docs.djangoproject.com/en/topics/db/queries/#complex-lookups-with-q).

### Prefetch()objects¶

   *class*Prefetch(*lookup*, *queryset=None*, *to_attr=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/query/#Prefetch)[¶](#django.db.models.Prefetch)
...
### prefetch_related_objects()¶
   ...
   prefetch_related_objects(*model_instances*, **related_lookups*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/query/#prefetch_related_objects)[¶](#django.db.models.prefetch_related_objects)    aprefetch_related_objects(*model_instances*, **related_lookups*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/query/#aprefetch_related_objects)[¶](#django.db.models.aprefetch_related_objects)
...
lookups or [Prefetch](#django.db.models.Prefetch) objects you want to prefetch for. For example:
...
### FilteredRelation()objects¶
   ...
   *class*FilteredRelation(*relation_name*, ***, *condition=Q()*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/query_utils/#FilteredRelation)[¶](#django.db.models.FilteredRelation)   relation_name[¶](#django.db.models.FilteredRelation.relation_name)

The name of the field on which you’d like to filter the relation.

    condition[¶](#django.db.models.FilteredRelation.condition)

A [Q](#django.db.models.Q) object to control the filtering.
...
- [QuerySet.only()](#django.db.models.query.QuerySet.only) and [prefetch_related()](#django.db.models.query.QuerySet.prefetch_related).
- A [GenericForeignKey](https://docs.djangoproject.com/en/5.0/contrib/contenttypes/#django.contrib.contenttypes.fields.GenericForeignKey)
