...
The [Cache Framework design philosophy](https://docs.djangoproject.com/en/misc/design-philosophies/#cache-design-philosophy)
...
Your cache preference goes in the [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting in your
...
- Set [BACKEND](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-BACKEND) to
...
- Set [LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION) to `ip:port` values,
...
[LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION), either as a semicolon or comma
...
override them in your [OPTIONS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-OPTIONS)):
...
- Set [LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION) to the URL pointing to your Redis
...
- Set [LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION) to `tablename`, the name of the
...
[LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION).

If you are using multiple database caches, [createcachetable](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-createcachetable) creates
one table for each cache.

If you are using multiple databases, [createcachetable](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-createcachetable) observes the
`allow_migrate()` method of your database routers (see below).

Like [migrate](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-migrate), [createcachetable](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-createcachetable) won’t touch an existing
table. It will only create missing tables.

To print the SQL that would be run, rather than run it, use the
[createcachetable--dry-run](https://docs.djangoproject.com/en/ref/django-admin/#cmdoption-createcachetable-dry-run) option.
...
file. To use this backend set [BACKEND](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-BACKEND) to
`"django.core.cache.backends.filebased.FileBasedCache"` and
[LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION) to a suitable directory. For example,
...
When the cache [LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION) is contained within
[MEDIA_ROOT](https://docs.djangoproject.com/en/ref/settings/#std-setting-MEDIA_ROOT), [STATIC_ROOT](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATIC_ROOT), or
[STATICFILES_FINDERS](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATICFILES_FINDERS), sensitive data may be exposed.
...
per-process (see below) and thread-safe. To use it, set [BACKEND](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-BACKEND) to `"django.core.cache.backends.locmem.LocMemCache"`. For
example:
...
The cache [LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION) is used to identify individual
memory stores. If you only have one `locmem` cache, you can omit the
[LOCATION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-LOCATION); however, if you have more than one local
...
activate dummy caching, set [BACKEND](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-BACKEND) like so:
...
[BACKEND](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-BACKEND) of the [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting, like so:
...
[CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting. Valid arguments are as follows:

- [TIMEOUT](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-TIMEOUT): The default timeout, in
  ...
  “don’t cache”).
- [OPTIONS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-OPTIONS): Any options that should be
  ...
  The Memcached and Redis backends pass the contents of [OPTIONS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-OPTIONS) as keyword arguments to the client constructors, allowing
  for more advanced control of client behavior. For example usage, see below.
- [KEY_PREFIX](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-KEY_PREFIX): A string that will be
  ...
  more information.
- [VERSION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-VERSION): The default version number
  for cache keys generated by the Django server.
  See the [cache documentation](#cache-versioning) for more
  information.
- [KEY_FUNCTION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-KEY_FUNCTION)
...
[parser class](https://github.com/redis/redis-py#parsers) (`redis.connection.HiredisParser` will be used by default if
the `hiredis-py` package is installed), and sets a custom [connection pool
class](https://github.com/redis/redis-py#connection-pools) (`redis.ConnectionPool` is used by default):
...
[MIDDLEWARE](https://docs.djangoproject.com/en/ref/settings/#std-setting-MIDDLEWARE) setting, as in this example:
...
see [Order of MIDDLEWARE](#order-of-middleware) below if you’d like the full story.

Then, add the following required settings to your Django settings file:

- [CACHE_MIDDLEWARE_ALIAS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_ALIAS) – The cache alias to use for storage.
- [CACHE_MIDDLEWARE_SECONDS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_SECONDS) – The integer number of seconds each
  page should be cached.
- [CACHE_MIDDLEWARE_KEY_PREFIX](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_KEY_PREFIX) – If the cache is shared across
...
each [HttpResponse](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse) which affect [downstream caches](#downstream-caches):

- Sets the `Expires` header to the current date/time plus the defined
  [CACHE_MIDDLEWARE_SECONDS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_SECONDS).
- Sets the `Cache-Control` header to give a max age for the page –
  again, from the [CACHE_MIDDLEWARE_SECONDS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_SECONDS) setting.

See [Middleware](https://docs.djangoproject.com/en/5.0/http/middleware/) for more on middleware.

If a view sets its own cache expiry time (i.e. it has a `max-age` section in
its `Cache-Control` header) then the page will be cached until the expiry
time, rather than [CACHE_MIDDLEWARE_SECONDS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_SECONDS). Using the decorators in
`django.views.decorators.cache` you can easily set a view’s expiry time
(using the [cache_control()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.cache_control) decorator) or
disable caching for a view (using the
[never_cache()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.never_cache) decorator). See the
[using other headers](#controlling-cache-using-other-headers) section for more on these decorators.

If [USE_I18N](https://docs.djangoproject.com/en/ref/settings/#std-setting-USE_I18N) is set to `True` then the generated cache key will
include the name of the active [language](https://docs.djangoproject.com/en/5.0/i18n/#term-language-code) – see also
[How Django discovers language preference](https://docs.djangoproject.com/en/5.0/i18n/translation/#how-django-discovers-language-preference)). This allows you to easily
cache multilingual sites without having to create the cache key yourself.

Cache keys also include the [current time zone](https://docs.djangoproject.com/en/5.0/i18n/timezones/#default-current-time-zone) when [USE_TZ](https://docs.djangoproject.com/en/ref/settings/#std-setting-USE_TZ) is set to `True`.

## The per-view cache¶

   django.views.decorators.cache.cache_page(*timeout*, ***, *cache=None*, *key_prefix=None*)[¶](#django.views.decorators.cache.cache_page)
...
[CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting) when caching view results. By default, the
...
which works in the same way as the [CACHE_MIDDLEWARE_KEY_PREFIX](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_KEY_PREFIX)
...
`key_prefix` argument and the [KEY_PREFIX](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-KEY_PREFIX)
specified under [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) will be concatenated.
...
If [USE_I18N](https://docs.djangoproject.com/en/ref/settings/#std-setting-USE_I18N) is set to `True` the per-site middleware cache will
[respect the active language](#i18n-cache-key). For the `cache` template
tag you could use one of the
[translation-specific variables](https://docs.djangoproject.com/en/5.0/i18n/translation/#template-translation-vars) available in
...
It is considered an error to specify a cache name that is not configured.
   ...
   django.core.cache.utils.make_template_fragment_key(*fragment_name*, *vary_on=None*)[¶](#django.core.cache.utils.make_template_fragment_key)
...
### Accessing the cache¶
   ...
   django.core.cache.caches[¶](#django.core.cache.caches)

You can access the caches configured in the [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting
...
The basic interface is:
   ...
   cache.set(*key*, *value*, *timeout=DEFAULT_TIMEOUT*, *version=None*)[¶](#django.core.cache.cache.set)

```
>>> cache.set("my_key", "hello, world!", 30)
```

    cache.get(*key*, *default=None*, *version=None*)[¶](#django.core.cache.cache.get)
...
of the appropriate backend in the [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting (explained above).
...
```
    ...
    cache.add(*key*, *value*, *timeout=DEFAULT_TIMEOUT*, *version=None*)[¶](#django.core.cache.cache.add)
...
`False` otherwise.
   ...
   cache.get_or_set(*key*, *default*, *timeout=DEFAULT_TIMEOUT*, *version=None*)[¶](#django.core.cache.cache.get_or_set)
...
```
    ...
    cache.get_many(*keys*, *version=None*)[¶](#django.core.cache.cache.get_many)
...
```
    ...
    cache.set_many(*dict*, *timeout*)[¶](#django.core.cache.cache.set_many)
...
failed to be inserted.
   ...
   cache.delete(*key*, *version=None*)[¶](#django.core.cache.cache.delete)
...
otherwise.
   ...
   cache.delete_many(*keys*, *version=None*)[¶](#django.core.cache.cache.delete_many)
...
```
    ...
    cache.clear()[¶](#django.core.cache.cache.clear)
...
```
    ...
    cache.touch(*key*, *timeout=DEFAULT_TIMEOUT*, *version=None*)[¶](#django.core.cache.cache.touch)
...
`TIMEOUT` option of the appropriate backend in the [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting.

`touch()` returns `True` if the key was successfully touched, `False`
otherwise.

   cache.incr(*key*, *delta=1*, *version=None*)[¶](#django.core.cache.cache.incr)    cache.decr(*key*, *delta=1*, *version=None*)[¶](#django.core.cache.cache.decr)
...
operation, it will be implemented using a two-step retrieve/update.
    ...
    cache.close()[¶](#django.core.cache.cache.close)
...
`cache.aadd()` or `cache.adelete_many()`. See [Asynchronous support](#id14)
for more details.
...
[KEY_PREFIX](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-KEY_PREFIX) cache setting.

By ensuring each Django instance has a different
[KEY_PREFIX](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-KEY_PREFIX), you can ensure that there will be no
...
specified using the [VERSION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-VERSION) cache setting.
...
The [KEY_FUNCTION](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-KEY_FUNCTION) cache setting
...
method, and follow the instructions for [using a custom cache backend](#using-a-custom-cache-backend). For
...
[BACKEND](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES-BACKEND) portion of your [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting.
...
[django.views.decorators.vary.vary_on_headers()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.vary.vary_on_headers) view decorator, like so:
...
[django.views.decorators.vary.vary_on_cookie()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.vary.vary_on_cookie) decorator. These two views
are equivalent:
...
You can also use a helper function, [django.utils.cache.patch_vary_headers()](https://docs.djangoproject.com/en/ref/utils/#django.utils.cache.patch_vary_headers),
...
`patch_vary_headers` takes an [HttpResponse](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse) instance as
...
Django, use the [cache_control()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.cache_control) view
decorator. Example:
...
[patch_cache_control()](https://docs.djangoproject.com/en/ref/utils/#django.utils.cache.patch_cache_control), the manual way to modify the
cache control header (it is internally called by the
[cache_control()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.cache_control) decorator):
...
the value of the [CACHE_MIDDLEWARE_SECONDS](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHE_MIDDLEWARE_SECONDS) setting. In that case,
the custom `max_age` from the
[cache_control()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.cache_control) decorator will take
...
[never_cache()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.never_cache) is a view decorator that
...
place within the [MIDDLEWARE](https://docs.djangoproject.com/en/ref/settings/#std-setting-MIDDLEWARE) setting. That’s because the cache
