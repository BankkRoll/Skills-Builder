# How to create custom template tags and filters¶ and more
...
tags and filters](https://docs.djangoproject.com/en/ref/templates/builtins/) designed to address the
...
available to your templates using the [{%load%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-load) tag.
...
to [INSTALLED_APPS](https://docs.djangoproject.com/en/ref/settings/#std-setting-INSTALLED_APPS), any tags it defines in the conventional location
...
The app that contains the custom tags must be in [INSTALLED_APPS](https://docs.djangoproject.com/en/ref/settings/#std-setting-INSTALLED_APPS) in
order for the [{%load%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-load) tag to work. This is a security feature:
...
Just keep in mind that a [{%load%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-load) statement will load
...
[DjangoTemplates](https://docs.djangoproject.com/en/topics/templates/#django.template.backends.django.DjangoTemplates). This is useful if
...
and tags. They’re in [django/template/defaultfilters.py](https://github.com/django/django/blob/main/django/template/defaultfilters.py) and
[django/template/defaulttags.py](https://github.com/django/django/blob/main/django/template/defaulttags.py), respectively.

For more information on the [load](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-load) tag, read its documentation.
...
### Registering custom filters¶
   ...
   django.template.Library.filter()[¶](#django.template.Library.filter)
...
### Template filters that expect strings¶
   ...
   django.template.defaultfilters.stringfilter()[¶](#django.template.defaultfilters.stringfilter)
...
- **Safe strings** are strings that have been marked safe from further
  ...
  [SafeString](https://docs.djangoproject.com/en/ref/utils/#django.utils.safestring.SafeString). You can test for them
  using code like:
  ```
...
2. Alternatively, your filter code can manually take care of any necessary
  ...
  [django.utils.safestring.mark_safe()](https://docs.djangoproject.com/en/ref/utils/#django.utils.safestring.mark_safe).
...
`urlize_and_linebreaks` that combined the [urlize](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatefilter-urlize) and
[linebreaksbr](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatefilter-linebreaksbr) filters, the filter would look like:
...
conversions in templates](https://docs.djangoproject.com/en/topics/i18n/timezones/#time-zones-in-templates).
...
### Simple tags¶
   ...
   django.template.Library.simple_tag()[¶](#django.template.Library.simple_tag)
...
[conditional_escape()](https://docs.djangoproject.com/en/ref/utils/#django.utils.html.conditional_escape) if the template context is in
...
[mark_safe()](https://docs.djangoproject.com/en/ref/utils/#django.utils.safestring.mark_safe) if you are absolutely sure that your
code does not contain XSS vulnerabilities. For building small HTML snippets,
use of [format_html()](https://docs.djangoproject.com/en/ref/utils/#django.utils.html.format_html) instead of `mark_safe()` is
...
### Inclusion tags¶
   ...
   django.template.Library.inclusion_tag()[¶](#django.template.Library.inclusion_tag)
...
created in the [tutorials](https://docs.djangoproject.com/en/intro/tutorial02/#creating-models). We’ll use the tag like this:
...
[django.template.Template](https://docs.djangoproject.com/en/ref/templates/api/#django.template.Template) instance:
...
tag is used inside a [{%autoescapeoff%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-autoescape) block.
...
[cycle](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-cycle) template tag that cycles among a list of given strings each time
it’s rendered:
...
[DateTimeField](https://docs.djangoproject.com/en/ref/models/fields/#django.db.models.DateTimeField) from an object and have the template
...
[{%comment%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-comment) tag hides everything until `{% endcomment %}`.
...
The actual implementation of [{%comment%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-comment) is slightly
...
[{%for%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-for) in [django/template/defaulttags.py](https://github.com/django/django/blob/main/django/template/defaulttags.py) and
[{%if%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-if) in [django/template/smartif.py](https://github.com/django/django/blob/main/django/template/smartif.py).
