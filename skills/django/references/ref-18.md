...
[field options](#field-options) and [field types](#field-types) Django offers.

See also

If the built-in fields don’t do the trick, you can try [django-localflavor](https://github.com/django/django-localflavor) ([documentation](https://django-localflavor.readthedocs.io/)), which contains assorted
pieces of code that are useful for particular countries and cultures.

Also, you can easily [write your own custom model fields](https://docs.djangoproject.com/en/howto/custom-model-fields/).

Note

Technically, these models are defined in [django.db.models.fields](#module-django.db.models.fields), but
for convenience they’re imported into [django.db.models](https://docs.djangoproject.com/en/topics/db/models/#module-django.db.models); the standard
...
### null¶
   ...
   Field.null[¶](#django.db.models.Field.null)

If `True`, Django will store empty values as `NULL` in the database. Default
is `False`.

Avoid using [null](#django.db.models.Field.null) on string-based fields such as
[CharField](#django.db.models.CharField) and [TextField](#django.db.models.TextField). If a string-based field has
`null=True`, that means it has two possible values for “no data”: `NULL`,
and the empty string. In most cases, it’s redundant to have two possible values
for “no data;” the Django convention is to use the empty string, not
`NULL`. One exception is when a [CharField](#django.db.models.CharField) has both `unique=True`
...
### blank¶
   ...
   Field.blank[¶](#django.db.models.Field.blank)
...
require implementing [clean()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.clean) on the model in
order to programmatically supply any missing values.

### choices¶

   Field.choices[¶](#django.db.models.Field.choices)
...
[model validation](https://docs.djangoproject.com/en/5.0/ref/instances/#validating-objects) and the default form widget will
...
[get_FOO_display()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.get_FOO_display) in the database API
documentation.
...
### db_column¶
   ...
   Field.db_column[¶](#django.db.models.Field.db_column)
...
### db_comment¶
  ...
  New in Django 4.2.    Field.db_comment[¶](#django.db.models.Field.db_comment)
...
### db_default¶
  ...
  New in Django 5.0.    Field.db_default[¶](#django.db.models.Field.db_default)

The database-computed default value for this field. This can be a literal value
or a database function, such as [Now](https://docs.djangoproject.com/en/5.0/ref/database-functions/#django.db.models.functions.Now):
...
Use the [indexes](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.indexes) option instead.

Where possible, use the [Meta.indexes](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.indexes) option
instead. In nearly all cases, [indexes](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.indexes) provides more
functionality than `db_index`. `db_index` may be deprecated in the
future.

### db_tablespace¶

   Field.db_tablespace[¶](#django.db.models.Field.db_tablespace)

The name of the [database tablespace](https://docs.djangoproject.com/en/topics/db/tablespaces/) to use for
this field’s index, if this field is indexed. The default is the project’s
[DEFAULT_INDEX_TABLESPACE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DEFAULT_INDEX_TABLESPACE) setting, if set, or the
[db_tablespace](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.db_tablespace) of the model, if any. If the backend doesn’t
support tablespaces for indexes, this option is ignored.

### default¶

   Field.default[¶](#django.db.models.Field.default)
...
can’t be [serialized by migrations](https://docs.djangoproject.com/en/topics/migrations/#migration-serializing). See that
...
### editable¶
   ...
   Field.editable[¶](#django.db.models.Field.editable)

If `False`, the field will not be displayed in the admin or any other
[ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm). They are also skipped during [model
validation](https://docs.djangoproject.com/en/5.0/ref/instances/#validating-objects). Default is `True`.

### error_messages¶

   Field.error_messages[¶](#django.db.models.Field.error_messages)
...
[Considerations regarding model’s error_messages](https://docs.djangoproject.com/en/topics/forms/modelforms/#considerations-regarding-model-errormessages).

### help_text¶

   Field.help_text[¶](#django.db.models.Field.help_text)
...
[django.utils.html.escape()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.html.escape) to escape any HTML special characters. Ensure
that you escape any help text that may come from untrusted users to avoid a
cross-site scripting attack.

### primary_key¶

   Field.primary_key[¶](#django.db.models.Field.primary_key)
...
be specified per app in [AppConfig.default_auto_field](https://docs.djangoproject.com/en/5.0/applications/#django.apps.AppConfig.default_auto_field) or globally in the
[DEFAULT_AUTO_FIELD](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DEFAULT_AUTO_FIELD) setting. For more, see
[Automatic primary key fields](https://docs.djangoproject.com/en/topics/db/models/#automatic-primary-key-fields).
...
[deleting](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.delete) an object.

### unique¶

   Field.unique[¶](#django.db.models.Field.unique)

If `True`, this field must be unique throughout the table.

This is enforced at the database level and by model validation. If
you try to save a model with a duplicate value in a [unique](#django.db.models.Field.unique)
field, a [django.db.IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError) will be raised by the model’s
[save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save) method.
...
### unique_for_date¶
   ...
   Field.unique_for_date[¶](#django.db.models.Field.unique_for_date)
...
portion of the field will be considered. Besides, when [USE_TZ](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ) is
`True`, the check will be performed in the [current time zone](https://docs.djangoproject.com/en/topics/i18n/timezones/#default-current-time-zone) at the time the object gets saved.

This is enforced by [Model.validate_unique()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.validate_unique) during model validation
but not at the database level. If any [unique_for_date](#django.db.models.Field.unique_for_date) constraint
involves fields that are not part of a [ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm) (for
example, if one of the fields is listed in `exclude` or has
[editable=False](#django.db.models.Field.editable)), [Model.validate_unique()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.validate_unique) will
skip validation for that particular constraint.

### unique_for_month¶

   Field.unique_for_month[¶](#django.db.models.Field.unique_for_month)
...
### unique_for_year¶
   ...
   Field.unique_for_year[¶](#django.db.models.Field.unique_for_year)

Like [unique_for_date](#django.db.models.Field.unique_for_date) and [unique_for_month](#django.db.models.Field.unique_for_month).

### verbose_name¶

   Field.verbose_name[¶](#django.db.models.Field.verbose_name)

A human-readable name for the field. If the verbose name isn’t given, Django
will automatically create it using the field’s attribute name, converting
underscores to spaces. See [Verbose field names](https://docs.djangoproject.com/en/topics/db/models/#verbose-field-names).

### validators¶

   Field.validators[¶](#django.db.models.Field.validators)

A list of validators to run for this field. See the [validators
documentation](https://docs.djangoproject.com/en/5.0/validators/) for more information.

## Field types¶

### AutoField¶

   *class*AutoField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#AutoField)[¶](#django.db.models.AutoField)

An [IntegerField](#django.db.models.IntegerField) that automatically increments
according to available IDs. You usually won’t need to use this directly; a
primary key field will automatically be added to your model if you don’t specify
otherwise. See [Automatic primary key fields](https://docs.djangoproject.com/en/topics/db/models/#automatic-primary-key-fields).

### BigAutoField¶

   *class*BigAutoField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#BigAutoField)[¶](#django.db.models.BigAutoField)
...
### BigIntegerField¶
   ...
   *class*BigIntegerField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#BigIntegerField)[¶](#django.db.models.BigIntegerField)

A 64-bit integer, much like an [IntegerField](#django.db.models.IntegerField) except that it is
guaranteed to fit numbers from `-9223372036854775808` to
`9223372036854775807`. The default form widget for this field is a
[NumberInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.NumberInput).

### BinaryField¶

   *class*BinaryField(*max_length=None*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#BinaryField)[¶](#django.db.models.BinaryField)
...
case it can’t be included in a [ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm).

   BinaryField.max_length[¶](#django.db.models.BinaryField.max_length)

Optional. The maximum length (in bytes) of the field. The maximum length is
enforced in Django’s validation using
[MaxLengthValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MaxLengthValidator).

Abusing `BinaryField`

Although you might think about storing files in the database, consider that
it is bad design in 99% of the cases. This field is *not* a replacement for
proper [static files](https://docs.djangoproject.com/en/howto/static-files/) handling.

### BooleanField¶

   *class*BooleanField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#BooleanField)[¶](#django.db.models.BooleanField)

A true/false field.

The default form widget for this field is [CheckboxInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.CheckboxInput),
or [NullBooleanSelect](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.NullBooleanSelect) if [null=True](#django.db.models.Field.null).
...
### CharField¶
   ...
   *class*CharField(*max_length=None*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#CharField)[¶](#django.db.models.CharField)

A string field, for small- to large-sized strings.

For large amounts of text, use [TextField](#django.db.models.TextField).

The default form widget for this field is a [TextInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.TextInput).

[CharField](#django.db.models.CharField) has the following extra arguments:

   CharField.max_length[¶](#django.db.models.CharField.max_length)
...
[MaxLengthValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MaxLengthValidator). It’s required for all
...
notes](https://docs.djangoproject.com/en/5.0/databases/) for details.

   Changed in Django 4.2:

Support for unlimited `VARCHAR` columns was added on PostgreSQL.

     CharField.db_collation[¶](#django.db.models.CharField.db_collation)
...
### DateField¶
   ...
   *class*DateField(*auto_now=False*, *auto_now_add=False*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#DateField)[¶](#django.db.models.DateField)

A date, represented in Python by a `datetime.date` instance. Has a few extra,
optional arguments:

   DateField.auto_now[¶](#django.db.models.DateField.auto_now)

Automatically set the field to now every time the object is saved. Useful
for “last-modified” timestamps. Note that the current date is *always*
used; it’s not just a default value that you can override.

The field is only automatically updated when calling [Model.save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save). The field isn’t updated when making updates
to other fields in other ways such as [QuerySet.update()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.update), though you can specify a custom
value for the field in an update like that.

    DateField.auto_now_add[¶](#django.db.models.DateField.auto_now_add)
...
- For [DateTimeField](#django.db.models.DateTimeField): `default=timezone.now` - from
  [django.utils.timezone.now()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.timezone.now)

The default form widget for this field is a
[DateInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.DateInput). The admin adds a JavaScript calendar,
...
the [default timezone](https://docs.djangoproject.com/en/topics/i18n/timezones/#default-current-time-zone) at the moment of
...
### DateTimeField¶
   ...
   *class*DateTimeField(*auto_now=False*, *auto_now_add=False*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#DateTimeField)[¶](#django.db.models.DateTimeField)

A date and time, represented in Python by a `datetime.datetime` instance.
Takes the same extra arguments as [DateField](#django.db.models.DateField).

The default form widget for this field is a single
[DateTimeInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.DateTimeInput). The admin uses two separate
[TextInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.TextInput) widgets with JavaScript shortcuts.

### DecimalField¶

   *class*DecimalField(*max_digits=None*, *decimal_places=None*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#DecimalField)[¶](#django.db.models.DecimalField)

A fixed-precision decimal number, represented in Python by a
[Decimal](https://docs.python.org/3/library/decimal.html#decimal.Decimal) instance. It validates the input using
[DecimalValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.DecimalValidator).

Has the following **required** arguments:

   DecimalField.max_digits[¶](#django.db.models.DecimalField.max_digits)

The maximum number of digits allowed in the number. Note that this number
must be greater than or equal to `decimal_places`.

    DecimalField.decimal_places[¶](#django.db.models.DecimalField.decimal_places)
...
The default form widget for this field is a [NumberInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.NumberInput)
when [localize](https://docs.djangoproject.com/en/5.0/forms/fields/#django.forms.Field.localize) is `False` or
[TextInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.TextInput) otherwise.
...
should also be aware of [SQLite limitations](https://docs.djangoproject.com/en/5.0/databases/#sqlite-decimal-handling)
of decimal fields.

### DurationField¶

   *class*DurationField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#DurationField)[¶](#django.db.models.DurationField)
...
### EmailField¶
   ...
   *class*EmailField(*max_length=254*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#EmailField)[¶](#django.db.models.EmailField)

A [CharField](#django.db.models.CharField) that checks that the value is a valid email address using
[EmailValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.EmailValidator).

### FileField¶

   *class*FileField(*upload_to=''*, *storage=None*, *max_length=100*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/files/#FileField)[¶](#django.db.models.FileField)
...
Has the following optional arguments:
   ...
   FileField.upload_to[¶](#django.db.models.FileField.upload_to)

This attribute provides a way of setting the upload directory and file name,
and can be set in two ways. In both cases, the value is passed to the
[Storage.save()](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage.save) method.
...
[FileSystemStorage](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.FileSystemStorage), the string value
will be appended to your [MEDIA_ROOT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MEDIA_ROOT) path to form the location on
...
| --- | --- |
| instance | An instance of the model where theFileFieldis defined. More specifically,
this is the particular instance where the
current file is being attached.In most cases, this object will not have been
saved to the database yet, so if it uses the
defaultAutoField,it might not yet have a
...
```
     ...
     FileField.storage[¶](#django.db.models.FileField.storage)

A storage object, or a callable which returns a storage object. This
handles the storage and retrieval of your files. See [Managing files](https://docs.djangoproject.com/en/topics/files/)
for details on how to provide this object.

The default form widget for this field is a
[ClearableFileInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.ClearableFileInput).

Using a [FileField](#django.db.models.FileField) or an [ImageField](#django.db.models.ImageField) (see below) in a model
takes a few steps:

1. In your settings file, you’ll need to define [MEDIA_ROOT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MEDIA_ROOT) as the
  full path to a directory where you’d like Django to store uploaded files.
  (For performance, these files are not stored in the database.) Define
  [MEDIA_URL](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MEDIA_URL) as the base public URL of that directory. Make sure
...
2. Add the [FileField](#django.db.models.FileField) or [ImageField](#django.db.models.ImageField) to your model, defining
  ...
  [MEDIA_ROOT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MEDIA_ROOT) to use for uploaded files.
3. All that will be stored in your database is a path to the file
  (relative to [MEDIA_ROOT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MEDIA_ROOT)). You’ll most likely want to use the
...
For example, say your [MEDIA_ROOT](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MEDIA_ROOT) is set to `'/home/media'`, and
...
size, you could use the [name](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File.name) and
[size](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File.size) attributes respectively; for more
information on the available attributes and methods, see the
[File](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File) class reference and the [Managing files](https://docs.djangoproject.com/en/topics/files/)
topic guide.
...
this calls the [url()](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage.url) method of the
underlying [Storage](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage) class.
...
#### FileFieldandFieldFile¶
   ...
   *class*FieldFile[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/files/#FieldFile)[¶](#django.db.models.fields.files.FieldFile)
...
The API of [FieldFile](#django.db.models.fields.files.FieldFile) mirrors that of [File](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File),
...
the result of the [Storage.open()](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage.open)
method, which may be a [File](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File) object, or it may be a
custom storage’s implementation of the [File](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File) API.

In addition to the API inherited from [File](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File) such as
...
associated `FieldFile` in the database.
    ...
    FieldFile.name[¶](#django.db.models.fields.files.FieldFile.name)

The name of the file including the relative path from the root of the
[Storage](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage) of the associated
[FileField](#django.db.models.FileField).

   FieldFile.path[¶](#django.db.models.fields.files.FieldFile.path)

A read-only property to access the file’s local filesystem path by calling the
[path()](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage.path) method of the underlying
[Storage](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage) class.

   FieldFile.size[¶](#django.db.models.fields.files.FieldFile.size)

The result of the underlying [Storage.size()](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage.size) method.

   FieldFile.url[¶](#django.db.models.fields.files.FieldFile.url)

A read-only property to access the file’s relative URL by calling the
[url()](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage.url) method of the underlying
[Storage](https://docs.djangoproject.com/en/5.0/files/storage/#django.core.files.storage.Storage) class.

   FieldFile.open(*mode='rb'*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/files/#FieldFile.open)[¶](#django.db.models.fields.files.FieldFile.open)
...
file or to change the `mode`.
   ...
   FieldFile.close()[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/files/#FieldFile.close)[¶](#django.db.models.fields.files.FieldFile.close)

Behaves like the standard Python `file.close()` method and closes the file
associated with this instance.

   FieldFile.save(*name*, *content*, *save=True*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/files/#FieldFile.save)[¶](#django.db.models.fields.files.FieldFile.save)
...
[django.core.files.File](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File), not Python’s built-in file object.
You can construct a [File](https://docs.djangoproject.com/en/5.0/files/file/#django.core.files.File) from an existing
...
For more information, see [Managing files](https://docs.djangoproject.com/en/topics/files/).

   FieldFile.delete(*save=True*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/files/#FieldFile.delete)[¶](#django.db.models.fields.files.FieldFile.delete)
...
### FilePathField¶
   ...
   *class*FilePathField(*path=''*, *match=None*, *recursive=False*, *allow_files=True*, *allow_folders=False*, *max_length=100*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#FilePathField)[¶](#django.db.models.FilePathField)
...
**required**:
   ...
   FilePathField.path[¶](#django.db.models.FilePathField.path)
...
```
     ...
     FilePathField.match[¶](#django.db.models.FilePathField.match)
...
match a file called `foo23.txt` but not `bar.txt` or `foo23.png`.
    ...
    FilePathField.recursive[¶](#django.db.models.FilePathField.recursive)

Optional. Either `True` or `False`. Default is `False`. Specifies
whether all subdirectories of [path](#django.db.models.FilePathField.path) should be included

    FilePathField.allow_files[¶](#django.db.models.FilePathField.allow_files)

Optional.  Either `True` or `False`.  Default is `True`.  Specifies
whether files in the specified location should be included.  Either this or
[allow_folders](#django.db.models.FilePathField.allow_folders) must be `True`.

    FilePathField.allow_folders[¶](#django.db.models.FilePathField.allow_folders)
...
### FloatField¶
   ...
   *class*FloatField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#FloatField)[¶](#django.db.models.FloatField)
...
### GeneratedField¶
  ...
  New in Django 5.0.    *class*GeneratedField(*expression*, *output_field*, *db_persist=None*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/generated/#GeneratedField)[¶](#django.db.models.GeneratedField)
...
materialized view.
   ...
   GeneratedField.expression[¶](#django.db.models.GeneratedField.expression)

An [Expression](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.Expression) used by the database to automatically set the field
...
other generated fields. Database backends can impose further restrictions.
    ...
    GeneratedField.output_field[¶](#django.db.models.GeneratedField.output_field)

A model field instance to define the field’s data type.

    GeneratedField.db_persist[¶](#django.db.models.GeneratedField.db_persist)
...
to access the new value after [save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save), for example, by using
[refresh_from_db()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.refresh_from_db).
...
### GenericIPAddressField¶
   ...
   *class*GenericIPAddressField(*protocol='both'*, *unpack_ipv4=False*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#GenericIPAddressField)[¶](#django.db.models.GenericIPAddressField)

An IPv4 or IPv6 address, in string format (e.g. `192.0.2.30` or
`2a02:42fe::4`). The default form widget for this field is a
[TextInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.TextInput).
...
are converted to lowercase.
   ...
   GenericIPAddressField.protocol[¶](#django.db.models.GenericIPAddressField.protocol)

Limits valid inputs to the specified protocol.
Accepted values are `'both'` (default), `'IPv4'`
or `'IPv6'`. Matching is case insensitive.

    GenericIPAddressField.unpack_ipv4[¶](#django.db.models.GenericIPAddressField.unpack_ipv4)
...
### ImageField¶
   ...
   *class*ImageField(*upload_to=None*, *height_field=None*, *width_field=None*, *max_length=100*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/files/#ImageField)[¶](#django.db.models.ImageField)
...
following optional arguments:
   ...
   ImageField.height_field[¶](#django.db.models.ImageField.height_field)

Name of a model field which will be auto-populated with the height of the
image each time the model instance is saved.

    ImageField.width_field[¶](#django.db.models.ImageField.width_field)
...
### IntegerField¶
   ...
   *class*IntegerField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#IntegerField)[¶](#django.db.models.IntegerField)

An integer. Values from `-2147483648` to `2147483647` are safe in all
databases supported by Django.

It uses [MinValueValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MinValueValidator) and
[MaxValueValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.MaxValueValidator) to validate the input based
...
### JSONField¶
   ...
   *class*JSONField(*encoder=None*, *decoder=None*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/json/#JSONField)[¶](#django.db.models.JSONField)
...
(with the [JSON1 extension enabled](https://docs.djangoproject.com/en/5.0/databases/#sqlite-json1)).

   JSONField.encoder[¶](#django.db.models.JSONField.encoder)
...
[DjangoJSONEncoder](https://docs.djangoproject.com/en/topics/serialization/#django.core.serializers.json.DjangoJSONEncoder) class.

Defaults to `json.JSONEncoder`.

    JSONField.decoder[¶](#django.db.models.JSONField.decoder)
...
To query `JSONField` in the database, see [Querying JSONField](https://docs.djangoproject.com/en/topics/db/queries/#querying-jsonfield).
...
[Index](https://docs.djangoproject.com/en/5.0/ref/indexes/#django.db.models.Index) and [Field.db_index](#django.db.models.Field.db_index) both create a
B-tree index, which isn’t particularly helpful when querying `JSONField`.
On PostgreSQL only, you can use
[GinIndex](https://docs.djangoproject.com/en/5.0/contrib/postgres/indexes/#django.contrib.postgres.indexes.GinIndex) that is better suited.
...
### PositiveBigIntegerField¶
   ...
   *class*PositiveBigIntegerField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#PositiveBigIntegerField)[¶](#django.db.models.PositiveBigIntegerField)
...
### PositiveIntegerField¶
   ...
   *class*PositiveIntegerField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#PositiveIntegerField)[¶](#django.db.models.PositiveIntegerField)
...
### PositiveSmallIntegerField¶
   ...
   *class*PositiveSmallIntegerField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#PositiveSmallIntegerField)[¶](#django.db.models.PositiveSmallIntegerField)
...
### SlugField¶
   ...
   *class*SlugField(*max_length=50*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#SlugField)[¶](#django.db.models.SlugField)

[Slug](https://docs.djangoproject.com/en/glossary/#term-slug) is a newspaper term. A slug is a short label for something,
...
[prepopulated_fields](https://docs.djangoproject.com/en/5.0/contrib/admin/#django.contrib.admin.ModelAdmin.prepopulated_fields).

It uses [validate_slug](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.validate_slug) or
[validate_unicode_slug](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.validate_unicode_slug) for validation.

   SlugField.allow_unicode[¶](#django.db.models.SlugField.allow_unicode)
...
### SmallAutoField¶
   ...
   *class*SmallAutoField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#SmallAutoField)[¶](#django.db.models.SmallAutoField)
...
### SmallIntegerField¶
   ...
   *class*SmallIntegerField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#SmallIntegerField)[¶](#django.db.models.SmallIntegerField)
...
### TextField¶
   ...
   *class*TextField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#TextField)[¶](#django.db.models.TextField)

A large text field. The default form widget for this field is a
[Textarea](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.Textarea).

If you specify a `max_length` attribute, it will be reflected in the
[Textarea](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.Textarea) widget of the auto-generated form field.
However it is not enforced at the model or database level. Use a
[CharField](#django.db.models.CharField) for that.

   TextField.db_collation[¶](#django.db.models.TextField.db_collation)
...
### TimeField¶
   ...
   *class*TimeField(*auto_now=False*, *auto_now_add=False*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#TimeField)[¶](#django.db.models.TimeField)

A time, represented in Python by a `datetime.time` instance. Accepts the same
auto-population options as [DateField](#django.db.models.DateField).

The default form widget for this field is a [TimeInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.TimeInput).
The admin adds some JavaScript shortcuts.

### URLField¶

   *class*URLField(*max_length=200*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#URLField)[¶](#django.db.models.URLField)

A [CharField](#django.db.models.CharField) for a URL, validated by
[URLValidator](https://docs.djangoproject.com/en/5.0/validators/#django.core.validators.URLValidator).

The default form widget for this field is a [URLInput](https://docs.djangoproject.com/en/5.0/forms/widgets/#django.forms.URLInput).
...
### UUIDField¶
   ...
   *class*UUIDField(***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#UUIDField)[¶](#django.db.models.UUIDField)
...
Using [iexact](https://docs.djangoproject.com/en/5.0/ref/querysets/#std-fieldlookup-iexact), [contains](https://docs.djangoproject.com/en/5.0/ref/querysets/#std-fieldlookup-contains), [icontains](https://docs.djangoproject.com/en/5.0/ref/querysets/#std-fieldlookup-icontains),
[startswith](https://docs.djangoproject.com/en/5.0/ref/querysets/#std-fieldlookup-startswith), [istartswith](https://docs.djangoproject.com/en/5.0/ref/querysets/#std-fieldlookup-istartswith), [endswith](https://docs.djangoproject.com/en/5.0/ref/querysets/#std-fieldlookup-endswith), or
[iendswith](https://docs.djangoproject.com/en/5.0/ref/querysets/#std-fieldlookup-iendswith) lookups on PostgreSQL don’t work for values without
...
### ForeignKey¶
   ...
   *class*ForeignKey(*to*, *on_delete*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/related/#ForeignKey)[¶](#django.db.models.ForeignKey)
...
Relationships defined this way on [abstract models](https://docs.djangoproject.com/en/topics/db/models/#abstract-base-classes) are resolved when the model is subclassed as a
concrete model and are not relative to the abstract model’s `app_label`:

  `products/models.py`[¶](#id3)
...
relation works.
   ...
   ForeignKey.on_delete[¶](#django.db.models.ForeignKey.on_delete)
...
[django.db.models](https://docs.djangoproject.com/en/topics/db/models/#module-django.db.models):

- CASCADE[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/deletion/#CASCADE)[¶](#django.db.models.CASCADE)
  ...
  [Model.delete()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.delete) isn’t called on related models, but the
  [pre_delete](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.pre_delete) and
  [post_delete](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.post_delete) signals are sent for all
  deleted objects.
- PROTECT[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/deletion/#PROTECT)[¶](#django.db.models.PROTECT)
  Prevent deletion of the referenced object by raising
  [ProtectedError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.models.ProtectedError), a subclass of
  [django.db.IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError).
- RESTRICT[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/deletion/#RESTRICT)[¶](#django.db.models.RESTRICT)
  Prevent deletion of the referenced object by raising
  [RestrictedError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.models.RestrictedError) (a subclass of
  [django.db.IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError)). Unlike [PROTECT](#django.db.models.PROTECT), deletion of the
  ...
  ```
- SET_NULL[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/deletion/#SET_NULL)[¶](#django.db.models.SET_NULL)
  Set the [ForeignKey](#django.db.models.ForeignKey) null; this is only possible if
  [null](#django.db.models.Field.null) is `True`.
- SET_DEFAULT[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/deletion/#SET_DEFAULT)[¶](#django.db.models.SET_DEFAULT)
...
- SET()[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/deletion/#SET)[¶](#django.db.models.SET)
  ...
  ```
- DO_NOTHING[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/deletion/#DO_NOTHING)[¶](#django.db.models.DO_NOTHING)
  Take no action. If your database backend enforces referential
  integrity, this will cause an [IntegrityError](https://docs.djangoproject.com/en/5.0/exceptions/#django.db.IntegrityError) unless
  you manually add an SQL `ON DELETE` constraint to the database field.

   ForeignKey.limit_choices_to[¶](#django.db.models.ForeignKey.limit_choices_to)

Sets a limit to the available choices for this field when this field is
rendered using a `ModelForm` or the admin (by default, all objects
in the queryset are available to choose). Either a dictionary, a
[Q](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.Q) object, or a callable returning a
dictionary or [Q](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.Q) object can be used.
...
If `limit_choices_to` is or returns a [Qobject](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.Q), which is useful for [complex queries](https://docs.djangoproject.com/en/topics/db/queries/#complex-lookups-with-q), then it will only have an effect on the choices
available in the admin when the field is not listed in
[raw_id_fields](https://docs.djangoproject.com/en/5.0/contrib/admin/#django.contrib.admin.ModelAdmin.raw_id_fields) in the
...
be invoked several times.
     ...
     ForeignKey.related_name[¶](#django.db.models.ForeignKey.related_name)
...
objects documentation](https://docs.djangoproject.com/en/topics/db/queries/#backwards-related-objects) for a full explanation
and example. Note that you must set this value when defining relations on
[abstract models](https://docs.djangoproject.com/en/topics/db/models/#abstract-base-classes); and when you do so
[some special syntax](https://docs.djangoproject.com/en/topics/db/models/#abstract-related-name) is available.
...
```
     ...
     ForeignKey.related_query_name[¶](#django.db.models.ForeignKey.related_query_name)
...
[default_related_name](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.default_related_name) if set, otherwise it
...
class interpolation via [some special syntax](https://docs.djangoproject.com/en/topics/db/models/#abstract-related-name).

    ForeignKey.to_field[¶](#django.db.models.ForeignKey.to_field)
...
field, that field must have `unique=True`.
    ...
    ForeignKey.db_constraint[¶](#django.db.models.ForeignKey.db_constraint)
...
will raise its `DoesNotExist` exception.
    ...
    ForeignKey.swappable[¶](#django.db.models.ForeignKey.swappable)
...
### ManyToManyField¶
   ...
   *class*ManyToManyField(*to*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/related/#ManyToManyField)[¶](#django.db.models.ManyToManyField)
...
[RelatedManager](https://docs.djangoproject.com/en/5.0/ref/relations/#django.db.models.fields.related.RelatedManager).
...
that control how the relationship functions.
   ...
   ManyToManyField.related_name[¶](#django.db.models.ManyToManyField.related_name)

Same as [ForeignKey.related_name](#django.db.models.ForeignKey.related_name).

    ManyToManyField.related_query_name[¶](#django.db.models.ManyToManyField.related_query_name)

Same as [ForeignKey.related_query_name](#django.db.models.ForeignKey.related_query_name).

    ManyToManyField.limit_choices_to[¶](#django.db.models.ManyToManyField.limit_choices_to)

Same as [ForeignKey.limit_choices_to](#django.db.models.ForeignKey.limit_choices_to).

    ManyToManyField.symmetrical[¶](#django.db.models.ManyToManyField.symmetrical)
...
[ManyToManyField](#django.db.models.ManyToManyField) relationships to be non-symmetrical.
    ...
    ManyToManyField.through[¶](#django.db.models.ManyToManyField.through)
...
[extra data with a many-to-many relationship](https://docs.djangoproject.com/en/topics/db/models/#intermediary-manytomany).

Note

If you don’t want multiple associations between the same instances, add
a [UniqueConstraint](https://docs.djangoproject.com/en/5.0/ref/constraints/#django.db.models.UniqueConstraint) including the from and to
...
```
     ...
     ManyToManyField.through_fields[¶](#django.db.models.ManyToManyField.through_fields)
...
Django should use.
    ...
    ManyToManyField.db_table[¶](#django.db.models.ManyToManyField.db_table)
...
itself.
    ...
    ManyToManyField.db_constraint[¶](#django.db.models.ManyToManyField.db_constraint)
...
It is an error to pass both `db_constraint` and `through`.
    ...
    ManyToManyField.swappable[¶](#django.db.models.ManyToManyField.swappable)
...
### OneToOneField¶
   ...
   *class*OneToOneField(*to*, *on_delete*, *parent_link=False*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/related/#OneToOneField)[¶](#django.db.models.OneToOneField)
...
another model in some way; [Multi-table inheritance](https://docs.djangoproject.com/en/topics/db/models/#multi-table-inheritance) is
...
of the target model’s [Model.DoesNotExist](https://docs.djangoproject.com/en/5.0/ref/class/#django.db.models.Model.DoesNotExist) exception and can be accessed as an
...
accepted by [ForeignKey](#django.db.models.ForeignKey), plus one extra argument:
   ...
   OneToOneField.parent_link[¶](#django.db.models.OneToOneField.parent_link)

When `True` and used in a model which inherits from another
[concrete model](https://docs.djangoproject.com/en/glossary/#term-concrete-model), indicates that this field should be used as the
link back to the parent class, rather than the extra
`OneToOneField` which would normally be implicitly created by
subclassing.

See [One-to-one relationships](https://docs.djangoproject.com/en/topics/db/examples/one_to_one/) for usage
examples of `OneToOneField`.

## Field API reference¶

   *class*Field[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field)[¶](#django.db.models.Field)
...
[models](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model) and [querysets](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet).

In models, a field is instantiated as a class attribute and represents a
particular table column, see [Models](https://docs.djangoproject.com/en/topics/db/models/). It has attributes
...
[RegisterLookupMixin](https://docs.djangoproject.com/en/5.0/ref/lookups/#django.db.models.lookups.RegisterLookupMixin) and thus both
[Transform](https://docs.djangoproject.com/en/5.0/ref/lookups/#django.db.models.Transform) and
[Lookup](https://docs.djangoproject.com/en/5.0/ref/lookups/#django.db.models.Lookup) can be registered on it to be used
in `QuerySet`s (e.g. `field_name__exact="foo"`). All [built-in
lookups](https://docs.djangoproject.com/en/5.0/ref/querysets/#field-lookups) are registered by default.

All of Django’s built-in fields, such as [CharField](#django.db.models.CharField), are particular
implementations of `Field`. If you need a custom field, you can either
subclass any of the built-in fields or write a `Field` from scratch. In
either case, see [How to create custom model fields](https://docs.djangoproject.com/en/howto/custom-model-fields/).

   description[¶](#django.db.models.Field.description)

A verbose description of the field, e.g. for the
[django.contrib.admindocs](https://docs.djangoproject.com/en/5.0/contrib/admin/admindocs/#module-django.contrib.admindocs) application.
...
where the arguments are interpolated from the field’s `__dict__`.
    ...
    descriptor_class[¶](#django.db.models.Field.descriptor_class)
...
methods:
   ...
   get_internal_type()[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.get_internal_type)[¶](#django.db.models.Field.get_internal_type)

Returns a string naming this field for backend specific purposes.
By default, it returns the class name.

See [Emulating built-in field types](https://docs.djangoproject.com/en/howto/custom-model-fields/#emulating-built-in-field-types) for usage in custom fields.

    db_type(*connection*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.db_type)[¶](#django.db.models.Field.db_type)

Returns the database column data type for the [Field](#django.db.models.Field), taking
into account the `connection`.

See [Custom database types](https://docs.djangoproject.com/en/howto/custom-model-fields/#custom-database-types) for usage in custom fields.

    rel_db_type(*connection*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.rel_db_type)[¶](#django.db.models.Field.rel_db_type)
...
When querying, [get_db_prep_value()](#django.db.models.Field.get_db_prep_value) and [get_prep_value()](#django.db.models.Field.get_prep_value) are used:
   ...
   get_prep_value(*value*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.get_prep_value)[¶](#django.db.models.Field.get_prep_value)

`value` is the current value of the model’s attribute, and the method
should return data in a format that has been prepared for use as a
parameter in a query.

See [Converting Python objects to query values](https://docs.djangoproject.com/en/howto/custom-model-fields/#converting-python-objects-to-query-values) for usage.

    get_db_prep_value(*value*, *connection*, *prepared=False*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.get_db_prep_value)[¶](#django.db.models.Field.get_db_prep_value)
...
See [Converting query values to database values](https://docs.djangoproject.com/en/howto/custom-model-fields/#converting-query-values-to-database-values) for usage.

When loading data, [from_db_value()](#django.db.models.Field.from_db_value) is used:

   from_db_value(*value*, *expression*, *connection*)[¶](#django.db.models.Field.from_db_value)
...
See [Converting values to Python objects](https://docs.djangoproject.com/en/howto/custom-model-fields/#converting-values-to-python-objects) for usage.
...
When saving, [pre_save()](#django.db.models.Field.pre_save) and [get_db_prep_save()](#django.db.models.Field.get_db_prep_save) are used:
   ...
   get_db_prep_save(*value*, *connection*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.get_db_prep_save)[¶](#django.db.models.Field.get_db_prep_save)
...
[get_db_prep_value()](#django.db.models.Field.get_db_prep_value).
    ...
    pre_save(*model_instance*, *add*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.pre_save)[¶](#django.db.models.Field.pre_save)
...
See [Preprocessing values before saving](https://docs.djangoproject.com/en/howto/custom-model-fields/#preprocessing-values-before-saving) for usage.

Fields often receive their values as a different type, either from
serialization or from forms.

   to_python(*value*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.to_python)[¶](#django.db.models.Field.to_python)

Converts the value into the correct Python object. It acts as the
reverse of [value_to_string()](#django.db.models.Field.value_to_string), and is also called in
[clean()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.clean).
...
serialize its value:
   ...
   value_from_object(*obj*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.value_from_object)[¶](#django.db.models.Field.value_from_object)

Returns the field’s value for the given model instance.

This method is often used by [value_to_string()](#django.db.models.Field.value_to_string).

    value_to_string(*obj*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.value_to_string)[¶](#django.db.models.Field.value_to_string)

Converts `obj` to a string. Used to serialize the value of the field.

See [Converting field data for serialization](https://docs.djangoproject.com/en/howto/custom-model-fields/#converting-model-field-to-serialization) for usage.

When using [modelforms](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm), the `Field`
needs to know which form field it should be represented by:

   formfield(*form_class=None*, *choices_form_class=None*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.formfield)[¶](#django.db.models.Field.formfield)

Returns the default [django.forms.Field](https://docs.djangoproject.com/en/5.0/forms/fields/#django.forms.Field) of this field for
[ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm).

By default, if both `form_class` and `choices_form_class` are
`None`, it uses [CharField](https://docs.djangoproject.com/en/5.0/forms/fields/#django.forms.CharField). If the field has
[choices](#django.db.models.Field.choices) and `choices_form_class`
isn’t specified, it uses [TypedChoiceField](https://docs.djangoproject.com/en/5.0/forms/fields/#django.forms.TypedChoiceField).

See [Specifying the form field for a model field](https://docs.djangoproject.com/en/howto/custom-model-fields/#specifying-form-field-for-model-field) for usage.

    deconstruct()[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/fields/#Field.deconstruct)[¶](#django.db.models.Field.deconstruct)
...
using [Migrations](https://docs.djangoproject.com/en/topics/migrations/).

## Registering and fetching lookups¶

`Field` implements the [lookup registration API](https://docs.djangoproject.com/en/5.0/ref/lookups/#lookup-registration-api).
...
Support for registering lookups on [Field](#django.db.models.Field)
instances was added.
...
These attributes can be used together with the [Model._meta API](https://docs.djangoproject.com/en/5.0/ref/meta/#model-meta-field-api) to narrow down a search for specific field types.
Custom model fields should implement these flags.

## Attributes for fields¶

   Field.auto_created[¶](#django.db.models.Field.auto_created)

Boolean flag that indicates if the field was automatically created, such
as the `OneToOneField` used by model inheritance.

    Field.concrete[¶](#django.db.models.Field.concrete)

Boolean flag that indicates if the field has a database column associated
with it.

    Field.hidden[¶](#django.db.models.Field.hidden)

Boolean flag that indicates if a field is hidden and should not be returned
by [Options.get_fields()](https://docs.djangoproject.com/en/5.0/ref/meta/#django.db.models.options.Options.get_fields) by default. An example is
the reverse field for a [ForeignKey](#django.db.models.ForeignKey) with a
`related_name` that starts with `'+'`.

    Field.is_relation[¶](#django.db.models.Field.is_relation)
...
`ManyToManyField`, `OneToOneField`, etc.).
    ...
    Field.model[¶](#django.db.models.Field.model)
...
([Field.is_relation=True](#django.db.models.Field.is_relation)).
   ...
   Field.many_to_many[¶](#django.db.models.Field.many_to_many)
...
`True` is `ManyToManyField`.
    ...
    Field.many_to_one[¶](#django.db.models.Field.many_to_one)

Boolean flag that is `True` if the field has a many-to-one relation, such
as a `ForeignKey`; `False` otherwise.

    Field.one_to_many[¶](#django.db.models.Field.one_to_many)
...
otherwise.
    ...
    Field.one_to_one[¶](#django.db.models.Field.one_to_one)

Boolean flag that is `True` if the field has a one-to-one relation, such
as a `OneToOneField`; `False` otherwise.

    Field.related_model[¶](#django.db.models.Field.related_model)
