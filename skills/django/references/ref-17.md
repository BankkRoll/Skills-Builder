...
usually imported from [django.db.models](https://docs.djangoproject.com/en/topics/db/models/#module-django.db.models).

### F()expressions¶

   *class*F[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#F)[¶](#django.db.models.F)
...
[save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save) - to just one:
...
We can also use [update()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.update) to increment
...
#### Avoiding race conditions usingF()¶
...
the database when the [save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save) or `update()` is executed, rather
than based on its value when the instance was retrieved.

#### F()assignments persist afterModel.save()¶

`F()` objects assigned to model fields persist after saving the model
instance and will be applied on each [save()](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model.save). For example:
...
This is documented in [using F() expressions in queries](https://docs.djangoproject.com/en/topics/db/queries/#using-f-expressions-in-filters).

#### UsingF()with annotations¶
...
#### UsingF()with logical operations¶
...
See [Database Functions](https://docs.djangoproject.com/en/5.0/ref/database-functions/) for a list of built-in database functions.

The `Func` API is as follows:

   *class*Func(**expressions*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Func)[¶](#django.db.models.Func)   function[¶](#django.db.models.Func.function)

A class attribute describing the function that will be generated.
Specifically, the `function` will be interpolated as the `function`
placeholder within [template](#django.db.models.Func.template). Defaults to `None`.

    template[¶](#django.db.models.Func.template)
...
interpolation with the query parameters in the database cursor.
    ...
    arg_joiner[¶](#django.db.models.Func.arg_joiner)

A class attribute that denotes the character used to join the list of
`expressions` together. Defaults to `', '`.

    arity[¶](#django.db.models.Func.arity)
...
to `None`.
    ...
    as_sql(*compiler*, *connection*, *function=None*, *template=None*, *arg_joiner=None*, ***extra_context*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Func.as_sql)[¶](#django.db.models.Func.as_sql)
...
customize the SQL as needed. For example:
  ...
  `django/db/models/functions.py`[¶](#id6)
...
To avoid an SQL injection vulnerability, `extra_context` [must
...
is required. All of the [aggregate functions](https://docs.djangoproject.com/en/5.0/ref/querysets/#aggregation-functions),
...
The `Aggregate` API is as follows:
   ...
   *class*Aggregate(**expressions*, *output_field=None*, *distinct=False*, *filter=None*, *default=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/aggregates/#Aggregate)[¶](#django.db.models.Aggregate)   template[¶](#django.db.models.Aggregate.template)

A class attribute, as a format string, that describes the SQL that is
generated for this aggregate. Defaults to
`'%(function)s(%(distinct)s%(expressions)s)'`.

    function[¶](#django.db.models.Aggregate.function)

A class attribute describing the aggregate function that will be
generated. Specifically, the `function` will be interpolated as the
`function` placeholder within [template](#django.db.models.Aggregate.template). Defaults to `None`.

    window_compatible[¶](#django.db.models.Aggregate.window_compatible)

Defaults to `True` since most aggregate functions can be used as the
source expression in [Window](#django.db.models.expressions.Window).

    allow_distinct[¶](#django.db.models.Aggregate.allow_distinct)

A class attribute determining whether or not this aggregate function
allows passing a `distinct` keyword argument. If set to `False`
(default), `TypeError` is raised if `distinct=True` is passed.

    empty_result_set_value[¶](#django.db.models.Aggregate.empty_result_set_value)
...
The `filter` argument takes a [Qobject](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.Q) that’s
used to filter the rows that are aggregated. See [Conditional aggregation](https://docs.djangoproject.com/en/5.0/ref/conditional-expressions/#conditional-aggregation)
and [Filtering on annotations](https://docs.djangoproject.com/en/topics/db/aggregation/#filtering-on-annotations) for example usage.

The `default` argument takes a value that will be passed along with the
aggregate to [Coalesce](https://docs.djangoproject.com/en/5.0/ref/database-functions/#django.db.models.functions.Coalesce). This is useful for
...
### Value()expressions¶
   ...
   *class*Value(*value*, *output_field=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Value)[¶](#django.db.models.Value)
...
`output_field` to [DateTimeField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.DateTimeField).

### ExpressionWrapper()expressions¶

   *class*ExpressionWrapper(*expression*, *output_field*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#ExpressionWrapper)[¶](#django.db.models.ExpressionWrapper)
...
expressions. For more details see [Conditional Expressions](https://docs.djangoproject.com/en/5.0/ref/conditional-expressions/).

### Subquery()expressions¶

   *class*Subquery(*queryset*, *output_field=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Subquery)[¶](#django.db.models.Subquery)
...
#### Referencing columns from the outer queryset¶
   ...
   *class*OuterRef(*field*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#OuterRef)[¶](#django.db.models.OuterRef)
...
In this case, the subquery must use [values()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.values)
...
(Using [get()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.get) instead of a slice would fail because the
`OuterRef` cannot be resolved until the queryset is used within a
`Subquery`.)

#### Exists()subqueries¶

   *class*Exists(*queryset*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Exists)[¶](#django.db.models.Exists)
...
#### Filtering on aSubquery()orExists()expressions¶

`Subquery()` that returns a boolean value and `Exists()` may be used as a
`condition` in [When](https://docs.djangoproject.com/en/5.0/ref/conditional-expressions/#django.db.models.expressions.When) expressions, or to
...
#### Using aggregates within aSubqueryexpression¶

Aggregates may be used within a `Subquery`, but they require a specific
combination of [filter()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.filter), [values()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.values), and
[annotate()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.annotate) to get the subquery grouping correct.
...
`order_by()` removes the default [ordering](https://docs.djangoproject.com/en/5.0/ref/options/#django.db.models.Options.ordering)
...
using [aggregate()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.aggregate) attempts to evaluate the queryset (and if
there is an `OuterRef`, this will not be possible to resolve).

### Raw SQL expressions¶

   *class*RawSQL(*sql*, *params*, *output_field=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#RawSQL)[¶](#django.db.models.expressions.RawSQL)
...
equivalent to including multiple expressions in a [QuerySet.annotate()](https://docs.djangoproject.com/en/topics/db/aggregation/) call. The ORM doesn’t make use of named windows,
instead they are part of the selected columns.

   *class*Window(*expression*, *partition_by=None*, *order_by=None*, *frame=None*, *output_field=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Window)[¶](#django.db.models.expressions.Window)   template[¶](#django.db.models.expressions.Window.template)
...
The `expression` argument is either a [window function](https://docs.djangoproject.com/en/5.0/ref/database-functions/#window-functions), an [aggregate function](https://docs.djangoproject.com/en/5.0/ref/querysets/#aggregation-functions), or
...
The [output_field](#output-field) is specified either as an argument or by
the expression.
...
ordinary sequence of rows.
   ...
   *class*ValueRange(*start=None*, *end=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#ValueRange)[¶](#django.db.models.expressions.ValueRange)   frame_type[¶](#django.db.models.expressions.ValueRange.frame_type)
...
FOLLOWING`.
    ...
    *class*RowRange(*start=None*, *end=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#RowRange)[¶](#django.db.models.expressions.RowRange)   frame_type[¶](#django.db.models.expressions.RowRange.frame_type)
...
Query expressions implement the [query expression API](https://docs.djangoproject.com/en/5.0/ref/lookups/#query-expression),
...
calling the appropriate methods on the wrapped expression.
   ...
   *class*Expression[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Expression)[¶](#django.db.models.Expression)   allowed_default[¶](#django.db.models.Expression.allowed_default)  New in Django 5.0.

Tells Django that this expression can be used in
[Field.db_default](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.Field.db_default). Defaults to `False`.

    contains_aggregate[¶](#django.db.models.Expression.contains_aggregate)

Tells Django that this expression contains an aggregate and that a
`GROUP BY` clause needs to be added to the query.

    contains_over_clause[¶](#django.db.models.Expression.contains_over_clause)
...
modify data.
    ...
    filterable[¶](#django.db.models.Expression.filterable)

Tells Django that this expression can be referenced in
[QuerySet.filter()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.filter). Defaults to `True`.

    window_compatible[¶](#django.db.models.Expression.window_compatible)

Tells Django that this expression can be used as the source expression
in [Window](#django.db.models.expressions.Window). Defaults to
`False`.

    empty_result_set_value[¶](#django.db.models.Expression.empty_result_set_value)
...
the database.
    ...
    resolve_expression(*query=None*, *allow_joins=True*, *reuse=None*, *summarize=False*, *for_save=False*)[¶](#django.db.models.Expression.resolve_expression)
...
being executed is performing a create or update.
    ...
    get_source_expressions()[¶](#django.db.models.Expression.get_source_expressions)
...
```
     ...
     set_source_expressions(*expressions*)[¶](#django.db.models.Expression.set_source_expressions)

Takes a list of expressions and stores them such that
`get_source_expressions()` can return them.

    relabeled_clone(*change_map*)[¶](#django.db.models.Expression.relabeled_clone)
...
```
     ...
     convert_value(*value*, *expression*, *connection*)[¶](#django.db.models.Expression.convert_value)
...
`expression` is the same as `self`.
    ...
    get_group_by_cols()[¶](#django.db.models.Expression.get_group_by_cols)
...
The `alias=None` keyword argument was removed.
     ...
     asc(*nulls_first=None*, *nulls_last=None*)[¶](#django.db.models.Expression.asc)
...
See [Using F() to sort null values](#using-f-to-sort-null-values) for example usage.
    ...
    desc(*nulls_first=None*, *nulls_last=None*)[¶](#django.db.models.Expression.desc)
...
See [Using F() to sort null values](#using-f-to-sort-null-values) for example usage.
    ...
    reverse_ordering()[¶](#django.db.models.Expression.reverse_ordering)
...
[reverse()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.reverse) is called on a
queryset.
...
`LEN` instead of `LENGTH` for the [Length](https://docs.djangoproject.com/en/5.0/ref/database-functions/#django.db.models.functions.Length) function.
...
should live in an [AppConfig.ready()](https://docs.djangoproject.com/en/5.0/applications/#django.apps.AppConfig.ready) method.
