...
[Differences between versions](https://docs.djangoproject.com/en/intro/whatsnext/#differences-between-doc-versions)).
...
- [Tutorials](https://docs.djangoproject.com/en/intro/) take the reader by the hand through a series
  ...
  explain afterward.
- [Topic guides](https://docs.djangoproject.com/en/topics/) aim to explain a concept or subject at a
  fairly high level.
...
- [Reference guides](https://docs.djangoproject.com/en/ref/) contain technical references for APIs.
  ...
  topic guide.
- [How-to guides](https://docs.djangoproject.com/en/howto/) are recipes that take the reader through
...
[Installing the development version](https://docs.djangoproject.com/en/topics/install/#installing-development-version)):
...
See [Localizing the Django documentation](https://docs.djangoproject.com/en/5.0/internals/localizing/#translating-documentation) if
...
[django-admin](https://docs.djangoproject.com/en/ref/django-admin/) command. This is configured in
...
Start from the [Writing code](https://docs.djangoproject.com/en/5.0/internals/writing-code/) docs.
...
See [Writing documentation](https://docs.djangoproject.com/en/5.0/internals/writing-documentation/) for more.
...
See [Localizing Django](https://docs.djangoproject.com/en/5.0/internals/localizing/) to help translate Django.
...
- Join the [Django forum](https://forum.djangoproject.com/). This forum is a place for discussing the Django
  ...
  contributing to Django.
- Join the [django-users](https://docs.djangoproject.com/en/5.0/mailing-lists/#django-users-mailing-list) mailing list and answer questions. This
