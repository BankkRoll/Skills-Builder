...
[deprecation policy](https://docs.djangoproject.com/en/5.0/release-process/#internal-release-deprecation-policy). More details
about each item can often be found in the release notes of two versions prior.

## 6.0¶

See the [Django 5.0 release notes](https://docs.djangoproject.com/en/releases/5.0/#deprecated-features-5-0) for more
...
See the [Django 4.2 release notes](https://docs.djangoproject.com/en/releases/4.2/#deprecated-features-4-2) for more
details on these changes.
...
See the [Django 4.0 release notes](https://docs.djangoproject.com/en/releases/4.0/#deprecated-features-4-0) for more
details on these changes.
...
See the [Django 4.1 release notes](https://docs.djangoproject.com/en/releases/4.1/#deprecated-features-4-1) for more
details on these changes.
...
See the [Django 3.2 release notes](https://docs.djangoproject.com/en/releases/3.2/#deprecated-features-3-2) for more
details on these changes.
...
See the [Django 3.0 release notes](https://docs.djangoproject.com/en/releases/3.0/#deprecated-features-3-0) for more
details on these changes.
...
See the [Django 3.1 release notes](https://docs.djangoproject.com/en/releases/3.1/#deprecated-features-3-1) for more
details on these changes.

- The `PASSWORD_RESET_TIMEOUT_DAYS` setting will be removed.
- The undocumented usage of the [isnull](https://docs.djangoproject.com/en/ref/models/querysets/#std-fieldlookup-isnull) lookup with non-boolean values
...
See the [Django 2.2 release notes](https://docs.djangoproject.com/en/releases/2.2/#deprecated-features-2-2) for more
details on these changes.
...
See the [Django 2.0 release notes](https://docs.djangoproject.com/en/releases/2.0/#deprecated-features-2-0) for more
details on these changes.
...
See the [Django 2.1 release notes](https://docs.djangoproject.com/en/releases/2.1/#deprecated-features-2-1) for more
details on these changes.
...
See the [Django 1.11 release notes](https://docs.djangoproject.com/en/releases/1.11/#deprecated-features-1-11) for more
details on these changes.
...
See the [Django 1.9 release notes](https://docs.djangoproject.com/en/releases/1.9/#deprecated-features-1-9) for more
details on these changes.
...
See the [Django 1.10 release notes](https://docs.djangoproject.com/en/releases/1.10/#deprecated-features-1-10) for more
details on these changes.
...
See the [Django 1.8 release notes](https://docs.djangoproject.com/en/releases/1.8/#deprecated-features-1-8) for more
details on these changes.
...
- The class `django.core.management.NoArgsCommand` will be removed. Use
  [BaseCommand](https://docs.djangoproject.com/en/howto/custom-management-commands/#django.core.management.BaseCommand) instead, which takes no arguments
  by default.
...
- The following private APIs will be removed from
  [django.db.models.options.Options](https://docs.djangoproject.com/en/ref/models/meta/#django.db.models.options.Options) (`Model._meta`):
  - `get_field_by_name()`
  - `get_all_field_names()`
...
- Django template objects returned by
  [get_template()](https://docs.djangoproject.com/en/topics/templates/#django.template.loader.get_template) and
  [select_template()](https://docs.djangoproject.com/en/topics/templates/#django.template.loader.select_template) won’t accept a
  [Context](https://docs.djangoproject.com/en/ref/templates/api/#django.template.Context) in their
  [render()](https://docs.djangoproject.com/en/topics/templates/#django.template.backends.base.Template.render) method anymore.
- [Template response APIs](https://docs.djangoproject.com/en/ref/template-response/) will enforce the use
  of [dict](https://docs.python.org/3/library/stdtypes.html#dict) and backend-dependent template objects instead of
  [Context](https://docs.djangoproject.com/en/ref/templates/api/#django.template.Context) and [Template](https://docs.djangoproject.com/en/ref/templates/api/#django.template.Template)
  respectively.
...
- Support for the syntax of `{% cycle %}` that uses comma-separated arguments
  will be removed.
- The warning that [Signer](https://docs.djangoproject.com/en/topics/signing/#django.core.signing.Signer) issues when given an
  invalid separator will become an exception.

## 1.9¶

See the [Django 1.7 release notes](https://docs.djangoproject.com/en/releases/1.7/#deprecated-features-1-7) for more
details on these changes.
...
- All models will need to be defined inside an installed application or
  declare an explicit [app_label](https://docs.djangoproject.com/en/ref/models/options/#django.db.models.Options.app_label).
...
- The `--natural` and `-n` options for [dumpdata](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-dumpdata) will be removed.
...
- `django.core.cache.get_cache` will be removed. Add suitable entries
  to [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) and use [django.core.cache.caches](https://docs.djangoproject.com/en/topics/cache/#django.core.cache.caches) instead.
...
- The `cache_choices` option to [ModelChoiceField](https://docs.djangoproject.com/en/ref/forms/fields/#django.forms.ModelChoiceField) and
  [ModelMultipleChoiceField](https://docs.djangoproject.com/en/ref/forms/fields/#django.forms.ModelMultipleChoiceField) will be removed.
- The default value of the
  [RedirectView.permanent](https://docs.djangoproject.com/en/ref/class-based-views/base/#django.views.generic.base.RedirectView.permanent)
...
See the [Django 1.6 release notes](https://docs.djangoproject.com/en/releases/1.6/#deprecated-features-1-6) for more
details on these changes.
...
- The [cycle](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-cycle) and [firstof](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-firstof) template tags will auto-escape their
  arguments. In 1.6 and 1.7, this behavior is provided by the version of these
  tags in the `future` template tag library.
- The `SEND_BROKEN_LINK_EMAILS` setting will be removed. Add the
  [django.middleware.common.BrokenLinkEmailsMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.middleware.common.BrokenLinkEmailsMiddleware) middleware to
...
See the [Django 1.5 release notes](https://docs.djangoproject.com/en/releases/1.5/#deprecated-features-1-5) for more
details on these changes.
...
- The `mimetype` argument to the `__init__` methods of
  [HttpResponse](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse),
  [SimpleTemplateResponse](https://docs.djangoproject.com/en/ref/template-response/#django.template.response.SimpleTemplateResponse), and
  [TemplateResponse](https://docs.djangoproject.com/en/ref/template-response/#django.template.response.TemplateResponse), will be removed.
  `content_type` should be used instead. This also applies to the
  `render_to_response()` shortcut and the sitemap views,
  [index()](https://docs.djangoproject.com/en/ref/contrib/sitemaps/#django.contrib.sitemaps.views.index) and
  [sitemap()](https://docs.djangoproject.com/en/ref/contrib/sitemaps/#django.contrib.sitemaps.views.sitemap).
- When [HttpResponse](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse) is instantiated with an iterator,
  or when [content](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse.content) is set to an iterator,
...
- The `depth` keyword argument will be removed from
  [select_related()](https://docs.djangoproject.com/en/ref/models/querysets/#django.db.models.query.QuerySet.select_related).
- The undocumented `get_warnings_state()`/`restore_warnings_state()`
  functions from [django.test.utils](https://docs.djangoproject.com/en/topics/testing/advanced/#module-django.test.utils) and the `save_warnings_state()`/
  `restore_warnings_state()` [django.test.*TestCase](https://docs.djangoproject.com/en/topics/testing/tools/#django-testcase-subclasses) methods are
...
- The undocumented `check_for_test_cookie` method in
  [AuthenticationForm](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.forms.AuthenticationForm) will be removed
...
See the [Django 1.4 release notes](https://docs.djangoproject.com/en/releases/1.4/#deprecated-features-1-4) for more
details on these changes.
...
- The `IGNORABLE_404_STARTS` and `IGNORABLE_404_ENDS` settings have been
  superseded by [IGNORABLE_404_URLS](https://docs.djangoproject.com/en/ref/settings/#std-setting-IGNORABLE_404_URLS) in the 1.4 release. They will be
  removed.
...
- Legacy ways of calling
  [cache_page()](https://docs.djangoproject.com/en/topics/cache/#django.views.decorators.cache.cache_page) will be removed.
- The backward-compatibility shim to automatically add a debug-false
  ...
  [LOGGING](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING) setting should include this filter explicitly if
  it is desired.
...
- `django.conf.urls.defaults` will be removed. The functions
  ...
  [handler404](https://docs.djangoproject.com/en/ref/urls/#django.conf.urls.handler404) and [handler500](https://docs.djangoproject.com/en/ref/urls/#django.conf.urls.handler500)
  are now available through `django.conf.urls`.
- The functions `setup_environ()` and `execute_manager()` will be removed
  from [django.core.management](https://docs.djangoproject.com/en/howto/custom-management-commands/#module-django.core.management). This also means that the old (pre-1.4)
...
See the [Django 1.3 release notes](https://docs.djangoproject.com/en/releases/1.3/#deprecated-features-1-3) for more
details on these changes.

- Starting Django without a [SECRET_KEY](https://docs.djangoproject.com/en/ref/settings/#std-setting-SECRET_KEY) will result in an exception
  rather than a `DeprecationWarning`. (This is accelerated from the usual
  deprecation path; see the [Django 1.4 release notes](https://docs.djangoproject.com/en/releases/1.4/).)
- The `mod_python` request handler will be removed. The `mod_wsgi`
  handler should be used instead.
- The `template` attribute on `django.test.client.Response`
  objects returned by the [test client](https://docs.djangoproject.com/en/topics/testing/tools/#test-client) will be removed.
  The [templates](https://docs.djangoproject.com/en/topics/testing/tools/#django.test.Response.templates) attribute should be
  used instead.
...
- The function-based generic view modules will be removed in favor of their
  class-based equivalents, outlined [here](https://docs.djangoproject.com/en/topics/class-based-views/).
...
- The template tags library `adminmedia` and the template tag `{%
  ...
  [Django 1.4 release notes](https://docs.djangoproject.com/en/releases/1.4/).)
...
- [transform()](https://docs.djangoproject.com/en/ref/contrib/gis/geos/#django.contrib.gis.geos.GEOSGeometry.transform) will raise
  a [GEOSException](https://docs.djangoproject.com/en/ref/contrib/gis/geos/#django.contrib.gis.geos.GEOSException) when called
...
- The [MEDIA_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-MEDIA_URL) or [STATIC_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATIC_URL) settings will be
...
- Translations located under the so-called *project path* will be ignored during
  ...
  [LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) setting can be used for the same task by including the
...
- The `CACHE_BACKEND` setting will be removed. The cache backend(s) should be
  specified in the [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting.

## 1.4¶

See the [Django 1.2 release notes](https://docs.djangoproject.com/en/releases/1.2/#deprecated-features-1-2) for more
details on these changes.
...
- The `Message` model (in `django.contrib.auth`), its related
  ...
  [messages framework](https://docs.djangoproject.com/en/ref/contrib/messages/) should be used
...
See the [Django 1.1 release notes](https://docs.djangoproject.com/en/releases/1.1/#deprecated-features-1-1) for more
details on these changes.
