...
First, please check if your question is answered on the [FAQ](https://docs.djangoproject.com/en/5.0/). Also, search for answers using your favorite search engine, and
...
- The Django Forum section [“Using Django”](https://forum.djangoproject.com/c/users/6). This is for web-based
  discussions.
- The [django-users](https://docs.djangoproject.com/en/internals/mailing-lists/#django-users-mailing-list) mailing list. This is for email-based discussions.
...
[django-users](https://docs.djangoproject.com/en/internals/mailing-lists/#django-users-mailing-list) has a lot of subscribers. This is good for the community, as
it means many people are available to contribute answers to questions.
Unfortunately, it also means that [django-users](https://docs.djangoproject.com/en/internals/mailing-lists/#django-users-mailing-list) is an attractive target for
spammers.

In order to combat the spam problem, when you join the [django-users](https://docs.djangoproject.com/en/internals/mailing-lists/#django-users-mailing-list) mailing
...
You might notice we have a second mailing list, called [django-developers](https://docs.djangoproject.com/en/internals/mailing-lists/#django-developers-mailing-list).
...
[django-users](https://docs.djangoproject.com/en/internals/mailing-lists/#django-users-mailing-list).

## I think I’ve found a bug! What should I do?¶

Detailed instructions on how to handle a potential bug can be found in our
[Guide to contributing to Django](https://docs.djangoproject.com/en/internals/contributing/bugs-and-features/#reporting-bugs).

## I think I’ve found a security problem! What should I do?¶

If you think you’ve found a security problem with Django, please send a message
to [security@djangoproject.com](mailto:security%40djangoproject.com). This is a private list only open to long-time,
...
[policy for handling security issues](https://docs.djangoproject.com/en/internals/security/#reporting-security-issues);
