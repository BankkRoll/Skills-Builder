# Internationalization and localization¶ and more
...
Django has full support for [translation of text](https://docs.djangoproject.com/en/5.0/topics/translation/), [formatting of dates, times and numbers](https://docs.djangoproject.com/en/5.0/topics/formatting/), and [time zones](https://docs.djangoproject.com/en/5.0/topics/timezones/).
...
here’s a simplified definition:
  ...
  internationalization[¶](#term-internationalization)
...
Translation is controlled by the [USE_I18N](https://docs.djangoproject.com/en/ref/settings/#std-setting-USE_I18N) setting. However, it
...
underscore.
  ...
  language code[¶](#term-language-code)
...
header is case-insensitive. The separator is a dash.
  ...
  message file[¶](#term-message-file)
...
language. Message files have a `.po` file extension.
  ...
  translation string[¶](#term-translation-string)

A literal that can be translated.

  format file[¶](#term-format-file)
...
- [How to configure and use logging](https://docs.djangoproject.com/en/howto/logging/#logging-how-to)
- [Django logging reference](https://docs.djangoproject.com/en/ref/logging/#logging-ref)
...
read more about how to [filter error reports](https://docs.djangoproject.com/en/howto/error-reporting/#filtering-error-reports).

### AdminEmailHandler¶

The built-in [AdminEmailHandler](https://docs.djangoproject.com/en/ref/logging/#django.utils.log.AdminEmailHandler) deserves a mention in
...
[DEBUG](https://docs.djangoproject.com/en/ref/settings/#std-setting-DEBUG) is `True`).
...
In order to configure logging, you use [LOGGING](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING) to define a
dictionary of logging settings. These settings describe the loggers,
handlers, filters and formatters that you want in your logging setup,
and the log levels and other properties that you want those components
to have.

By default, the [LOGGING](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING) setting is merged with [Django’s
default logging configuration](https://docs.djangoproject.com/en/ref/logging/#default-logging-configuration) using the
following scheme.

If the `disable_existing_loggers` key in the [LOGGING](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING) dictConfig is
...
of the default loggers; or you can set [LOGGING_CONFIG](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING_CONFIG) to `None`
...
logging system print more messages from just the [django](https://docs.djangoproject.com/en/ref/logging/#django-logger) named
logger:
...
logging from the [django](https://docs.djangoproject.com/en/ref/logging/#django-logger) named logger to a local file:
...
- Defines two handlers:
  - `console`, a [StreamHandler](https://docs.python.org/3/library/logging.handlers.html#logging.StreamHandler), which prints any `INFO`
    ...
    output format.
  - `mail_admins`, an [AdminEmailHandler](https://docs.djangoproject.com/en/ref/logging/#django.utils.log.AdminEmailHandler), which
    emails any `ERROR` (or higher) message to the site [ADMINS](https://docs.djangoproject.com/en/ref/settings/#std-setting-ADMINS).
...
The [LOGGING_CONFIG](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING_CONFIG) setting defines the callable that will
...
that takes a single argument. The contents of [LOGGING](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING) will
...
[LOGGING_CONFIG](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING_CONFIG) to `None`. This will disable the
configuration process for [Django’s default logging](https://docs.djangoproject.com/en/ref/logging/#default-logging-configuration).

Setting [LOGGING_CONFIG](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING_CONFIG) to `None` only means that the automatic
...
[LOGGING_CONFIG](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGGING_CONFIG) once settings are fully-loaded. In contrast, manually
