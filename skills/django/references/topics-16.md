...
See the section on [Media objects](#media-objects) for more details on how to construct
...
[django.contrib.staticfiles](https://docs.djangoproject.com/en/ref/contrib/staticfiles/#module-django.contrib.staticfiles) app is installed, it will be used to serve
assets.

Whether or not you use [django.contrib.staticfiles](https://docs.djangoproject.com/en/ref/contrib/staticfiles/#module-django.contrib.staticfiles),  the
[STATIC_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATIC_URL) and [STATIC_ROOT](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATIC_ROOT) settings are required to
render a complete web page.

To find the appropriate prefix to use, Django will check if the
[STATIC_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATIC_URL) setting is not `None` and automatically fall back
to using [MEDIA_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-MEDIA_URL). For example, if the [MEDIA_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-MEDIA_URL) for
your site was `'http://uploads.example.com/'` and [STATIC_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATIC_URL)
was `None`:
...
But if [STATIC_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-STATIC_URL) is `'http://static.example.com/'`:
...
Or if [staticfiles](https://docs.djangoproject.com/en/ref/contrib/staticfiles/#module-django.contrib.staticfiles) is configured using the
[ManifestStaticFilesStorage](https://docs.djangoproject.com/en/ref/contrib/staticfiles/#django.contrib.staticfiles.storage.ManifestStaticFilesStorage):
...
[html_safe()](https://docs.djangoproject.com/en/ref/utils/#django.utils.html.html_safe) decorator. The object is responsible for
