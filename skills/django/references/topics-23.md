...
[translation strings](https://docs.djangoproject.com/en/5.0/topics/#term-translation-string). They tell Django: “This text
...
[message file](https://docs.djangoproject.com/en/5.0/topics/#term-message-file). This file is a convenient way for translators to provide
...
[USE_I18N=False](https://docs.djangoproject.com/en/ref/settings/#std-setting-USE_I18N) in your settings file. Then Django will
make some optimizations so as not to load the internationalization machinery.

Note

Make sure you’ve activated translation for your project (the fastest way is
to check if [MIDDLEWARE](https://docs.djangoproject.com/en/ref/settings/#std-setting-MIDDLEWARE) includes
[django.middleware.locale.LocaleMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.middleware.locale.LocaleMiddleware)). If you haven’t yet,
...
[gettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext). It’s convention to import this
...
1. Sometimes, you should use [gettext_lazy()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext_lazy)
...
Because of how `xgettext` (used by [makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages)) works, only
functions that take a single string argument can be imported as `_`:

- [gettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext)
- [gettext_lazy()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext_lazy)
...
[django-adminmakemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages), won’t be able to find
these strings. More on [makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) later.)
...
Use the function [django.utils.translation.gettext_noop()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext_noop) to mark a
...
Use the function [django.utils.translation.ngettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.ngettext) to specify
pluralized messages.
...
You would get an error when running [django-admincompilemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages):
...
[django.utils.translation.pgettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.pgettext) function, or the
[django.utils.translation.npgettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.npgettext) function if the string needs
...
[django.utils.translation](https://docs.djangoproject.com/en/ref/utils/#module-django.utils.translation) (easily recognizable by the `lazy` suffix in
...
#### Model fields and relationshipsverbose_nameandhelp_textoption values¶
...
You can mark names of [ForeignKey](https://docs.djangoproject.com/en/ref/models/fields/#django.db.models.ForeignKey),
[ManyToManyField](https://docs.djangoproject.com/en/ref/models/fields/#django.db.models.ManyToManyField) or
[OneToOneField](https://docs.djangoproject.com/en/ref/models/fields/#django.db.models.OneToOneField) relationship as translatable by using
their [verbose_name](https://docs.djangoproject.com/en/ref/models/options/#django.db.models.Options.verbose_name) options:
...
Just like you would do in [verbose_name](https://docs.djangoproject.com/en/ref/models/options/#django.db.models.Options.verbose_name) you
...
[verbose_name](https://docs.djangoproject.com/en/ref/models/options/#django.db.models.Options.verbose_name) and
[verbose_name_plural](https://docs.djangoproject.com/en/ref/models/options/#django.db.models.Options.verbose_name_plural) options rather than
...
#### Model methodsdescriptionargument to the@displaydecorator¶

For model methods, you can provide translations to Django and the admin site
with the `description` argument to the [display()](https://docs.djangoproject.com/en/ref/contrib/admin/#django.contrib.admin.display)
decorator:
...
[django.utils.text.format_lazy()](https://docs.djangoproject.com/en/ref/utils/#django.utils.text.format_lazy), which creates a lazy object
...
### Localized names of languages¶
   ...
   get_language_info(*lang_code*)[[source]](https://docs.djangoproject.com/en/_modules/django/utils/translation/#get_language_info)[¶](#django.utils.translation.get_language_info)
...
Translations in [Django templates](https://docs.djangoproject.com/en/ref/templates/language/) uses two template
...
[gettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext) call.
...
Other block tags (for example [{%for%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-for) or [{%if%}](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-if)) are
...
temporarily with the [deactivate_all()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.deactivate_all)
function.
...
translators can be specified using comments, either with the [comment](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatetag-comment)
tag:
...
or with the `{#` … `#}` [one-line comment constructs](https://docs.djangoproject.com/en/ref/templates/language/#template-comments):
...
which the first element is the [language code](https://docs.djangoproject.com/en/5.0/topics/#term-language-code) and the second is the
...
#### i18ncontext processor¶

If you enable the [django.template.context_processors.i18n](https://docs.djangoproject.com/en/ref/templates/api/#django.template.context_processors.i18n) context
...
[LANGUAGES](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGES)). See [the section about the set_language redirect
view](#set-language-redirect-view) for an example of how to display a language
selector using `{% get_language_info_list %}`.

In addition to [LANGUAGES](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGES) style list of tuples,
...
### TheJavaScriptCatalogview¶

   *class*JavaScriptCatalog[[source]](https://docs.djangoproject.com/en/_modules/django/views/i18n/#JavaScriptCatalog)[¶](#django.views.i18n.JavaScriptCatalog)
...
**Attributes**
   ...
   domain[¶](#django.views.i18n.JavaScriptCatalog.domain)

Translation domain containing strings to add in the view output.
Defaults to `'djangojs'`.

    packages[¶](#django.views.i18n.JavaScriptCatalog.packages)

A list of [applicationnames](https://docs.djangoproject.com/en/ref/applications/#django.apps.AppConfig.name) among
installed applications. Those apps should contain a `locale`
directory. All those catalogs plus all catalogs found in
[LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) (which are always included) are merged into one
catalog. Defaults to `None`, which means that all available
translations from all [INSTALLED_APPS](https://docs.djangoproject.com/en/ref/settings/#std-setting-INSTALLED_APPS) are provided in the
JavaScript output.
...
- [DATE_FORMAT](https://docs.djangoproject.com/en/ref/settings/#std-setting-DATE_FORMAT)
- [DATE_INPUT_FORMATS](https://docs.djangoproject.com/en/ref/settings/#std-setting-DATE_INPUT_FORMATS)
- [DATETIME_FORMAT](https://docs.djangoproject.com/en/ref/settings/#std-setting-DATETIME_FORMAT)
- [DATETIME_INPUT_FORMATS](https://docs.djangoproject.com/en/ref/settings/#std-setting-DATETIME_INPUT_FORMATS)
- [DECIMAL_SEPARATOR](https://docs.djangoproject.com/en/ref/settings/#std-setting-DECIMAL_SEPARATOR)
- [FIRST_DAY_OF_WEEK](https://docs.djangoproject.com/en/ref/settings/#std-setting-FIRST_DAY_OF_WEEK)
- [MONTH_DAY_FORMAT](https://docs.djangoproject.com/en/ref/settings/#std-setting-MONTH_DAY_FORMAT)
- [NUMBER_GROUPING](https://docs.djangoproject.com/en/ref/settings/#std-setting-NUMBER_GROUPING)
- [SHORT_DATE_FORMAT](https://docs.djangoproject.com/en/ref/settings/#std-setting-SHORT_DATE_FORMAT)
- [SHORT_DATETIME_FORMAT](https://docs.djangoproject.com/en/ref/settings/#std-setting-SHORT_DATETIME_FORMAT)
- [THOUSAND_SEPARATOR](https://docs.djangoproject.com/en/ref/settings/#std-setting-THOUSAND_SEPARATOR)
- [TIME_FORMAT](https://docs.djangoproject.com/en/ref/settings/#std-setting-TIME_FORMAT)
- [TIME_INPUT_FORMATS](https://docs.djangoproject.com/en/ref/settings/#std-setting-TIME_INPUT_FORMATS)
- [YEAR_MONTH_FORMAT](https://docs.djangoproject.com/en/ref/settings/#std-setting-YEAR_MONTH_FORMAT)
...
([pgettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.pgettext)), providing a contextually
translated word:
...
([npgettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.npgettext)), providing a **pluralized**
...
The `pluralidx` function works in a similar way to the [pluralize](https://docs.djangoproject.com/en/ref/templates/builtins/#std-templatefilter-pluralize)
...
### TheJSONCatalogview¶
   ...
   *class*JSONCatalog[[source]](https://docs.djangoproject.com/en/_modules/django/views/i18n/#JSONCatalog)[¶](#django.views.i18n.JSONCatalog)
...
[cache_page()](https://docs.djangoproject.com/en/5.0/cache/#django.views.decorators.cache.cache_page) decorator. To trigger cache
...
you’re using ETags ([ConditionalGetMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.middleware.http.ConditionalGetMiddleware)),
you’re already covered. Otherwise, you can apply [conditional decorators](https://docs.djangoproject.com/en/5.0/conditional-view-processing/#conditional-decorators). In the following example, the cache is invalidated
...
in [django-statici18n](https://django-statici18n.readthedocs.io/).
...
- Adding the language prefix to the root of the URL patterns to make it
  possible for [LocaleMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.middleware.locale.LocaleMiddleware) to detect
  the language to activate from the requested URL.
- Making URL patterns themselves translatable via the
  [django.utils.translation.gettext_lazy()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext_lazy) function.
...
[django.middleware.locale.LocaleMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.middleware.locale.LocaleMiddleware) in your
[MIDDLEWARE](https://docs.djangoproject.com/en/ref/settings/#std-setting-MIDDLEWARE) setting.

### Language prefix in URL patterns¶

   i18n_patterns(**urls*, *prefix_default_language=True*)[[source]](https://docs.djangoproject.com/en/_modules/django/conf/urls/i18n/#i18n_patterns)[¶](#django.conf.urls.i18n.i18n_patterns)
...
default language ([LANGUAGE_CODE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_CODE)). This can be useful when adding
...
[ImproperlyConfigured](https://docs.djangoproject.com/en/ref/exceptions/#django.core.exceptions.ImproperlyConfigured) exception.
...
[gettext_lazy()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext_lazy) function. Example:
...
After you’ve created the translations, the [reverse()](https://docs.djangoproject.com/en/ref/urlresolvers/#django.urls.reverse)
...
The first step is to create a [message file](https://docs.djangoproject.com/en/5.0/topics/#term-message-file) for a new language. A message
file is a plain-text file, representing a single language, that contains all
available translation strings and how they should be represented in the given
language. Message files have a `.po` file extension.

Django comes with a tool, [django-adminmakemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages), that automates the creation and upkeep of these files.
...
…where `de` is the [locale name](https://docs.djangoproject.com/en/5.0/topics/#term-locale-name) for the message file you want to
...
[How Django discovers translations](#how-django-discovers-translations) and be sure [LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS)
...
message file under the directory listed first in [LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) or
will generate an error if [LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) is empty.

By default [django-adminmakemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) examines every
file that has the `.html`, `.txt` or `.py` file extension. If you want to
override that default, use the [--extension](https://docs.djangoproject.com/en/ref/django-admin/#cmdoption-makemessages-extension)
...
[makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) doesn’t understand the syntax of Jinja2 templates.
To extract strings from a project containing Jinja2 templates, use [Message
Extracting](https://babel.pocoo.org/en/latest/messages.html#message-extraction) from [Babel](https://babel.pocoo.org/en/latest/) instead.
...
Babel provides similar features to [makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages), can replace it
in general, and doesn’t depend on `gettext`. For more information, read
its documentation about [working with message catalogs](https://babel.pocoo.org/en/latest/messages.html).

No gettext?

If you don’t have the `gettext` utilities installed,
[makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) will create empty files. If that’s the case, either
...
[makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) works, see [gettext on Windows](#gettext-on-windows) for more
information.
...
…then [django-adminmakemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) will have created
...
[makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) sometimes generates translation entries marked as
fuzzy, e.g. when translations are inferred from previously translated
strings. By default, fuzzy entries are **not** processed by
[compilemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages).
...
this with the [django-admincompilemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages)
utility.

This tool runs over all available `.po` files and creates `.mo` files, which
are binary files optimized for use by `gettext`. In the same directory from
which you ran [django-adminmakemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages), run
[django-admincompilemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages) like this:
...
If you’re using Windows and need to install the GNU gettext utilities so
[django-admincompilemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages) works see
[gettext on Windows](#gettext-on-windows) for more information.
...
### Troubleshooting:gettext()incorrectly detectspython-formatin strings with percent signs¶
...
`_("10% interest")`), [gettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext) incorrectly
...
files – with the [django-adminmakemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) tool.
...
updating message files, run [django-admincompilemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages) the same way as you do with normal Django message files.
...
custom [makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) command and override its `xgettext_options`
attribute:
...
[makemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages) command:
...
### Theset_languageredirect view¶
   ...
   set_language(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/views/i18n/#set_language)[¶](#django.views.i18n.set_language)
...
through the [LANGUAGE_COOKIE_NAME](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_NAME) setting.)
...
You’ve already been introduced to [django.utils.translation.activate()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.activate). That
applies to the current thread only. To persist the language for the entire
session in a cookie, set the [LANGUAGE_COOKIE_NAME](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_NAME) cookie on the
response:
...
You would typically want to use both: [django.utils.translation.activate()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.activate)
...
regardless of [LANGUAGE_CODE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_CODE) and language set by middleware.

Functions of particular interest are
[django.utils.translation.get_language()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.get_language) which returns the language used
in the current thread, [django.utils.translation.activate()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.activate) which
activates a translation catalog for the current thread, and
[django.utils.translation.check_for_language()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.check_for_language)
which checks if the given language is supported by Django.

To help write more concise code, there is also a context manager
[django.utils.translation.override()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.override) that stores the current language on
...
- [LANGUAGE_COOKIE_NAME](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_NAME)
- [LANGUAGE_COOKIE_AGE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_AGE)
- [LANGUAGE_COOKIE_DOMAIN](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_DOMAIN)
- [LANGUAGE_COOKIE_HTTPONLY](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_HTTPONLY)
- [LANGUAGE_COOKIE_PATH](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_PATH)
- [LANGUAGE_COOKIE_SAMESITE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_SAMESITE)
- [LANGUAGE_COOKIE_SECURE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_SECURE)
...
To set an installation-wide language preference, set [LANGUAGE_CODE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_CODE).
...
is set [LANGUAGE_CODE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_CODE) and make sure the corresponding [message
files](https://docs.djangoproject.com/en/5.0/topics/#term-message-file) and their compiled versions (`.mo`) exist.
...
to your [MIDDLEWARE](https://docs.djangoproject.com/en/ref/settings/#std-setting-MIDDLEWARE) setting. Because middleware order matters, follow
these guidelines:
...
For example, your [MIDDLEWARE](https://docs.djangoproject.com/en/ref/settings/#std-setting-MIDDLEWARE) might look like this:
...
(For more on middleware, see the [middleware documentation](https://docs.djangoproject.com/en/5.0/http/middleware/).)
...
- Failing that, it looks for a cookie.
  The name of the cookie used is set by the [LANGUAGE_COOKIE_NAME](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_NAME)
  setting. (The default name is `django_language`.)
- Failing that, it looks at the `Accept-Language` HTTP header. This
  header is sent by your browser and tells the server which language(s) you
  prefer, in order by priority. Django tries each language in the header
  until it finds one with available translations.
- Failing that, it uses the global [LANGUAGE_CODE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_CODE) setting.

Notes:

- In each of these places, the language preference is expected to be in the
  standard [language format](https://docs.djangoproject.com/en/5.0/topics/#term-language-code), as a string. For example,
  Brazilian Portuguese is `pt-br`.
- If a base language is available but the sublanguage specified is not,
  Django uses the base language. For example, if a user specifies `de-at`
  (Austrian German) but Django only has `de` available, Django uses
  `de`.
- Only languages listed in the [LANGUAGES](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGES) setting can be selected.
  If you want to restrict the language selection to a subset of provided
  languages (because your application doesn’t provide all those languages),
  set [LANGUAGES](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGES) to a list of languages. For example:
  ```
  LANGUAGES = [
      ("de", _("German")),
      ("en", _("English")),
  ...
  `en-us`).
- If you define a custom [LANGUAGES](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGES) setting, as explained in the
  previous bullet, you can mark the language names as translation strings
  – but use [gettext_lazy()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext_lazy) instead of
  [gettext()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.gettext) to avoid a circular import.
...
[HttpRequest](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpRequest). Feel free to read this value in your view
...
[message files](https://docs.djangoproject.com/en/5.0/topics/#term-message-file) (`.mo`) and the precedence of multiple
translations for the same literal:

1. The directories listed in [LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) have the highest
  precedence, with the ones appearing first having higher precedence than
  the ones appearing later.
2. Then, it looks for and uses if it exists a `locale` directory in each
  of the installed apps listed in [INSTALLED_APPS](https://docs.djangoproject.com/en/ref/settings/#std-setting-INSTALLED_APPS).  The ones
...
You can also put [custom format files](https://docs.djangoproject.com/en/5.0/topics/formatting/#custom-format-files) in the
[LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) directories if you also set
[FORMAT_MODULE_PATH](https://docs.djangoproject.com/en/ref/settings/#std-setting-FORMAT_MODULE_PATH).

In all cases the name of the directory containing the translation is expected to
be named using [locale name](https://docs.djangoproject.com/en/5.0/topics/#term-locale-name) notation. E.g. `de`, `pt_BR`, `es_AR`,
...
- All paths listed in [LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) in your settings file are
  searched for `<language>/LC_MESSAGES/django.(po|mo)`
- `$APPPATH/locale/<language>/LC_MESSAGES/django.(po|mo)`
- `$PYTHONPATH/django/conf/locale/<language>/LC_MESSAGES/django.(po|mo)`

To create message files, you use the [django-adminmakemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-makemessages)
tool. And you use [django-admincompilemessages](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages)
to produce the binary `.mo` files that are used by `gettext`.

You can also run [django-admincompilemessages--settings=path.to.settings](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-compilemessages) to make the compiler process all
the directories in your [LOCALE_PATHS](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOCALE_PATHS) setting.
...
- When an English variant is activated and English strings are missing, the
  fallback language will not be the [LANGUAGE_CODE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_CODE) of the project,
  but the original strings. For example, an English user visiting a site with
  [LANGUAGE_CODE](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_CODE) set to Spanish and original strings written in
