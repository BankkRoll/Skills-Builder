...
1. Add `'django.contrib.admin'` and its dependencies -
  [django.contrib.auth](https://docs.djangoproject.com/en/topics/auth/#module-django.contrib.auth), [django.contrib.contenttypes](https://docs.djangoproject.com/en/5.0/ref/contenttypes/#module-django.contrib.contenttypes),
  [django.contrib.messages](https://docs.djangoproject.com/en/5.0/ref/messages/#module-django.contrib.messages), and [django.contrib.sessions](https://docs.djangoproject.com/en/topics/http/sessions/#module-django.contrib.sessions) - to your
  [INSTALLED_APPS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-INSTALLED_APPS) setting.
2. Configure a [DjangoTemplates](https://docs.djangoproject.com/en/topics/templates/#django.template.backends.django.DjangoTemplates)
  backend in your [TEMPLATES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-TEMPLATES) setting with
  `django.template.context_processors.request`,
  `django.contrib.auth.context_processors.auth`, and
  `django.contrib.messages.context_processors.messages` in
  the `'context_processors'` option of [OPTIONS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-TEMPLATES-OPTIONS).
3. If you’ve customized the [MIDDLEWARE](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MIDDLEWARE) setting,
  [django.contrib.auth.middleware.AuthenticationMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.contrib.auth.middleware.AuthenticationMiddleware) and
  [django.contrib.messages.middleware.MessageMiddleware](https://docs.djangoproject.com/en/5.0/middleware/#django.contrib.messages.middleware.MessageMiddleware) must be
  included.
...
If you need to create a user to login with, use the [createsuperuser](https://docs.djangoproject.com/en/5.0/django-admin/#django-admin-createsuperuser)
command. By default, logging in to the admin requires that the user has the
[is_staff](https://docs.djangoproject.com/en/5.0/ref/auth/#django.contrib.auth.models.User.is_staff) attribute set to `True`.
...
CSS) associated with the admin in production, see [Serving files](https://docs.djangoproject.com/en/howto/deployment/wsgi/modwsgi/#serving-files).

Having problems?  Try [FAQ: The admin](https://docs.djangoproject.com/en/faq/admin/).

## ModelAdminobjects¶

   *class*ModelAdmin[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin)[¶](#django.contrib.admin.ModelAdmin)
...
### Theregisterdecorator¶
   ...
   register(**models*, *site=django.contrib.admin.sites.site*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/decorators/#register)[¶](#django.contrib.admin.register)
...
When you put `'django.contrib.admin'` in your [INSTALLED_APPS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-INSTALLED_APPS)
setting, Django automatically looks for an `admin` module in each
application and imports it.

   *class*apps.AdminConfig[¶](#django.contrib.admin.apps.AdminConfig)

This is the default [AppConfig](https://docs.djangoproject.com/en/5.0/applications/#django.apps.AppConfig) class for the admin.
It calls [autodiscover()](#django.contrib.admin.autodiscover) when Django starts.

    *class*apps.SimpleAdminConfig[¶](#django.contrib.admin.apps.SimpleAdminConfig)
...
This class works like [AdminConfig](#django.contrib.admin.apps.AdminConfig),
   ...
   default_site[¶](#django.contrib.admin.apps.SimpleAdminConfig.default_site)
...
[Overriding the default admin site](#overriding-default-admin-site) for usage.
     ...
     autodiscover()[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/#autodiscover)[¶](#django.contrib.admin.autodiscover)
...
`'django.contrib.admin'` in your [INSTALLED_APPS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-INSTALLED_APPS) setting.
...
```
    ...
    ModelAdmin.actions[¶](#django.contrib.admin.ModelAdmin.actions)

A list of actions to make available on the change list page. See
[Admin actions](https://docs.djangoproject.com/en/5.0/ref/contrib/actions/) for details.

    ModelAdmin.actions_on_top[¶](#django.contrib.admin.ModelAdmin.actions_on_top)    ModelAdmin.actions_on_bottom[¶](#django.contrib.admin.ModelAdmin.actions_on_bottom)

Controls where on the page the actions bar appears. By default, the admin
changelist displays actions at the top of the page (`actions_on_top = True;
actions_on_bottom = False`).

    ModelAdmin.actions_selection_counter[¶](#django.contrib.admin.ModelAdmin.actions_selection_counter)

Controls whether a selection counter is displayed next to the action dropdown.
By default, the admin changelist will display it
(`actions_selection_counter = True`).

    ModelAdmin.date_hierarchy[¶](#django.contrib.admin.ModelAdmin.date_hierarchy)
...
`date_hierarchy` uses [QuerySet.datetimes()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.datetimes) internally. Please refer
to its documentation for some caveats when time zone support is
enabled ([USE_TZ=True](https://docs.djangoproject.com/en/5.0/settings/#std-setting-USE_TZ)).

     ModelAdmin.empty_value_display[¶](#django.contrib.admin.ModelAdmin.empty_value_display)
...
```
     ...
     ModelAdmin.exclude[¶](#django.contrib.admin.ModelAdmin.exclude)
...
[django.contrib.flatpages.models.FlatPage](https://docs.djangoproject.com/en/5.0/ref/flatpages/#django.contrib.flatpages.models.FlatPage) model as follows:
...
[list_display](#django.contrib.admin.ModelAdmin.list_display), except that callables aren’t accepted.
Names of model and model admin methods will only be used if they’re listed
in [readonly_fields](#django.contrib.admin.ModelAdmin.readonly_fields).
...
dictionary key that is within the [fieldsets](#django.contrib.admin.ModelAdmin.fieldsets) option,
...
are defined in the model.
    ...
    ModelAdmin.fieldsets[¶](#django.contrib.admin.ModelAdmin.fieldsets)
...
[django.contrib.flatpages.models.FlatPage](https://docs.djangoproject.com/en/5.0/ref/flatpages/#django.contrib.flatpages.models.FlatPage) model:
...
This results in an admin page that looks like:
 ...
 ![../../../_images/fieldsets.png](https://docs.djangoproject.com/en/_images/fieldsets.png)
...
- `description`
  ...
  rendered for [TabularInline](#django.contrib.admin.TabularInline) due to its
  layout.
  Note that this value is *not* HTML-escaped when it’s displayed in
  the admin interface. This lets you include HTML if you so desire.
  Alternatively you can use plain text and
  [django.utils.html.escape()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.html.escape) to escape any HTML special
  characters.

    ModelAdmin.filter_horizontal[¶](#django.contrib.admin.ModelAdmin.filter_horizontal)

By default, a [ManyToManyField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.ManyToManyField) is displayed in
...
[ManyToManyField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.ManyToManyField) to this list will instead use
...
interface.
    ...
    ModelAdmin.filter_vertical[¶](#django.contrib.admin.ModelAdmin.filter_vertical)
...
the box of selected options.
    ...
    ModelAdmin.form[¶](#django.contrib.admin.ModelAdmin.form)
...
[ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm), you must also define the
...
field will be included in the generated form.
     ...
     ModelAdmin.formfield_overrides[¶](#django.contrib.admin.ModelAdmin.formfield_overrides)

This provides a quick-and-dirty way to override some of the
[Field](https://docs.djangoproject.com/en/5.0/forms/fields/#django.forms.Field) options for use in the admin.
...
the form field’s `__init__()` method. See [The Forms API](https://docs.djangoproject.com/en/5.0/forms/api/) for
details.

Warning

If you want to use a custom widget with a relation field (i.e.
[ForeignKey](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.ForeignKey) or
[ManyToManyField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.ManyToManyField)), make sure you haven’t
...
their own.
     ...
     ModelAdmin.inlines[¶](#django.contrib.admin.ModelAdmin.inlines)
...
[ModelAdmin.get_formsets_with_inlines()](#django.contrib.admin.ModelAdmin.get_formsets_with_inlines).
    ...
    ModelAdmin.list_display[¶](#django.contrib.admin.ModelAdmin.list_display)
...
- If the string given is a method of the model, `ModelAdmin` or a
  ...
  [format_html()](https://docs.djangoproject.com/en/5.0/utils/#django.utils.html.format_html).
...
- Usually, elements of `list_display` that aren’t actual database
  ...
  ```
  [Query expressions](https://docs.djangoproject.com/en/5.0/models/expressions/) may be used with the
  `ordering` argument:
  ```
...
- Django will try to interpret every element of `list_display` in this
  ...
  as a `ModelAdmin` attribute, the model field will be used.
    ...
    ModelAdmin.list_display_links[¶](#django.contrib.admin.ModelAdmin.list_display_links)
...
```
     ...
     ModelAdmin.list_editable[¶](#django.contrib.admin.ModelAdmin.list_editable)
...
You’ll get a validation error if either of these rules are broken.
     ...
     ModelAdmin.list_filter[¶](#django.contrib.admin.ModelAdmin.list_filter)
...
See [ModelAdmin List Filters](https://docs.djangoproject.com/en/5.0/ref/contrib/filters/#modeladmin-list-filters) for the details.

    ModelAdmin.list_max_show_all[¶](#django.contrib.admin.ModelAdmin.list_max_show_all)
...
setting. By default, this is set to `200`.
    ...
    ModelAdmin.list_per_page[¶](#django.contrib.admin.ModelAdmin.list_per_page)

Set `list_per_page` to control how many items appear on each paginated
admin change list page. By default, this is set to `100`.

    ModelAdmin.list_select_related[¶](#django.contrib.admin.ModelAdmin.list_select_related)

Set `list_select_related` to tell Django to use
[select_related()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.select_related) in retrieving
...
[select_related()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.select_related) was already
called on the changelist’s `QuerySet`.

     ModelAdmin.ordering[¶](#django.contrib.admin.ModelAdmin.ordering)

Set `ordering` to specify how lists of objects should be ordered in the
Django admin views. This should be a list or tuple in the same format as a
model’s [ordering](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.ordering) parameter.
...
`name` and `pk`.
     ...
     ModelAdmin.paginator[¶](#django.contrib.admin.ModelAdmin.paginator)

The paginator class to be used for pagination. By default,
[django.core.paginator.Paginator](https://docs.djangoproject.com/en/5.0/paginator/#django.core.paginator.Paginator) is used. If the custom paginator
class doesn’t have the same constructor interface as
[django.core.paginator.Paginator](https://docs.djangoproject.com/en/5.0/paginator/#django.core.paginator.Paginator), you will also need to
provide an implementation for [ModelAdmin.get_paginator()](#django.contrib.admin.ModelAdmin.get_paginator).

    ModelAdmin.prepopulated_fields[¶](#django.contrib.admin.ModelAdmin.prepopulated_fields)
...
`OneToOneField`, and `ManyToManyField` fields.
    ...
    ModelAdmin.preserve_filters[¶](#django.contrib.admin.ModelAdmin.preserve_filters)
...
this attribute to `False`.
    ...
    ModelAdmin.show_facets[¶](#django.contrib.admin.ModelAdmin.show_facets)  New in Django 5.0.
...
When displayed, facet counts update in line with currently applied filters.
   ...
   *class*ShowFacets[¶](#django.contrib.admin.ModelAdmin.ShowFacets)  New in Django 5.0.

Enum of allowed values for [ModelAdmin.show_facets](#django.contrib.admin.ModelAdmin.show_facets).

   ALWAYS[¶](#django.contrib.admin.ModelAdmin.ShowFacets.ALWAYS)

Always show facet counts.

    ALLOW[¶](#django.contrib.admin.ModelAdmin.ShowFacets.ALLOW)

Show facet counts when the `_facets` query string parameter is
provided.

    NEVER[¶](#django.contrib.admin.ModelAdmin.ShowFacets.NEVER)
...
[ShowFacets.NEVER](#django.contrib.admin.ModelAdmin.ShowFacets.NEVER) to disable faceting entirely.

     ModelAdmin.radio_fields[¶](#django.contrib.admin.ModelAdmin.radio_fields)
...
`choices` set.
    ...
    ModelAdmin.autocomplete_fields[¶](#django.contrib.admin.ModelAdmin.autocomplete_fields)
...
Ordering using [ModelAdmin.ordering](#django.contrib.admin.ModelAdmin.ordering) may cause performance
...
[ModelAdmin.get_search_results()](#django.contrib.admin.ModelAdmin.get_search_results) implementation using a
...
`Paginator.count` property.
     ...
     ModelAdmin.raw_id_fields[¶](#django.contrib.admin.ModelAdmin.raw_id_fields)
...
a value:
 ...
 ![../../../_images/raw_id_fields.png](https://docs.djangoproject.com/en/_images/raw_id_fields.png)    ModelAdmin.readonly_fields[¶](#django.contrib.admin.ModelAdmin.readonly_fields)

By default the admin shows all fields as editable. Any fields in this
option (which should be a `list` or `tuple`) will display its data
as-is and non-editable; they are also excluded from the
[ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm) used for creating and editing. Note that
...
```
     ...
     ModelAdmin.save_as[¶](#django.contrib.admin.ModelAdmin.save_as)
...
By default, `save_as` is set to `False`.
    ...
    ModelAdmin.save_as_continue[¶](#django.contrib.admin.ModelAdmin.save_as_continue)
...
By default, `save_as_continue` is set to `True`.
    ...
    ModelAdmin.save_on_top[¶](#django.contrib.admin.ModelAdmin.save_on_top)
...
words, case-insensitive (using the [icontains](https://docs.djangoproject.com/en/5.0/models/querysets/#std-fieldlookup-icontains) lookup), where each
...
lookup by appending it the field. For example, you could use [exact](https://docs.djangoproject.com/en/5.0/models/querysets/#std-fieldlookup-exact)
...
search behavior.
    ...
    ModelAdmin.search_help_text[¶](#django.contrib.admin.ModelAdmin.search_help_text)

Set `search_help_text` to specify a descriptive text for the search box
which will be displayed below it.

    ModelAdmin.show_full_result_count[¶](#django.contrib.admin.ModelAdmin.show_full_result_count)
...
large number of rows.
    ...
    ModelAdmin.sortable_by[¶](#django.contrib.admin.ModelAdmin.sortable_by)
...
[get_sortable_by()](#django.contrib.admin.ModelAdmin.get_sortable_by) method instead.
    ...
    ModelAdmin.view_on_site[¶](#django.contrib.admin.ModelAdmin.view_on_site)
...
default), the object’s [get_absolute_url()](https://docs.djangoproject.com/en/5.0/models/instances/#django.db.models.Model.get_absolute_url)
method will be used to generate the url.

If your model has a [get_absolute_url()](https://docs.djangoproject.com/en/5.0/models/instances/#django.db.models.Model.get_absolute_url) method
...
templates used by the [ModelAdmin](#django.contrib.admin.ModelAdmin) views:
   ...
   ModelAdmin.add_form_template[¶](#django.contrib.admin.ModelAdmin.add_form_template)

Path to a custom template, used by [add_view()](#django.contrib.admin.ModelAdmin.add_view).

    ModelAdmin.change_form_template[¶](#django.contrib.admin.ModelAdmin.change_form_template)

Path to a custom template, used by [change_view()](#django.contrib.admin.ModelAdmin.change_view).

    ModelAdmin.change_list_template[¶](#django.contrib.admin.ModelAdmin.change_list_template)

Path to a custom template, used by [changelist_view()](#django.contrib.admin.ModelAdmin.changelist_view).

    ModelAdmin.delete_confirmation_template[¶](#django.contrib.admin.ModelAdmin.delete_confirmation_template)

Path to a custom template, used by [delete_view()](#django.contrib.admin.ModelAdmin.delete_view) for displaying a
confirmation page when deleting one or more objects.

    ModelAdmin.delete_selected_confirmation_template[¶](#django.contrib.admin.ModelAdmin.delete_selected_confirmation_template)
...
the [actions documentation](https://docs.djangoproject.com/en/5.0/ref/contrib/actions/).

    ModelAdmin.object_history_template[¶](#django.contrib.admin.ModelAdmin.object_history_template)

Path to a custom template, used by [history_view()](#django.contrib.admin.ModelAdmin.history_view).

    ModelAdmin.popup_response_template[¶](#django.contrib.admin.ModelAdmin.popup_response_template)
...
perform extra operations.
    ...
    ModelAdmin.save_model(*request*, *obj*, *form*, *change*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.save_model)[¶](#django.contrib.admin.ModelAdmin.save_model)

The `save_model` method is given the `HttpRequest`, a model instance,
a `ModelForm` instance, and a boolean value based on whether it is adding
or changing the object. Overriding this method allows doing pre- or
post-save operations. Call `super().save_model()` to save the object
using [Model.save()](https://docs.djangoproject.com/en/5.0/models/instances/#django.db.models.Model.save).
...
```
     ...
     ModelAdmin.delete_model(*request*, *obj*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.delete_model)[¶](#django.contrib.admin.ModelAdmin.delete_model)

The `delete_model` method is given the `HttpRequest` and a model
instance. Overriding this method allows doing pre- or post-delete
operations. Call `super().delete_model()` to delete the object using
[Model.delete()](https://docs.djangoproject.com/en/5.0/models/instances/#django.db.models.Model.delete).

    ModelAdmin.delete_queryset(*request*, *queryset*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.delete_queryset)[¶](#django.contrib.admin.ModelAdmin.delete_queryset)

The `delete_queryset()` method is given the `HttpRequest` and a
`QuerySet` of objects to be deleted. Override this method to customize
the deletion process for the “delete selected objects” [action](https://docs.djangoproject.com/en/5.0/ref/contrib/actions/).

    ModelAdmin.save_formset(*request*, *form*, *formset*, *change*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.save_formset)[¶](#django.contrib.admin.ModelAdmin.save_formset)
...
See also [Saving objects in the formset](https://docs.djangoproject.com/en/topics/forms/modelforms/#saving-objects-in-the-formset).

    ModelAdmin.get_ordering(*request*)[¶](#django.contrib.admin.ModelAdmin.get_ordering)
...
```
     ...
     ModelAdmin.get_search_results(*request*, *queryset*, *search_term*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_search_results)[¶](#django.contrib.admin.ModelAdmin.get_search_results)
...
on PostgreSQL.
    ...
    ModelAdmin.save_related(*request*, *form*, *formsets*, *change*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.save_related)[¶](#django.contrib.admin.ModelAdmin.save_related)
...
that at this point the parent object and its form have already been saved.
    ...
    ModelAdmin.get_autocomplete_fields(*request*)[¶](#django.contrib.admin.ModelAdmin.get_autocomplete_fields)
...
[ModelAdmin.autocomplete_fields](#django.contrib.admin.ModelAdmin.autocomplete_fields) section.
    ...
    ModelAdmin.get_readonly_fields(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.get_readonly_fields)
...
as described above in the [ModelAdmin.readonly_fields](#django.contrib.admin.ModelAdmin.readonly_fields) section.
    ...
    ModelAdmin.get_prepopulated_fields(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.get_prepopulated_fields)
...
section.
    ...
    ModelAdmin.get_list_display(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_list_display)[¶](#django.contrib.admin.ModelAdmin.get_list_display)
...
[ModelAdmin.list_display](#django.contrib.admin.ModelAdmin.list_display) section.
    ...
    ModelAdmin.get_list_display_links(*request*, *list_display*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_list_display_links)[¶](#django.contrib.admin.ModelAdmin.get_list_display_links)
...
in the [ModelAdmin.list_display_links](#django.contrib.admin.ModelAdmin.list_display_links) section.
    ...
    ModelAdmin.get_exclude(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.get_exclude)
...
of fields, as described in [ModelAdmin.exclude](#django.contrib.admin.ModelAdmin.exclude).
    ...
    ModelAdmin.get_fields(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.get_fields)
...
of fields, as described above in the [ModelAdmin.fields](#django.contrib.admin.ModelAdmin.fields) section.
    ...
    ModelAdmin.get_fieldsets(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.get_fieldsets)
...
admin form page, as described above in the [ModelAdmin.fieldsets](#django.contrib.admin.ModelAdmin.fieldsets) section.
    ...
    ModelAdmin.get_list_filter(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_list_filter)[¶](#django.contrib.admin.ModelAdmin.get_list_filter)

The `get_list_filter` method is given the `HttpRequest` and is expected
to return the same kind of sequence type as for the
[list_filter](#django.contrib.admin.ModelAdmin.list_filter) attribute.

    ModelAdmin.get_list_select_related(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_list_select_related)[¶](#django.contrib.admin.ModelAdmin.get_list_select_related)
...
does.
    ...
    ModelAdmin.get_search_fields(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_search_fields)[¶](#django.contrib.admin.ModelAdmin.get_search_fields)
...
[search_fields](#django.contrib.admin.ModelAdmin.search_fields) attribute.
    ...
    ModelAdmin.get_sortable_by(*request*)[¶](#django.contrib.admin.ModelAdmin.get_sortable_by)
...
```
     ...
     ModelAdmin.get_inline_instances(*request*, *obj=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_inline_instances)[¶](#django.contrib.admin.ModelAdmin.get_inline_instances)
...
a “Bad Request” error when adding related objects.
    ...
    ModelAdmin.get_inlines(*request*, *obj*)[¶](#django.contrib.admin.ModelAdmin.get_inlines)
...
in [ModelAdmin.inlines](#django.contrib.admin.ModelAdmin.inlines).
    ...
    ModelAdmin.get_urls()[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_urls)[¶](#django.contrib.admin.ModelAdmin.get_urls)

The `get_urls` method on a `ModelAdmin` returns the URLs to be used for
that ModelAdmin in the same way as a URLconf.  Therefore you can extend
them as documented in [URL dispatcher](https://docs.djangoproject.com/en/topics/http/urls/), using the
...
1. Permission checks are run, ensuring only active staff users can
  access the view.
2. The [django.views.decorators.cache.never_cache()](https://docs.djangoproject.com/en/topics/http/decorators/#django.views.decorators.cache.never_cache) decorator is
...
`AdminSite` views have `admin_site` attributes.
    ...
    ModelAdmin.get_form(*request*, *obj=None*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_form)[¶](#django.contrib.admin.ModelAdmin.get_form)

Returns a [ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm) class for use in the admin add
...
The base implementation uses [modelform_factory()](https://docs.djangoproject.com/en/5.0/forms/models/#django.forms.models.modelform_factory)
...
You may also return a custom [ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm) class
directly.

    ModelAdmin.get_formsets_with_inlines(*request*, *obj=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_formsets_with_inlines)[¶](#django.contrib.admin.ModelAdmin.get_formsets_with_inlines)
...
```
     ...
     ModelAdmin.formfield_for_foreignkey(*db_field*, *request*, ***kwargs*)[¶](#django.contrib.admin.ModelAdmin.formfield_for_foreignkey)
...
[Fields which handle relationships](https://docs.djangoproject.com/en/5.0/forms/fields/#fields-which-handle-relationships)). For example:
...
```
     ...
     ModelAdmin.formfield_for_manytomany(*db_field*, *request*, ***kwargs*)[¶](#django.contrib.admin.ModelAdmin.formfield_for_manytomany)
...
```
     ...
     ModelAdmin.formfield_for_choice_field(*db_field*, *request*, ***kwargs*)[¶](#django.contrib.admin.ModelAdmin.formfield_for_choice_field)
...
a [ValidationError](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.ValidationError) when the model itself
is validated before saving.

     ModelAdmin.get_changelist(*request*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_changelist)[¶](#django.contrib.admin.ModelAdmin.get_changelist)

Returns the `Changelist` class to be used for listing. By default,
`django.contrib.admin.views.main.ChangeList` is used. By inheriting this
class you can change the behavior of the listing.

    ModelAdmin.get_changelist_form(*request*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_changelist_form)[¶](#django.contrib.admin.ModelAdmin.get_changelist_form)

Returns a [ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.ModelForm) class for use in the `Formset`
...
[ModelAdmin.list_editable](#django.contrib.admin.ModelAdmin.list_editable) attribute. The easiest solution is to
omit the `Meta.model` attribute, since `ModelAdmin` will provide the
correct model to use.

     ModelAdmin.get_changelist_formset(*request*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_changelist_formset)[¶](#django.contrib.admin.ModelAdmin.get_changelist_formset)

Returns a [ModelFormSet](https://docs.djangoproject.com/en/topics/forms/modelforms/#model-formsets) class for use on the
...
```
     ...
     ModelAdmin.lookup_allowed(*lookup*, *value*, *request*)[¶](#django.contrib.admin.ModelAdmin.lookup_allowed)
...
lookups are similar to what’s used in [QuerySet.filter()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.filter) (e.g.
...
(subclass of [SuspiciousOperation](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.SuspiciousOperation)) is raised.
...
[limit_choices_to](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.ForeignKey.limit_choices_to) to function
...
The `request` argument was added.
     ...
     ModelAdmin.has_view_permission(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.has_view_permission)
...
“change” or “view” permission.
    ...
    ModelAdmin.has_add_permission(*request*)[¶](#django.contrib.admin.ModelAdmin.has_add_permission)

Should return `True` if adding an object is permitted, `False`
otherwise.

    ModelAdmin.has_change_permission(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.has_change_permission)
...
not permitted to edit any object of this type).
    ...
    ModelAdmin.has_delete_permission(*request*, *obj=None*)[¶](#django.contrib.admin.ModelAdmin.has_delete_permission)
...
not permitted to delete any object of this type).
    ...
    ModelAdmin.has_module_permission(*request*)[¶](#django.contrib.admin.ModelAdmin.has_module_permission)
...
Uses [User.has_module_perms()](https://docs.djangoproject.com/en/5.0/ref/auth/#django.contrib.auth.models.User.has_module_perms) by default. Overriding
...
[has_delete_permission()](#django.contrib.admin.ModelAdmin.has_delete_permission) should be used for that.
    ...
    ModelAdmin.get_queryset(*request*)[¶](#django.contrib.admin.ModelAdmin.get_queryset)

The `get_queryset` method on a `ModelAdmin` returns a
[QuerySet](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet) of all model instances that
...
```
     ...
     ModelAdmin.message_user(*request*, *message*, *level=messages.INFO*, *extra_tags=''*, *fail_silently=False*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.message_user)[¶](#django.contrib.admin.ModelAdmin.message_user)

Sends a message to the user using the [django.contrib.messages](https://docs.djangoproject.com/en/5.0/ref/messages/#module-django.contrib.messages)
backend.  See the [custom ModelAdmin example](https://docs.djangoproject.com/en/5.0/ref/contrib/actions/#custom-admin-action).

Keyword arguments allow you to change the message level, add extra CSS
tags, or fail silently if the `contrib.messages` framework is not
installed. These keyword arguments match those for
[django.contrib.messages.add_message()](https://docs.djangoproject.com/en/5.0/ref/messages/#django.contrib.messages.add_message), see that function’s
...
passed as a string label in addition to integer/constant.
    ...
    ModelAdmin.get_paginator(*request*, *queryset*, *per_page*, *orphans=0*, *allow_empty_first_page=True*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_paginator)[¶](#django.contrib.admin.ModelAdmin.get_paginator)

Returns an instance of the paginator to use for this view. By default,
instantiates an instance of [paginator](#django.contrib.admin.ModelAdmin.paginator).

    ModelAdmin.response_add(*request*, *obj*, *post_url_continue=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.response_add)[¶](#django.contrib.admin.ModelAdmin.response_add)

Determines the [HttpResponse](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpResponse) for the
...
after the object has been created.
    ...
    ModelAdmin.response_change(*request*, *obj*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.response_change)[¶](#django.contrib.admin.ModelAdmin.response_change)
...
behavior after the object has been changed.
    ...
    ModelAdmin.response_delete(*request*, *obj_display*, *obj_id*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.response_delete)[¶](#django.contrib.admin.ModelAdmin.response_delete)
...
deleted.
    ...
    ModelAdmin.get_formset_kwargs(*request*, *obj*, *inline*, *prefix*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_formset_kwargs)[¶](#django.contrib.admin.ModelAdmin.get_formset_kwargs)
...
You can also use it to set `initial` for formset forms.
    ...
    ModelAdmin.get_changeform_initial_data(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_changeform_initial_data)[¶](#django.contrib.admin.ModelAdmin.get_changeform_initial_data)
...
```
     ...
     ModelAdmin.get_deleted_objects(*objs*, *request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_deleted_objects)[¶](#django.contrib.admin.ModelAdmin.get_deleted_objects)

A hook for customizing the deletion process of the [delete_view()](#django.contrib.admin.ModelAdmin.delete_view) and
the “delete selected” [action](https://docs.djangoproject.com/en/5.0/ref/contrib/actions/).
...
[HttpRequest](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest).
...
template using the [unordered_list](https://docs.djangoproject.com/en/5.0/templates/builtins/#std-templatefilter-unordered_list) filter.

`model_count` is a dictionary mapping each model’s
[verbose_name_plural](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.verbose_name_plural) to the number of
objects that will be deleted.

`perms_needed` is a set of [verbose_name](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.verbose_name)s
...
#### Other methods¶
   ...
   ModelAdmin.add_view(*request*, *form_url=''*, *extra_context=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.add_view)[¶](#django.contrib.admin.ModelAdmin.add_view)

Django view for the model instance addition page. See note below.

    ModelAdmin.change_view(*request*, *object_id*, *form_url=''*, *extra_context=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.change_view)[¶](#django.contrib.admin.ModelAdmin.change_view)

Django view for the model instance editing page. See note below.

    ModelAdmin.changelist_view(*request*, *extra_context=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.changelist_view)[¶](#django.contrib.admin.ModelAdmin.changelist_view)

Django view for the model instances change list/actions page. See note
below.

    ModelAdmin.delete_view(*request*, *object_id*, *extra_context=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.delete_view)[¶](#django.contrib.admin.ModelAdmin.delete_view)

Django view for the model instance(s) deletion confirmation page. See note
below.

    ModelAdmin.history_view(*request*, *object_id*, *extra_context=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.history_view)[¶](#django.contrib.admin.ModelAdmin.history_view)
...
These views return [TemplateResponse](https://docs.djangoproject.com/en/5.0/template-response/#django.template.response.TemplateResponse)
instances which allow you to easily customize the response data before
rendering. For more details, see the [TemplateResponse documentation](https://docs.djangoproject.com/en/5.0/template-response/).

### ModelAdminasset definitions¶
...
The [staticfiles app](https://docs.djangoproject.com/en/5.0/ref/staticfiles/) prepends
[STATIC_URL](https://docs.djangoproject.com/en/5.0/settings/#std-setting-STATIC_URL) (or [MEDIA_URL](https://docs.djangoproject.com/en/5.0/settings/#std-setting-MEDIA_URL) if [STATIC_URL](https://docs.djangoproject.com/en/5.0/settings/#std-setting-STATIC_URL) is
`None`) to any asset paths. The same rules apply as [regular asset
definitions on forms](https://docs.djangoproject.com/en/topics/forms/media/#form-asset-paths).
...
`js=['admin/js/jquery.init.js', …]` when [declaring form media assets](https://docs.djangoproject.com/en/topics/forms/media/#assets-as-a-static-definition).
...
files for the forms and/or formsets. If [DEBUG](https://docs.djangoproject.com/en/5.0/settings/#std-setting-DEBUG) is `True` it will
...
interface reuses [django.forms](https://docs.djangoproject.com/en/5.0/forms/api/#module-django.forms), and the `ModelAdmin` class gives you
...
the [forms](https://docs.djangoproject.com/en/5.0/forms/) documentation on [custom validation](https://docs.djangoproject.com/en/5.0/forms/validation/) and, more specifically, the
[model form validation notes](https://docs.djangoproject.com/en/topics/forms/modelforms/#overriding-modelform-clean-method) for more
information.

## InlineModelAdminobjects¶

   *class*InlineModelAdmin[¶](#django.contrib.admin.InlineModelAdmin)    *class*TabularInline[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#TabularInline)[¶](#django.contrib.admin.TabularInline)    *class*StackedInline[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#StackedInline)[¶](#django.contrib.admin.StackedInline)
...
The `InlineModelAdmin` class adds or customizes:
   ...
   InlineModelAdmin.model[¶](#django.contrib.admin.InlineModelAdmin.model)

The model which the inline is using. This is required.

    InlineModelAdmin.fk_name[¶](#django.contrib.admin.InlineModelAdmin.fk_name)

The name of the foreign key on the model. In most cases this will be dealt
with automatically, but `fk_name` must be specified explicitly if there
are more than one foreign key to the same parent model.

    InlineModelAdmin.formset[¶](#django.contrib.admin.InlineModelAdmin.formset)

This defaults to [BaseInlineFormSet](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.models.BaseInlineFormSet). Using
your own formset can give you many possibilities of customization. Inlines
are built around [model formsets](https://docs.djangoproject.com/en/topics/forms/modelforms/#model-formsets).

    InlineModelAdmin.form[¶](#django.contrib.admin.InlineModelAdmin.form)

The value for `form` defaults to `ModelForm`. This is what is passed
through to [inlineformset_factory()](https://docs.djangoproject.com/en/5.0/forms/models/#django.forms.models.inlineformset_factory) when
...
described in the warning in [Validation on a ModelForm](https://docs.djangoproject.com/en/topics/forms/modelforms/#validation-on-modelform).

    InlineModelAdmin.classes[¶](#django.contrib.admin.InlineModelAdmin.classes)
...
link.
    ...
    InlineModelAdmin.extra[¶](#django.contrib.admin.InlineModelAdmin.extra)

This controls the number of extra forms the formset will display in
addition to the initial forms. Defaults to 3. See the
[formsets documentation](https://docs.djangoproject.com/en/topics/forms/formsets/) for more
information.
...
of extra forms.
    ...
    InlineModelAdmin.max_num[¶](#django.contrib.admin.InlineModelAdmin.max_num)

This controls the maximum number of forms to show in the inline. This
doesn’t directly correlate to the number of objects, but can if the value
is small enough. See [Limiting the number of editable objects](https://docs.djangoproject.com/en/topics/forms/modelforms/#model-formsets-max-num) for more information.

[InlineModelAdmin.get_max_num()](#django.contrib.admin.InlineModelAdmin.get_max_num) also allows you to customize the
maximum number of extra forms.

    InlineModelAdmin.min_num[¶](#django.contrib.admin.InlineModelAdmin.min_num)

This controls the minimum number of forms to show in the inline.
See [modelformset_factory()](https://docs.djangoproject.com/en/5.0/forms/models/#django.forms.models.modelformset_factory) for more information.
...
minimum number of displayed forms.
    ...
    InlineModelAdmin.raw_id_fields[¶](#django.contrib.admin.InlineModelAdmin.raw_id_fields)
...
```
     ...
     InlineModelAdmin.template[¶](#django.contrib.admin.InlineModelAdmin.template)

The template used to render the inline on the page.

    InlineModelAdmin.verbose_name[¶](#django.contrib.admin.InlineModelAdmin.verbose_name)

An override to the [verbose_name](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.verbose_name) from the
model’s inner `Meta` class.

    InlineModelAdmin.verbose_name_plural[¶](#django.contrib.admin.InlineModelAdmin.verbose_name_plural)

An override to the [verbose_name_plural](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.verbose_name_plural)
...
[InlineModelAdmin.verbose_name](#django.contrib.admin.InlineModelAdmin.verbose_name) + `'s'`.
    ...
    InlineModelAdmin.can_delete[¶](#django.contrib.admin.InlineModelAdmin.can_delete)

Specifies whether or not inline objects can be deleted in the inline.
Defaults to `True`.

    InlineModelAdmin.show_change_link[¶](#django.contrib.admin.InlineModelAdmin.show_change_link)

Specifies whether or not inline objects that can be changed in the
admin have a link to the change form. Defaults to `False`.

    InlineModelAdmin.get_formset(*request*, *obj=None*, ***kwargs*)[¶](#django.contrib.admin.InlineModelAdmin.get_formset)

Returns a [BaseInlineFormSet](https://docs.djangoproject.com/en/topics/forms/modelforms/#django.forms.models.BaseInlineFormSet) class for use in
admin add/change views. `obj` is the parent object being edited or
`None` when adding a new parent. See the example for
[ModelAdmin.get_formsets_with_inlines](#django.contrib.admin.ModelAdmin.get_formsets_with_inlines).

    InlineModelAdmin.get_extra(*request*, *obj=None*, ***kwargs*)[¶](#django.contrib.admin.InlineModelAdmin.get_extra)
...
```
     ...
     InlineModelAdmin.get_max_num(*request*, *obj=None*, ***kwargs*)[¶](#django.contrib.admin.InlineModelAdmin.get_max_num)
...
```
     ...
     InlineModelAdmin.get_min_num(*request*, *obj=None*, ***kwargs*)[¶](#django.contrib.admin.InlineModelAdmin.get_min_num)
...
(passed as the keyword argument `obj`).
    ...
    InlineModelAdmin.has_add_permission(*request*, *obj*)[¶](#django.contrib.admin.InlineModelAdmin.has_add_permission)
...
adding a new parent.
    ...
    InlineModelAdmin.has_change_permission(*request*, *obj=None*)[¶](#django.contrib.admin.InlineModelAdmin.has_change_permission)

Should return `True` if editing an inline object is permitted, `False`
otherwise. `obj` is the parent object being edited.

    InlineModelAdmin.has_delete_permission(*request*, *obj=None*)[¶](#django.contrib.admin.InlineModelAdmin.has_delete_permission)
...
[ManyToManyField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.ManyToManyField). Depending on your `ModelAdmin`
...
[m2m_changed](https://docs.djangoproject.com/en/5.0/signals/#django.db.models.signals.m2m_changed) signals aren’t triggered. This
...
[ManyToManyField](https://docs.djangoproject.com/en/5.0/models/fields/#django.db.models.ManyToManyField), the admin will not display a
...
[GenericTabularInline](https://docs.djangoproject.com/en/5.0/ref/contenttypes/#django.contrib.contenttypes.admin.GenericTabularInline)
or [GenericStackedInline](https://docs.djangoproject.com/en/5.0/ref/contenttypes/#django.contrib.contenttypes.admin.GenericStackedInline) (both
subclasses of [GenericInlineModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contenttypes/#django.contrib.contenttypes.admin.GenericInlineModelAdmin))
provided by [admin](https://docs.djangoproject.com/en/5.0/ref/contenttypes/#module-django.contrib.contenttypes.admin). They implement tabular
...
See the [contenttypes documentation](https://docs.djangoproject.com/en/5.0/ref/contenttypes/) for more
...
you specified in the [DIRS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-TEMPLATES-DIRS) option of the
`DjangoTemplates` backend in the [TEMPLATES](https://docs.djangoproject.com/en/5.0/settings/#std-setting-TEMPLATES) setting. If you have
...
## AdminSiteobjects¶
   ...
   *class*AdminSite(*name='admin'*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite)[¶](#django.contrib.admin.AdminSite)
...
[AdminSite](#django.contrib.admin.AdminSite) class.
    ...
    django.contrib.admin.sites.all_sites[¶](#django.contrib.admin.django.contrib.admin.sites.all_sites)
...
[Overriding admin templates](#admin-overriding-templates).
   ...
   AdminSite.site_header[¶](#django.contrib.admin.AdminSite.site_header)
...
In older versions, `site_header` was using an `<h1>` tag.
     ...
     AdminSite.site_title[¶](#django.contrib.admin.AdminSite.site_title)

The text to put at the end of each admin page’s `<title>` (a string). By
default, this is “Django site admin”.

    AdminSite.site_url[¶](#django.contrib.admin.AdminSite.site_url)
...
value if `site_url` isn’t set to something other than `/`.
    ...
    AdminSite.index_title[¶](#django.contrib.admin.AdminSite.index_title)

The text to put at the top of the admin index page (a string). By default,
this is “Site administration”.

    AdminSite.index_template[¶](#django.contrib.admin.AdminSite.index_template)

Path to a custom template that will be used by the admin site main index
view.

    AdminSite.app_index_template[¶](#django.contrib.admin.AdminSite.app_index_template)

Path to a custom template that will be used by the admin site app index view.

    AdminSite.empty_value_display[¶](#django.contrib.admin.AdminSite.empty_value_display)
...
[ModelAdmin.empty_value_display](#django.contrib.admin.ModelAdmin.empty_value_display) for examples.
    ...
    AdminSite.enable_nav_sidebar[¶](#django.contrib.admin.AdminSite.enable_nav_sidebar)

A boolean value that determines whether to show the navigation sidebar
on larger screens. By default, it is set to `True`.

    AdminSite.final_catch_all_view[¶](#django.contrib.admin.AdminSite.final_catch_all_view)
...
against a potential model enumeration privacy issue.
     ...
     AdminSite.login_template[¶](#django.contrib.admin.AdminSite.login_template)

Path to a custom template that will be used by the admin site login view.

    AdminSite.login_form[¶](#django.contrib.admin.AdminSite.login_form)

Subclass of [AuthenticationForm](https://docs.djangoproject.com/en/topics/auth/default/#django.contrib.auth.forms.AuthenticationForm) that
will be used by the admin site login view.

    AdminSite.logout_template[¶](#django.contrib.admin.AdminSite.logout_template)

Path to a custom template that will be used by the admin site logout view.

    AdminSite.password_change_template[¶](#django.contrib.admin.AdminSite.password_change_template)

Path to a custom template that will be used by the admin site password
change view.

    AdminSite.password_change_done_template[¶](#django.contrib.admin.AdminSite.password_change_done_template)
...
### AdminSitemethods¶
   ...
   AdminSite.each_context(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.each_context)[¶](#django.contrib.admin.AdminSite.each_context)
...
- `available_apps`: a list of applications from the [application registry](https://docs.djangoproject.com/en/5.0/applications/) available for the current user. Each entry in the
...
- `log_entries`: [AdminSite.get_log_entries()](#django.contrib.admin.AdminSite.get_log_entries)
    ...
    AdminSite.get_app_list(*request*, *app_label=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.get_app_list)[¶](#django.contrib.admin.AdminSite.get_app_list)

Returns a list of applications from the [application registry](https://docs.djangoproject.com/en/5.0/applications/) available for the current user. You can optionally
...
page.
    ...
    AdminSite.has_permission(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.has_permission)[¶](#django.contrib.admin.AdminSite.has_permission)
...
[User.is_active](https://docs.djangoproject.com/en/5.0/ref/auth/#django.contrib.auth.models.User.is_active) and
[User.is_staff](https://docs.djangoproject.com/en/5.0/ref/auth/#django.contrib.auth.models.User.is_staff) to be
`True`.

    AdminSite.register(*model_or_iterable*, *admin_class=None*, ***options*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.register)[¶](#django.contrib.admin.AdminSite.register)
...
Raises [ImproperlyConfigured](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.ImproperlyConfigured) if a model is
abstract. and `django.contrib.admin.exceptions.AlreadyRegistered` if a
model is already registered.

    AdminSite.unregister(*model_or_iterable*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.unregister)[¶](#django.contrib.admin.AdminSite.unregister)
...
already registered.
    ...
    AdminSite.get_model_admin(*model*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.get_model_admin)[¶](#django.contrib.admin.AdminSite.get_model_admin)  New in Django 5.0.
...
`django.contrib.admin.exceptions.NotRegistered` if a model isn’t registered.
    ...
    AdminSite.get_log_entries(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.get_log_entries)[¶](#django.contrib.admin.AdminSite.get_log_entries)  New in Django 5.0.
...
[include()](https://docs.djangoproject.com/en/5.0/urls/#django.urls.include).
...
## LogEntryobjects¶
   ...
   *class*models.LogEntry[¶](#django.contrib.admin.models.LogEntry)
...
### LogEntryattributes¶
   ...
   LogEntry.action_time[¶](#django.contrib.admin.models.LogEntry.action_time)

The date and time of the action.

    LogEntry.user[¶](#django.contrib.admin.models.LogEntry.user)

The user (an [AUTH_USER_MODEL](https://docs.djangoproject.com/en/5.0/settings/#std-setting-AUTH_USER_MODEL) instance) who performed the
action.

    LogEntry.content_type[¶](#django.contrib.admin.models.LogEntry.content_type)

The [ContentType](https://docs.djangoproject.com/en/5.0/ref/contenttypes/#django.contrib.contenttypes.models.ContentType) of the
modified object.

    LogEntry.object_id[¶](#django.contrib.admin.models.LogEntry.object_id)

The textual representation of the modified object’s primary key.

    LogEntry.object_repr[¶](#django.contrib.admin.models.LogEntry.object_repr)

The object`s `repr()` after the modification.

    LogEntry.action_flag[¶](#django.contrib.admin.models.LogEntry.action_flag)
...
```
     ...
     LogEntry.change_message[¶](#django.contrib.admin.models.LogEntry.change_message)
...
[get_change_message()](#django.contrib.admin.models.LogEntry.get_change_message) can recompose a message translated in the current
user language. Custom code might set this as a plain string though. You are
advised to use the [get_change_message()](#django.contrib.admin.models.LogEntry.get_change_message) method to retrieve this value
instead of accessing it directly.

### LogEntrymethods¶

   LogEntry.get_edited_object()[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/models/#LogEntry.get_edited_object)[¶](#django.contrib.admin.models.LogEntry.get_edited_object)

A shortcut that returns the referenced object.

    LogEntry.get_change_message()[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/models/#LogEntry.get_change_message)[¶](#django.contrib.admin.models.LogEntry.get_change_message)
...
accessible using Django’s [URL reversing system](https://docs.djangoproject.com/en/topics/http/urls/#naming-url-patterns).
...
For more details, see the documentation on [reversing namespaced URLs](https://docs.djangoproject.com/en/topics/http/urls/#topics-http-reversing-url-namespaces).
...
## Thedisplaydecorator¶
   ...
   display(***, *boolean=None*, *ordering=None*, *description=None*, *empty_value=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/decorators/#display)[¶](#django.contrib.admin.display)
...
## Thestaff_member_requireddecorator¶

   staff_member_required(*redirect_field_name='next'*, *login_url='admin:login'*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/views/decorators/#staff_member_required)[¶](#django.contrib.admin.views.decorators.staff_member_required)
