...
[django.contrib.auth](https://docs.djangoproject.com/en/topics/auth/#module-django.contrib.auth) app:

 ![../../../../_images/admin-actions.png](https://docs.djangoproject.com/en/_images/admin-actions.png)

Warning

The “delete selected objects” action uses [QuerySet.delete()](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet.delete) for efficiency reasons, which
has an important caveat: your model’s `delete()` method will not be
called.

If you wish to override this behavior, you can override
[ModelAdmin.delete_queryset()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.delete_queryset) or write a custom action which does
...
deletion](https://docs.djangoproject.com/en/topics/db/queries/#topics-db-queries-delete).
...
- The current [ModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin)
- An [HttpRequest](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpRequest) representing the current request,
- A [QuerySet](https://docs.djangoproject.com/en/5.0/models/querysets/#django.db.models.query.QuerySet) containing the set of
  objects selected by the user.

Our publish-these-articles function won’t need the [ModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin) or the
...
For the best performance, we’re using the queryset’s [update method](https://docs.djangoproject.com/en/topics/db/queries/#topics-db-queries-update). Other types of actions might need to deal
...
[list_display](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.list_display) option uses a similar
technique with the [display()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.display) decorator to
provide human-readable descriptions for callback functions registered
there, too.

### Adding actions to theModelAdmin¶

Next, we’ll need to inform our [ModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin) of the action. This works
...
That code will give us an admin change list that looks something like this:
 ...
 ![../../../../_images/adding-actions-to-the-modeladmin.png](https://docs.djangoproject.com/en/_images/adding-actions-to-the-modeladmin.png)
...
[django.contrib.admin.ModelAdmin.message_user()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.message_user) to display a user friendly
...
tells the [ModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin) to look up the action as a method.

Defining actions as methods gives the action more idiomatic access to the
[ModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin) itself, allowing the action to call any of the methods
...
performing an action:
 ...
 ![../../../../_images/actions-as-modeladmin-methods.png](https://docs.djangoproject.com/en/_images/actions-as-modeladmin-methods.png)
...
To provide an intermediary page, return an [HttpResponse](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpResponse)
(or subclass) from your action. For example, you might write an export function
that uses Django’s [serialization functions](https://docs.djangoproject.com/en/topics/serialization/) to
...
[HttpResponseRedirect](https://docs.djangoproject.com/en/5.0/request-response/#django.http.HttpResponseRedirect) and redirect the user to a view
...
### Making actions available site-wide¶
   ...
   AdminSite.add_action(*action*, *name=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.add_action)[¶](#django.contrib.admin.AdminSite.add_action)
...
#### Disabling a site-wide action¶
   ...
   AdminSite.disable_action(*name*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/sites/#AdminSite.disable_action)[¶](#django.contrib.admin.AdminSite.disable_action)
...
#### Disabling all actions for a particularModelAdmin¶

If you want *no* bulk actions available for a given [ModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin), set
[ModelAdmin.actions](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.actions) to `None`:
...
This tells the [ModelAdmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin) to not display or allow any actions,
including any [site-wide actions](#adminsite-actions).

#### Conditionally enabling or disabling actions¶

   ModelAdmin.get_actions(*request*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/options/#ModelAdmin.get_actions)[¶](#django.contrib.admin.ModelAdmin.get_actions)
...
[ModelAdmin.has_change_permission()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.has_change_permission) check.
...
- `'add'`: [ModelAdmin.has_add_permission()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.has_add_permission)
- `'change'`: [ModelAdmin.has_change_permission()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.has_change_permission)
- `'delete'`: [ModelAdmin.has_delete_permission()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.has_delete_permission)
- `'view'`: [ModelAdmin.has_view_permission()](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.has_view_permission)
...
## Theactiondecorator¶
   ...
   action(***, *permissions=None*, *description=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/contrib/admin/decorators/#action)[¶](#django.contrib.admin.action)

This decorator can be used for setting specific attributes on custom action
functions that can be used with
[actions](https://docs.djangoproject.com/en/5.0/ref/contrib/#django.contrib.admin.ModelAdmin.actions):
...
respectively, by the model’s [verbose_name](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.verbose_name)
and [verbose_name_plural](https://docs.djangoproject.com/en/5.0/models/options/#django.db.models.Options.verbose_name_plural).
...
[INSTALLED_APPS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-INSTALLED_APPS) and makes that documentation available from the
[Djangoadmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#module-django.contrib.admin).
...
- Add [django.contrib.admindocs](#module-django.contrib.admindocs) to your [INSTALLED_APPS](https://docs.djangoproject.com/en/5.0/settings/#std-setting-INSTALLED_APPS).
...
filters that come with Django (in fact, the [built-in tag reference](https://docs.djangoproject.com/en/5.0/templates/builtins/#ref-templates-builtins-tags) and [built-in filter reference](https://docs.djangoproject.com/en/5.0/templates/builtins/#ref-templates-builtins-filters) documentation come directly from those
...
Django’s [template loaders](https://docs.djangoproject.com/en/5.0/templates/api/#template-loaders). This can be a handy way to
...
you are logged into the [Djangoadmin](https://docs.djangoproject.com/en/5.0/ref/contrib/#module-django.contrib.admin) as a
[User](https://docs.djangoproject.com/en/5.0/ref/auth/#django.contrib.auth.models.User) with
[is_staff](https://docs.djangoproject.com/en/5.0/ref/auth/#django.contrib.auth.models.User.is_staff) set to `True`.
