...
- Use [RequestFactory](https://docs.djangoproject.com/en/5.0/topics/advanced/#django.test.RequestFactory) to test view functions directly,
...
- To resolve URLs, the test client uses whatever URLconf is pointed-to by
  your [ROOT_URLCONF](https://docs.djangoproject.com/en/ref/settings/#std-setting-ROOT_URLCONF) setting.
...
Use the `django.test.Client` class to make requests.
   ...
   *class*Client(*enforce_csrf_checks=False*, *raise_request_exception=True*, *json_encoder=DjangoJSONEncoder*, ***, *headers=None*, ***defaults*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client)[¶](#django.test.Client)
...
The `headers` parameter was added.
    ...
    get(*path*, *data=None*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.get)[¶](#django.test.Client.get)
...
[django.http.HttpRequest.accepts()](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpRequest.accepts) method.
...
The `headers` parameter was added.
     ...
     post(*path*, *data=None*, *content_type=MULTIPART_CONTENT*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.post)[¶](#django.test.Client.post)
...
[DjangoJSONEncoder](https://docs.djangoproject.com/en/5.0/serialization/#django.core.serializers.json.DjangoJSONEncoder) by default,
...
[FileField](https://docs.djangoproject.com/en/ref/forms/fields/#django.forms.FileField):
...
[ImageField](https://docs.djangoproject.com/en/ref/models/fields/#django.db.models.ImageField), the object needs a `name`
attribute that passes the
[validate_image_file_extension](https://docs.djangoproject.com/en/ref/validators/#django.core.validators.validate_image_file_extension) validator.
For example:
...
The `headers` parameter was added.
     ...
     head(*path*, *data=None*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.head)[¶](#django.test.Client.head)
...
The `headers` parameter was added.
     ...
     options(*path*, *data=''*, *content_type='application/octet-stream'*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.options)[¶](#django.test.Client.options)
...
the same as for [Client.get()](#django.test.Client.get).

  Changed in Django 4.2:

The `headers` parameter was added.

     put(*path*, *data=''*, *content_type='application/octet-stream'*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.put)[¶](#django.test.Client.put)
...
The `headers` parameter was added.
     ...
     patch(*path*, *data=''*, *content_type='application/octet-stream'*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.patch)[¶](#django.test.Client.patch)
...
The `headers` parameter was added.
     ...
     delete(*path*, *data=''*, *content_type='application/octet-stream'*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.delete)[¶](#django.test.Client.delete)
...
The `headers` parameter was added.
     ...
     trace(*path*, *follow=False*, *secure=False*, ***, *headers=None*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#Client.trace)[¶](#django.test.Client.trace)
...
The `headers` parameter was added.
     ...
     login(***credentials*)[¶](#django.test.Client.login)    alogin(***credentials*)[¶](#django.test.Client.alogin)

*Asynchronous version*: `alogin()`

If your site uses Django’s [authentication system](https://docs.djangoproject.com/en/5.0/auth/)
...
[authentication backend](https://docs.djangoproject.com/en/5.0/auth/customizing/#authentication-backends) you’re using
(which is configured by your [AUTHENTICATION_BACKENDS](https://docs.djangoproject.com/en/ref/settings/#std-setting-AUTHENTICATION_BACKENDS)
...
[set_password()](https://docs.djangoproject.com/en/ref/contrib/auth/#django.contrib.auth.models.User.set_password) function to
store a correctly hashed password. Alternatively, you can use the
[create_user()](https://docs.djangoproject.com/en/ref/contrib/auth/#django.contrib.auth.models.UserManager.create_user) helper
...
`alogin()` method was added.
     ...
     force_login(*user*, *backend=None*)[¶](#django.test.Client.force_login)    aforce_login(*user*, *backend=None*)[¶](#django.test.Client.aforce_login)

*Asynchronous version*: `aforce_login()`

If your site uses Django’s [authentication
system](https://docs.djangoproject.com/en/5.0/auth/), you can use the `force_login()` method
...
verification steps: inactive users ([is_active=False](https://docs.djangoproject.com/en/ref/contrib/auth/#django.contrib.auth.models.User.is_active)) are permitted to login
...
The [authenticate()](https://docs.djangoproject.com/en/5.0/auth/default/#django.contrib.auth.authenticate) function called by
...
`login()` by [using a weaker hasher while testing](https://docs.djangoproject.com/en/5.0/topics/overview/#speeding-up-tests-auth-hashers).

  Changed in Django 5.0:

`aforce_login()` method was added.

     logout()[¶](#django.test.Client.logout)    alogout()[¶](#django.test.Client.alogout)
...
to come from an [AnonymousUser](https://docs.djangoproject.com/en/ref/contrib/auth/#django.contrib.auth.models.AnonymousUser).
...
Specifically, a `Response` object has the following attributes:
   ...
   *class*Response[¶](#django.test.Response)   client[¶](#django.test.Response.client)

The test client that was used to make the request that resulted in the
response.

    content[¶](#django.test.Response.content)

The body of the response, as a bytestring. This is the final page
content as rendered by the view, or any error message.

    context[¶](#django.test.Response.context)
...
[DjangoTemplates](https://docs.djangoproject.com/en/5.0/templates/#django.template.backends.django.DjangoTemplates) backend.
If you’re using another template engine,
[context_data](https://docs.djangoproject.com/en/ref/template-response/#django.template.response.SimpleTemplateResponse.context_data)
may be a suitable alternative on responses with that attribute.

     exc_info[¶](#django.test.Response.exc_info)
...
If no exception occurred, then `exc_info` will be `None`.
    ...
    json(***kwargs*)[¶](#django.test.Response.json)
...
[ValueError](https://docs.python.org/3/library/exceptions.html#ValueError) will be raised when trying to parse the response.
    ...
    request[¶](#django.test.Response.request)

The request data that stimulated the response.

    wsgi_request[¶](#django.test.Response.wsgi_request)

The `WSGIRequest` instance generated by the test handler that
generated the response.

    status_code[¶](#django.test.Response.status_code)
...
of defined codes, see the [IANA status code registry](https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml).
    ...
    templates[¶](#django.test.Response.templates)
...
[DjangoTemplates](https://docs.djangoproject.com/en/5.0/templates/#django.template.backends.django.DjangoTemplates) backend.
If you’re using another template engine,
[template_name](https://docs.djangoproject.com/en/ref/template-response/#django.template.response.SimpleTemplateResponse.template_name)
may be a suitable alternative if you only need the name of the
template used for rendering.

     resolver_match[¶](#django.test.Response.resolver_match)

An instance of [ResolverMatch](https://docs.djangoproject.com/en/ref/urlresolvers/#django.urls.ResolverMatch) for the response.
You can use the [func](https://docs.djangoproject.com/en/ref/urlresolvers/#django.urls.ResolverMatch.func) attribute, for
...
[Resolver404](https://docs.djangoproject.com/en/ref/exceptions/#django.urls.Resolver404) exception.

As with a normal response, you can also access the headers through
[HttpResponse.headers](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse.headers). For example, you could determine the content
...
[Http404](https://docs.djangoproject.com/en/5.0/http/views/#django.http.Http404),
[PermissionDenied](https://docs.djangoproject.com/en/ref/exceptions/#django.core.exceptions.PermissionDenied), [SystemExit](https://docs.python.org/3/library/exceptions.html#SystemExit), and
[SuspiciousOperation](https://docs.djangoproject.com/en/ref/exceptions/#django.core.exceptions.SuspiciousOperation). Django catches these
...
access these properties as part of a test condition.
   ...
   Client.cookies[¶](#django.test.Client.cookies)
...
[http.cookies](https://docs.python.org/3/library/http.cookies.html#module-http.cookies) module for more.
    ...
    Client.session[¶](#django.test.Client.session)

A dictionary-like object containing session information. See the
[session documentation](https://docs.djangoproject.com/en/5.0/http/sessions/) for full details.
...
```
     ...
     Client.asession()[¶](#django.test.Client.asession)  New in Django 5.0.
...
[LocaleMiddleware](https://docs.djangoproject.com/en/ref/middleware/#django.middleware.locale.LocaleMiddleware) is enabled.

If the middleware is enabled, the language can be set by creating a cookie with
a name of [LANGUAGE_COOKIE_NAME](https://docs.djangoproject.com/en/ref/settings/#std-setting-LANGUAGE_COOKIE_NAME) and a value of the language code:
...
More details are in [How Django discovers language preference](https://docs.djangoproject.com/en/5.0/i18n/translation/#how-django-discovers-language-preference).

If the middleware isn’t enabled, the active language may be set using
[translation.override()](https://docs.djangoproject.com/en/ref/utils/#django.utils.translation.override):
...
More details are in [Explicitly setting the active language](https://docs.djangoproject.com/en/5.0/i18n/translation/#explicitly-setting-the-active-language).
...
[django.test.RequestFactory](https://docs.djangoproject.com/en/5.0/topics/advanced/#django.test.RequestFactory)
...
Hierarchy of Django unit testing classes[¶](#id4)
...
### SimpleTestCase¶
   ...
   *class*SimpleTestCase[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase)[¶](#django.test.SimpleTestCase)
...
- Some useful assertions like:
  - Checking that a callable [raisesacertainexception](#django.test.SimpleTestCase.assertRaisesMessage).
  - Checking that a callable [triggersacertainwarning](#django.test.SimpleTestCase.assertWarnsMessage).
  - Testing form field [renderinganderrortreatment](#django.test.SimpleTestCase.assertFieldOutput).
  - Testing [HTMLresponsesforthepresence/lackofagivenfragment](#django.test.SimpleTestCase.assertContains).
  - Verifying that a template [has/hasn'tbeenusedtogenerateagivenresponsecontent](#django.test.SimpleTestCase.assertTemplateUsed).
  ...
  - Robustly testing two [HTMLfragments](#django.test.SimpleTestCase.assertHTMLEqual)
    for equality/inequality or [containment](#django.test.SimpleTestCase.assertInHTML).
  - Robustly testing two [XMLfragments](#django.test.SimpleTestCase.assertXMLEqual)
    for equality/inequality.
  - Robustly testing two [JSONfragments](#django.test.SimpleTestCase.assertJSONEqual)
    for equality.
...
[TransactionTestCase](#django.test.TransactionTestCase) or [TestCase](#django.test.TestCase).
   ...
   SimpleTestCase.databases[¶](#django.test.SimpleTestCase.databases)
...
### TransactionTestCase¶
   ...
   *class*TransactionTestCase[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#TransactionTestCase)[¶](#django.test.TransactionTestCase)
...
required when using
[select_for_update()](https://docs.djangoproject.com/en/ref/models/querysets/#django.db.models.query.QuerySet.select_for_update). In those cases,
...
Apps [will not see their data reloaded](https://docs.djangoproject.com/en/5.0/topics/overview/#test-case-serialized-rollback);
...
### TestCase¶
   ...
   *class*TestCase[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#TestCase)[¶](#django.test.TestCase)
...
- Wraps the tests within two nested [atomic()](https://docs.djangoproject.com/en/5.0/db/transactions/#django.db.transaction.atomic)
...
It also provides an additional method:
   ...
   *classmethod*TestCase.setUpTestData()[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#TestCase.setUpTestData)[¶](#django.test.TestCase.setUpTestData)
...
from alterations performed by each test methods.
    ...
    *classmethod*TestCase.captureOnCommitCallbacks(*using=DEFAULT_DB_ALIAS*, *execute=False*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#TestCase.captureOnCommitCallbacks)[¶](#django.test.TestCase.captureOnCommitCallbacks)

Returns a context manager that captures [transaction.on_commit()](https://docs.djangoproject.com/en/5.0/db/transactions/#django.db.transaction.on_commit) callbacks for the given database
...
### LiveServerTestCase¶
   ...
   *class*LiveServerTestCase[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#LiveServerTestCase)[¶](#django.test.LiveServerTestCase)
...
the [staticfiles](https://docs.djangoproject.com/en/ref/contrib/staticfiles/#module-django.contrib.staticfiles) app and want to have static files served
during the execution of your tests similar to what we get at development time
with `DEBUG=True`, i.e. without having to collect them using
[collectstatic](https://docs.djangoproject.com/en/ref/contrib/staticfiles/#django-admin-collectstatic). We’ll use
the  [StaticLiveServerTestCase](https://docs.djangoproject.com/en/ref/contrib/staticfiles/#django.contrib.staticfiles.testing.StaticLiveServerTestCase)
...
### Default test client¶
   ...
   SimpleTestCase.client[¶](#django.test.SimpleTestCase.client)
...
### Customizing the test client¶
   ...
   SimpleTestCase.client_class[¶](#django.test.SimpleTestCase.client_class)
...
### Fixture loading¶
   ...
   TransactionTestCase.fixtures[¶](#django.test.TransactionTestCase.fixtures)
...
however, you can also use [fixtures](https://docs.djangoproject.com/en/5.0/db/fixtures/#fixtures-explanation).
...
[manage.pydumpdata](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-dumpdata) command. This assumes you
already have some data in your database. See the [dumpdatadocumentation](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-dumpdata) for more details.

Once you’ve created a fixture and placed it in a `fixtures` directory in one
of your [INSTALLED_APPS](https://docs.djangoproject.com/en/ref/settings/#std-setting-INSTALLED_APPS), you can use it in your unit tests by
...
- At the start of each test, before `setUp()` is run, Django will flush the
  ...
  [migrate](https://docs.djangoproject.com/en/ref/django-admin/#django-admin-migrate) was called.
- Then, all the named fixtures are installed. In this example, Django will
  install any JSON fixture named `mammals`, followed by any fixture named
  `birds`. See the [Fixtures](https://docs.djangoproject.com/en/5.0/db/fixtures/#fixtures-explanation) topic for more details on
...
### Multi-database support¶
   ...
   TransactionTestCase.databases[¶](#django.test.TransactionTestCase.databases)

Django sets up a test database corresponding to every database that is
defined in the [DATABASES](https://docs.djangoproject.com/en/ref/settings/#std-setting-DATABASES) definition in your settings and referred to
...
prevent state leaking between tests.
   ...
   TestCase.databases[¶](#django.test.TestCase.databases)
...
the original values after such manipulations.
    ...
    SimpleTestCase.settings()[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.settings)[¶](#django.test.SimpleTestCase.settings)
...
This example will override the [LOGIN_URL](https://docs.djangoproject.com/en/ref/settings/#std-setting-LOGIN_URL) setting for the code
in the `with` block and reset its value to the previous state afterward.

   SimpleTestCase.modify_settings()[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.modify_settings)[¶](#django.test.SimpleTestCase.modify_settings)
...
neither does `remove` when the value doesn’t exist.
   ...
   override_settings(***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/utils/#override_settings)[¶](#django.test.override_settings)
...
```
    ...
    modify_settings(**args*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/utils/#modify_settings)[¶](#django.test.modify_settings)
...
We do not recommend altering the [DATABASES](https://docs.djangoproject.com/en/ref/settings/#std-setting-DATABASES) setting. Altering
the [CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES) setting is possible, but a bit tricky if you are
using internals that make using of caching, like
[django.contrib.sessions](https://docs.djangoproject.com/en/5.0/http/sessions/#module-django.contrib.sessions). For example, you will have to reinitialize
the session backend in a test that uses cached sessions and overrides
[CACHES](https://docs.djangoproject.com/en/ref/settings/#std-setting-CACHES).
...
changed. Django provides the [django.test.signals.setting_changed](https://docs.djangoproject.com/en/ref/signals/#django.test.signals.setting_changed)
...
### Isolating apps¶
   ...
   utils.isolate_apps(**app_labels*, *attr_name=None*, *kwarg_name=None*)[¶](#django.test.utils.isolate_apps)

Registers the models defined within a wrapped context into their own
isolated [apps](https://docs.djangoproject.com/en/ref/applications/#django.apps.apps) registry. This functionality is useful
...
your test suite.
   ...
   SimpleTestCase.assertRaisesMessage(*expected_exception*, *expected_message*, *callable*, **args*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertRaisesMessage)[¶](#django.test.SimpleTestCase.assertRaisesMessage)  SimpleTestCase.assertRaisesMessage(*expected_exception*, *expected_message*)
...
```
     ...
     SimpleTestCase.assertWarnsMessage(*expected_warning*, *expected_message*, *callable*, **args*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertWarnsMessage)[¶](#django.test.SimpleTestCase.assertWarnsMessage)  SimpleTestCase.assertWarnsMessage(*expected_warning*, *expected_message*)
...
[assertRaisesRegex()](https://docs.python.org/3/library/unittest.html#unittest.TestCase.assertRaisesRegex).
    ...
    SimpleTestCase.assertFieldOutput(*fieldclass*, *valid*, *invalid*, *field_args=None*, *field_kwargs=None*, *empty_value=''*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertFieldOutput)[¶](#django.test.SimpleTestCase.assertFieldOutput)
...
```
     ...
     SimpleTestCase.assertFormError(*form*, *field*, *errors*, *msg_prefix=''*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertFormError)[¶](#django.test.SimpleTestCase.assertFormError)

Asserts that a field on a form raises the provided list of errors.

`form` is a `Form` instance. The form must be
[bound](https://docs.djangoproject.com/en/ref/forms/api/#ref-forms-api-bound-unbound) but not necessarily
...
[non-fielderrors](https://docs.djangoproject.com/en/ref/forms/api/#django.forms.Form.non_field_errors), use
`field=None`.
...
`errors=['error message']`.
    ...
    SimpleTestCase.assertFormSetError(*formset*, *form_index*, *field*, *errors*, *msg_prefix=''*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertFormSetError)[¶](#django.test.SimpleTestCase.assertFormSetError)
...
Deprecated since version 4.2: The `assertFormsetError()` assertion method is deprecated. Use
`assertFormSetError()` instead.

     SimpleTestCase.assertContains(*response*, *text*, *count=None*, *status_code=200*, *msg_prefix=''*, *html=False*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertContains)[¶](#django.test.SimpleTestCase.assertContains)

Asserts that a [response](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse) produced the
given [status_code](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse.status_code) and that `text`
appears in its [content](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse.content). If `count`
...
[assertHTMLEqual()](#django.test.SimpleTestCase.assertHTMLEqual) for more details.
    ...
    SimpleTestCase.assertNotContains(*response*, *text*, *status_code=200*, *msg_prefix=''*, *html=False*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertNotContains)[¶](#django.test.SimpleTestCase.assertNotContains)

Asserts that a [response](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse) produced the
given [status_code](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse.status_code) and that `text` does
*not* appear in its [content](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse.content).
...
[assertHTMLEqual()](#django.test.SimpleTestCase.assertHTMLEqual) for more details.
    ...
    SimpleTestCase.assertTemplateUsed(*response*, *template_name*, *msg_prefix=''*, *count=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertTemplateUsed)[¶](#django.test.SimpleTestCase.assertTemplateUsed)

Asserts that the template with the given name was used in rendering the
response.

`response` must be a response instance returned by the
[testclient](#django.test.Response).
...
```
     ...
     SimpleTestCase.assertTemplateNotUsed(*response*, *template_name*, *msg_prefix=''*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertTemplateNotUsed)[¶](#django.test.SimpleTestCase.assertTemplateNotUsed)
...
[assertTemplateUsed()](#django.test.SimpleTestCase.assertTemplateUsed).
    ...
    SimpleTestCase.assertURLEqual(*url1*, *url2*, *msg_prefix=''*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertURLEqual)[¶](#django.test.SimpleTestCase.assertURLEqual)
...
`/path/?a=1&a=2` isn’t equal to `/path/?a=2&a=1`.
    ...
    SimpleTestCase.assertRedirects(*response*, *expected_url*, *status_code=302*, *target_status_code=200*, *msg_prefix=''*, *fetch_redirect_response=True*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertRedirects)[¶](#django.test.SimpleTestCase.assertRedirects)

Asserts that the [response](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse) returned a
[status_code](https://docs.djangoproject.com/en/ref/request-response/#django.http.HttpResponse.status_code) redirect status, redirected
...
`expected_url` is the one used to make the comparisons to.
    ...
    SimpleTestCase.assertHTMLEqual(*html1*, *html2*, *msg=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertHTMLEqual)[¶](#django.test.SimpleTestCase.assertHTMLEqual)
...
Output in case of error can be customized with the `msg` argument.
    ...
    SimpleTestCase.assertHTMLNotEqual(*html1*, *html2*, *msg=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertHTMLNotEqual)[¶](#django.test.SimpleTestCase.assertHTMLNotEqual)
...
Output in case of error can be customized with the `msg` argument.
    ...
    SimpleTestCase.assertXMLEqual(*xml1*, *xml2*, *msg=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertXMLEqual)[¶](#django.test.SimpleTestCase.assertXMLEqual)
...
Output in case of error can be customized with the `msg` argument.
    ...
    SimpleTestCase.assertXMLNotEqual(*xml1*, *xml2*, *msg=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertXMLNotEqual)[¶](#django.test.SimpleTestCase.assertXMLNotEqual)
...
Output in case of error can be customized with the `msg` argument.
    ...
    SimpleTestCase.assertInHTML(*needle*, *haystack*, *count=None*, *msg_prefix=''*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertInHTML)[¶](#django.test.SimpleTestCase.assertInHTML)
...
significant. See [assertHTMLEqual()](#django.test.SimpleTestCase.assertHTMLEqual) for more details.
    ...
    SimpleTestCase.assertJSONEqual(*raw*, *expected_data*, *msg=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertJSONEqual)[¶](#django.test.SimpleTestCase.assertJSONEqual)
...
Output in case of error can be customized with the `msg` argument.
    ...
    SimpleTestCase.assertJSONNotEqual(*raw*, *expected_data*, *msg=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#SimpleTestCase.assertJSONNotEqual)[¶](#django.test.SimpleTestCase.assertJSONNotEqual)
...
Output in case of error can be customized with the `msg` argument.
    ...
    TransactionTestCase.assertQuerySetEqual(*qs*, *values*, *transform=None*, *ordered=True*, *msg=None*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#TransactionTestCase.assertQuerySetEqual)[¶](#django.test.TransactionTestCase.assertQuerySetEqual)
...
Deprecated since version 4.2: The `assertQuerysetEqual()` assertion method is deprecated. Use
`assertQuerySetEqual()` instead.

     TransactionTestCase.assertNumQueries(*num*, *func*, **args*, ***kwargs*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#TransactionTestCase.assertNumQueries)[¶](#django.test.TransactionTestCase.assertNumQueries)
...
[test--exclude-tag](https://docs.djangoproject.com/en/ref/django-admin/#cmdoption-test-exclude-tag) has precedence over [test--tag](https://docs.djangoproject.com/en/ref/django-admin/#cmdoption-test-tag), so if a
...
or as `self.async_client` on any test.
   ...
   *class*AsyncClient(*enforce_csrf_checks=False*, *raise_request_exception=True*, ***, *headers=None*, ***defaults*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/client/#AsyncClient)[¶](#django.test.AsyncClient)
...
Django’s [asynchronous request path](https://docs.djangoproject.com/en/5.0/async/), which supports both.
...
methods with [async_to_sync()](https://docs.djangoproject.com/en/5.0/async/#asgiref.sync.async_to_sync) *inside* of them instead:
...
functionality](https://docs.djangoproject.com/en/5.0/email/), you probably don’t want to send email each time
...
Django, such as your machine’s mail server, if you’re running one.)
   ...
   django.core.mail.outbox[¶](#django.core.mail.django.core.mail.outbox)

During test running, each outgoing email is saved in
`django.core.mail.outbox`. This is a list of all
[EmailMessage](https://docs.djangoproject.com/en/5.0/email/#django.core.mail.EmailMessage) instances that have been sent.  The
...
[django.core.mail](https://docs.djangoproject.com/en/5.0/email/#module-django.core.mail) module and you can’t import it directly. The code below
...
[call_command()](https://docs.djangoproject.com/en/ref/django-admin/#django.core.management.call_command) function. The output can be
...
that can be used as a basis for skipping tests.
   ...
   skipIfDBFeature(**feature_name_strings*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#skipIfDBFeature)[¶](#django.test.skipIfDBFeature)
...
```
    ...
    skipUnlessDBFeature(**feature_name_strings*)[[source]](https://docs.djangoproject.com/en/_modules/django/test/testcases/#skipUnlessDBFeature)[¶](#django.test.skipUnlessDBFeature)
