...
# Formsets¶
   ...
   *class*BaseFormSet[[source]](https://docs.djangoproject.com/en/_modules/django/forms/formsets/#BaseFormSet)[¶](#django.forms.formsets.BaseFormSet)
...
[formset_factory()](https://docs.djangoproject.com/en/ref/forms/formsets/#django.forms.formsets.formset_factory) defines one extra form; the
...
[Creating formsets from models with model formsets](https://docs.djangoproject.com/en/5.0/topics/modelforms/#model-formsets).

## Limiting the maximum number of forms¶

The `max_num` parameter to [formset_factory()](https://docs.djangoproject.com/en/ref/forms/formsets/#django.forms.formsets.formset_factory)
...
[formset_factory()](https://docs.djangoproject.com/en/ref/forms/formsets/#django.forms.formsets.formset_factory), then `max_num` will affect
validation.  See [validate_max](#validate-max).

## Limiting the maximum number of instantiated forms¶

The `absolute_max` parameter to [formset_factory()](https://docs.djangoproject.com/en/ref/forms/formsets/#django.forms.formsets.formset_factory) allows limiting the
...
validation may be incorrect when adding and deleting forms.
   ...
   BaseFormSet.total_error_count()[[source]](https://docs.djangoproject.com/en/_modules/django/forms/formsets/#BaseFormSet.total_error_count)[¶](#django.forms.formsets.BaseFormSet.total_error_count)
...
### total_form_countandinitial_form_count¶
...
[formset_factory()](https://docs.djangoproject.com/en/ref/forms/formsets/#django.forms.formsets.formset_factory), validation will also check
...
The [formset_factory()](https://docs.djangoproject.com/en/ref/forms/formsets/#django.forms.formsets.formset_factory) provides two optional
parameters `can_order` and `can_delete` to help with ordering of forms in
formsets and deletion of forms from a formset.

### can_order¶

   BaseFormSet.can_order[¶](#django.forms.formsets.BaseFormSet.can_order)
...
#### ordering_widget¶
   ...
   BaseFormSet.ordering_widget[¶](#django.forms.formsets.BaseFormSet.ordering_widget)

Default: [NumberInput](https://docs.djangoproject.com/en/ref/forms/widgets/#django.forms.NumberInput)
...
#### get_ordering_widget¶
   ...
   BaseFormSet.get_ordering_widget()[[source]](https://docs.djangoproject.com/en/_modules/django/forms/formsets/#BaseFormSet.get_ordering_widget)[¶](#django.forms.formsets.BaseFormSet.get_ordering_widget)
...
### can_delete¶
   ...
   BaseFormSet.can_delete[¶](#django.forms.formsets.BaseFormSet.can_delete)
...
If you are using a [ModelFormSet](https://docs.djangoproject.com/en/5.0/topics/modelforms/#django.forms.models.BaseModelFormSet),
model instances for deleted forms will be deleted when you call
`formset.save()`.

If you call `formset.save(commit=False)`, objects will not be deleted
automatically.  You’ll need to call `delete()` on each of the
[formset.deleted_objects](https://docs.djangoproject.com/en/5.0/topics/modelforms/#django.forms.models.BaseModelFormSet.deleted_objects) to actually delete
them:
...
#### deletion_widget¶
   ...
   BaseFormSet.deletion_widget[¶](#django.forms.formsets.BaseFormSet.deletion_widget)

Default: [CheckboxInput](https://docs.djangoproject.com/en/ref/forms/widgets/#django.forms.CheckboxInput)
...
#### get_deletion_widget¶
   ...
   BaseFormSet.get_deletion_widget()[[source]](https://docs.djangoproject.com/en/_modules/django/forms/formsets/#BaseFormSet.get_deletion_widget)[¶](#django.forms.formsets.BaseFormSet.get_deletion_widget)
...
### can_delete_extra¶
   ...
   BaseFormSet.can_delete_extra[¶](#django.forms.formsets.BaseFormSet.can_delete_extra)
...
Formsets have the following attributes and methods associated with rendering:
   ...
   BaseFormSet.renderer[¶](#django.forms.formsets.BaseFormSet.renderer)

Specifies the [renderer](https://docs.djangoproject.com/en/ref/forms/renderers/) to use for the
formset. Defaults to the renderer specified by the [FORM_RENDERER](https://docs.djangoproject.com/en/ref/settings/#std-setting-FORM_RENDERER)
setting.

    BaseFormSet.template_name[¶](#django.forms.formsets.BaseFormSet.template_name)
...
[formset_template_name](https://docs.djangoproject.com/en/ref/forms/renderers/#django.forms.renderers.BaseRenderer.formset_template_name). You may
...
[template_name](https://docs.djangoproject.com/en/ref/forms/api/#django.forms.Form.template_name).

    BaseFormSet.template_name_div[¶](#django.forms.formsets.BaseFormSet.template_name_div)
...
form’s [as_div()](https://docs.djangoproject.com/en/ref/forms/api/#django.forms.Form.as_div) method.

    BaseFormSet.template_name_p[¶](#django.forms.formsets.BaseFormSet.template_name_p)
...
[as_p()](https://docs.djangoproject.com/en/ref/forms/api/#django.forms.Form.as_p) method.

    BaseFormSet.template_name_table[¶](#django.forms.formsets.BaseFormSet.template_name_table)
...
formset’s management form and then each form in the formset as per the
form’s [as_table()](https://docs.djangoproject.com/en/ref/forms/api/#django.forms.Form.as_table) method.

    BaseFormSet.template_name_ul[¶](#django.forms.formsets.BaseFormSet.template_name_ul)
...
management form and then each form in the formset as per the form’s
[as_ul()](https://docs.djangoproject.com/en/ref/forms/api/#django.forms.Form.as_ul) method.

    BaseFormSet.get_context()[[source]](https://docs.djangoproject.com/en/_modules/django/forms/formsets/#BaseFormSet.get_context)[¶](#django.forms.formsets.BaseFormSet.get_context)
...
- `formset` : The instance of the formset.
    ...
    BaseFormSet.render(*template_name=None*, *context=None*, *renderer=None*)[¶](#django.forms.formsets.BaseFormSet.render)
...
[overriding the default template](https://docs.djangoproject.com/en/ref/forms/renderers/#overriding-built-in-formset-templates).

### Manually renderedcan_deleteandcan_order¶
