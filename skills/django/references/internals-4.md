# Django’s security policies¶ and more
...
- The two most recent Django release series receive security
  ...
  support will end.
- [Long-term support release](https://docs.djangoproject.com/en/5.0/release-process/#term-Long-term-support-release)s will receive security updates for a
  specified period.
...
First, we notify [django-announce](https://docs.djangoproject.com/en/5.0/mailing-lists/#django-announce-mailing-list) of the date and approximate time of the
...
4. Post a notice to the [django-announce](https://docs.djangoproject.com/en/5.0/mailing-lists/#django-announce-mailing-list) and [oss-security@lists.openwall.com](mailto:oss-security%40lists.openwall.com)
...
disclosed in Django](https://docs.djangoproject.com/en/releases/security/).
...
- A detailed explanation of why you are requesting security notifications.
  ...
  [django-announce](https://docs.djangoproject.com/en/5.0/mailing-lists/#django-announce-mailing-list) to receive advanced notice of when a security release will
