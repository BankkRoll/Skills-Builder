...
This document covers features of the [Model](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model) class.
...
### DoesNotExist¶
   ...
   *exception*Model.DoesNotExist[¶](#django.db.models.Model.DoesNotExist)

This exception is raised by the ORM when an expected object is not found.
For example, [QuerySet.get()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.get) will raise it when no object is found
...
subclass of [django.core.exceptions.ObjectDoesNotExist](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.ObjectDoesNotExist).

### MultipleObjectsReturned¶

   *exception*Model.MultipleObjectsReturned[¶](#django.db.models.Model.MultipleObjectsReturned)

This exception is raised by [QuerySet.get()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.get) when multiple objects are
...
[django.core.exceptions.MultipleObjectsReturned](https://docs.djangoproject.com/en/5.0/exceptions/#django.core.exceptions.MultipleObjectsReturned).

### objects¶

   Model.objects[¶](#django.db.models.Model.objects)

Each non-abstract [Model](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model) class must have a
[Manager](https://docs.djangoproject.com/en/topics/db/managers/#django.db.models.Manager) instance added to it.
...
[Manager](https://docs.djangoproject.com/en/topics/db/managers/#django.db.models.Manager) instance. If you add your own
[Manager](https://docs.djangoproject.com/en/topics/db/managers/#django.db.models.Manager) instance attribute, the default one does
...
For more details on model managers see [Managers](https://docs.djangoproject.com/en/topics/db/managers/)
and [Retrieving objects](https://docs.djangoproject.com/en/topics/db/queries/#retrieving-objects).
...
also be combined and nested like other [expressions](https://docs.djangoproject.com/en/5.0/ref/expressions/).
...
### When¶
   ...
   *class*When(*condition=None*, *then=None*, ***lookups*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#When)[¶](#django.db.models.expressions.When)

A `When()` object is used to encapsulate a condition and its result for use
in the conditional expression. Using a `When()` object is similar to using
the [filter()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.filter) method. The condition can
be specified using [field lookups](https://docs.djangoproject.com/en/5.0/ref/querysets/#field-lookups),
[Q](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.Q) objects, or [Expression](https://docs.djangoproject.com/en/5.0/ref/expressions/#django.db.models.Expression)
objects that have an `output_field` that is a
[BooleanField](https://docs.djangoproject.com/en/5.0/ref/fields/#django.db.models.BooleanField). The result is provided using the
`then` keyword.
...
[Model](https://docs.djangoproject.com/en/5.0/ref/instances/#django.db.models.Model) has a field named `then`. This can be
...
### Case¶
   ...
   *class*Case(**cases*, ***extra*)[[source]](https://docs.djangoproject.com/en/_modules/django/db/models/expressions/#Case)[¶](#django.db.models.expressions.Case)
...
[update()](https://docs.djangoproject.com/en/5.0/ref/querysets/#django.db.models.query.QuerySet.update) method:
...
functions](https://docs.djangoproject.com/en/5.0/ref/querysets/#aggregation-functions) to achieve this:
