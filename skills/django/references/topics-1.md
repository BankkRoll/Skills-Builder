...
[ASGI](https://docs.djangoproject.com/en/howto/deployment/asgi/). Async views will still work under
...
[ASGI](https://docs.djangoproject.com/en/howto/deployment/asgi/) instead.
...
Middleware can be built to support [both sync and async](https://docs.djangoproject.com/en/5.0/http/middleware/#async-middleware) contexts. Some of Django’s middleware is built like
...
- [cache_control()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.cache_control)
- [never_cache()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.cache.never_cache)
- [no_append_slash()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.common.no_append_slash)
- [csrf_exempt()](https://docs.djangoproject.com/en/ref/csrf/#django.views.decorators.csrf.csrf_exempt)
- [csrf_protect()](https://docs.djangoproject.com/en/ref/csrf/#django.views.decorators.csrf.csrf_protect)
- [ensure_csrf_cookie()](https://docs.djangoproject.com/en/ref/csrf/#django.views.decorators.csrf.ensure_csrf_cookie)
- [requires_csrf_token()](https://docs.djangoproject.com/en/ref/csrf/#django.views.decorators.csrf.requires_csrf_token)
- [sensitive_variables()](https://docs.djangoproject.com/en/howto/error-reporting/#django.views.decorators.debug.sensitive_variables)
- [sensitive_post_parameters()](https://docs.djangoproject.com/en/howto/error-reporting/#django.views.decorators.debug.sensitive_post_parameters)
- [gzip_page()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.gzip.gzip_page)
- [condition()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.http.condition)
- `conditional_page()`
- [etag()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.http.etag)
- [last_modified()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.http.last_modified)
- [require_http_methods()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.http.require_http_methods)
- [require_GET()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.http.require_GET)
- [require_POST()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.http.require_POST)
- [require_safe()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.http.require_safe)
- [vary_on_cookie()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.vary.vary_on_cookie)
- [vary_on_headers()](https://docs.djangoproject.com/en/5.0/http/decorators/#django.views.decorators.vary.vary_on_headers)
- `xframe_options_deny()`
...
Detailed notes can be found in [Asynchronous queries](https://docs.djangoproject.com/en/5.0/db/queries/#async-queries), but in short:
...
You can also [handle client disconnects in streaming responses](https://docs.djangoproject.com/en/ref/request-response/#request-response-streaming-disconnect).
...
[SynchronousOnlyOperation](https://docs.djangoproject.com/en/ref/exceptions/#django.core.exceptions.SynchronousOnlyOperation) error. Note that you
...
without generating [SynchronousOnlyOperation](https://docs.djangoproject.com/en/ref/exceptions/#django.core.exceptions.SynchronousOnlyOperation)
...
### async_to_sync()¶
   ...
   async_to_sync(*async_function*, *force_new_loop=False*)[[source]](https://docs.djangoproject.com/en/_modules/asgiref/sync/#async_to_sync)[¶](#asgiref.sync.async_to_sync)
...
### sync_to_async()¶
   ...
   sync_to_async(*sync_function*, *thread_sensitive=True*)[[source]](https://docs.djangoproject.com/en/_modules/asgiref/sync/#sync_to_async)[¶](#asgiref.sync.sync_to_async)
...
functions in the same thread. Note, though, that it *relies on usage of* [async_to_sync()](#asgiref.sync.async_to_sync) *above it in the stack* to correctly run things on the
