...
- Documentation on connect arguments:
  [https://www.sqlalchemy.org/docs/06/dbengine.html#create-engine-url-arguments](https://www.sqlalchemy.org/docs/06/dbengine.html#create-engine-url-arguments).
- Reference documentation for individual dialects:
  [https://www.sqlalchemy.org/docs/06/reference/dialects/index.html](https://www.sqlalchemy.org/docs/06/reference/dialects/index.html).
...
#unions-and-other-set-operations].  See [#1665](https://www.sqlalchemy.org/trac/ticket/1665) and
...
documented at: [https://docs.python.org/library/warnings.html](https://docs.python.org/library/warnings.html)
...
### Changes toquery.update()andquery.delete()
...
### relation()is officially namedrelationship()
...
- `ScopedSession.mapper` remains deprecated.  See the
  usage recipe at   [https://www.sqlalchemy.org/trac/wiki/Usag](https://www.sqlalchemy.org/trac/wiki/Usag)
...
[[https://www.sqlalchemy.org/docs/06/reference/ext/sqlsoup.html](https://www.sqlalchemy.org/docs/06/reference/ext/sqlsoup.html)].
...
[MixIn class](https://www.sqlalchemy.org/docs/reference/ext/declarative.html#mix-in-classes) approach should be used
