...
- Fixed bug whereby DATETIME2 type would fail on
  ...
  References: [#2159](https://www.sqlalchemy.org/trac/ticket/2159)
...
- Fixed bug in QueuePool, SingletonThreadPool whereby
  ...
  this.
  References: [#2102](https://www.sqlalchemy.org/trac/ticket/2102)
...
- Fixed bug whereby “passive_deletes=’all’” wasn’t passing
  ...
  References: [#2013](https://www.sqlalchemy.org/trac/ticket/2013)
- Fixed bug which prevented composite mapped
  ...
  References: [#1997](https://www.sqlalchemy.org/trac/ticket/1997)
- active_history flag also added to composite().
  ...
  References: [#1976](https://www.sqlalchemy.org/trac/ticket/1976)
- Fixed uow bug whereby expired objects passed to
  ...
  References: [#2002](https://www.sqlalchemy.org/trac/ticket/2002)
- A warning is emitted when version_id_col is specified
  ...
  the same.
  References: [#1987](https://www.sqlalchemy.org/trac/ticket/1987)
...
- The mapper argument “primary_key” can be passed as a
  ...
  References: [#1971](https://www.sqlalchemy.org/trac/ticket/1971)
...
- Fixed memory leak in C version of Decimal result
  processor.
  References: [#1978](https://www.sqlalchemy.org/trac/ticket/1978)
- Implemented sequence check capability for the C
  ...
  References: [#1871](https://www.sqlalchemy.org/trac/ticket/1871)
- Threadlocal engine methods rollback(), commit(),
  ...
  References: [#1998](https://www.sqlalchemy.org/trac/ticket/1998)
- Threadlocal engine returns itself upon begin(),
  ...
  References: [#2004](https://www.sqlalchemy.org/trac/ticket/2004)
...
- Fixed operator precedence rules for multiple
  ...
  i.e. “x - (y - z).label(‘foo’)”
  References: [#1984](https://www.sqlalchemy.org/trac/ticket/1984)
- The ‘info’ attribute of Column is copied during
  Column.copy(), i.e. as occurs when using columns
  in declarative mixins.
  References: [#1967](https://www.sqlalchemy.org/trac/ticket/1967)
...
- CheckConstraint will copy its ‘initially’, ‘deferrable’,
  ...
  References: [#2000](https://www.sqlalchemy.org/trac/ticket/2000)
...
- Ensured every numeric, float, int code, scalar + array,
  ...
  base type.
  References: [#1955](https://www.sqlalchemy.org/trac/ticket/1955)
- Added as_uuid=True flag to the UUID type, will receive
  ...
  work with psycopg2.
  References: [#1956](https://www.sqlalchemy.org/trac/ticket/1956)
- Fixed bug whereby KeyError would occur with non-ENUM
  supported PG versions after a pool dispose+recreate
  would occur.
  References: [#1989](https://www.sqlalchemy.org/trac/ticket/1989)
...
- Fixed error handling for Jython + zxjdbc, such that
  ...
  References: [#1960](https://www.sqlalchemy.org/trac/ticket/1960)
...
- The REFERENCES clause in a CREATE TABLE that includes
  ...
  References: [#1851](https://www.sqlalchemy.org/trac/ticket/1851)
...
- The rewrite of index reflection in was
  ...
  References: [#1770](https://www.sqlalchemy.org/trac/ticket/1770)
...
- The cx_oracle “decimal detection” logic, which takes place
  ...
  References: [#1953](https://www.sqlalchemy.org/trac/ticket/1953)
...
- Firebird numeric type now checks for Decimal explicitly,
  ...
  References: [#2012](https://www.sqlalchemy.org/trac/ticket/2012)
- An error is raised if __table_args__ is not in tuple
  or dict format, and is not None.
  References: [#1972](https://www.sqlalchemy.org/trac/ticket/1972)
- Added “map_to()” method to SqlSoup, which is a “master”
  ...
  mapping.
  References: [#1975](https://www.sqlalchemy.org/trac/ticket/1975)
...
- Added a new “lazyload” option “immediateload”.
  ...
  References: [#1914](https://www.sqlalchemy.org/trac/ticket/1914)
- New Query methods: query.label(name), query.as_scalar(),
  ...
  expressions.
  References: [#1920](https://www.sqlalchemy.org/trac/ticket/1920)
...
- Fixed a regression in 0.6.4 which occurred if you
  ...
  mapper()
  References: [#1918](https://www.sqlalchemy.org/trac/ticket/1918)
...
- Patched a case where query.join() would adapt the
  ...
  inappropriately
  References: [#1925](https://www.sqlalchemy.org/trac/ticket/1925)
...
- Fixed bug in query.update() where ‘evaluate’ or ‘fetch’
  ...
  actual column name.
  References: [#1935](https://www.sqlalchemy.org/trac/ticket/1935)
...
- lazy loads for relationship attributes now use
  ...
  available.
  References: [#1910](https://www.sqlalchemy.org/trac/ticket/1910)
...
- scoped_session emits a warning when configure() is
  ...
  current thread)
  References: [#1924](https://www.sqlalchemy.org/trac/ticket/1924)
- reworked the internals of mapper.cascade_iterator() to
  cut down method calls by about 9% in some circumstances.
  References: [#1932](https://www.sqlalchemy.org/trac/ticket/1932)
...
- as_scalar(), label() can be called on a selectable
  ...
  References: [#1862](https://www.sqlalchemy.org/trac/ticket/1862)
- Fixed recursion overflow which could occur when operating
  ...
  References: [#1907](https://www.sqlalchemy.org/trac/ticket/1907)
...
- Fixed bug which prevented “domain” built from a
  ...
  References: [#1933](https://www.sqlalchemy.org/trac/ticket/1933)
...
- Fixed bug involving reflection of CURRENT_TIMESTAMP
  ...
  Taavi Burns
  References: [#1940](https://www.sqlalchemy.org/trac/ticket/1940)

### mssql

- Fixed reflection bug which did not properly handle
  reflection of unknown types.
  References: [#1946](https://www.sqlalchemy.org/trac/ticket/1946)
- Fixed bug where aliasing of tables with “schema” would
  fail to compile properly.
  References: [#1943](https://www.sqlalchemy.org/trac/ticket/1943)
...
- mssql+pymssql dialect now honors the “port” portion
  ...
  References: [#1952](https://www.sqlalchemy.org/trac/ticket/1952)
...
- The implicit_returning argument to create_engine()
  ...
  References: [#1878](https://www.sqlalchemy.org/trac/ticket/1878)
...
- @classproperty (soon/now @declared_attr) takes effect for
  ...
  References: [#1922](https://www.sqlalchemy.org/trac/ticket/1922)
- @classproperty ‘s official name/location for usage
  ...
  References: [#1915](https://www.sqlalchemy.org/trac/ticket/1915)
- Fixed bug whereby columns on a mixin wouldn’t propagate
  ...
  References: [#1930](https://www.sqlalchemy.org/trac/ticket/1930), [#1931](https://www.sqlalchemy.org/trac/ticket/1931)
...
- *Major* cleanup / modernization of the Informix
  ...
  References: [#1906](https://www.sqlalchemy.org/trac/ticket/1906)
- CircularDependencyError now has .cycles and .edges
  ...
  References: [#1890](https://www.sqlalchemy.org/trac/ticket/1890)
...
- Added a mutex to the identity map which mutexes
  ...
  References: [#1891](https://www.sqlalchemy.org/trac/ticket/1891)
...
- If the “secondary” table has no ForeignKey metadata
  ...
  References: [#1877](https://www.sqlalchemy.org/trac/ticket/1877)
- Moving an o2m object from one collection to
  ...
  References: [#1856](https://www.sqlalchemy.org/trac/ticket/1856)
- The value of version_id_col can be changed
  ...
  References: [#1857](https://www.sqlalchemy.org/trac/ticket/1857)
...
- Specifying a non-column based argument
  ...
  text() or literal().
  References: [#1863](https://www.sqlalchemy.org/trac/ticket/1863)
...
- Dynamic attributes don’t support collection
  ...
  References: [#1864](https://www.sqlalchemy.org/trac/ticket/1864)
- Fixed bug whereby generating a Query derived
  ...
  the outer query.
  References: [#1852](https://www.sqlalchemy.org/trac/ticket/1852)
- object_session() raises the proper
  UnmappedInstanceError when presented with an
  unmapped instance.
  References: [#1881](https://www.sqlalchemy.org/trac/ticket/1881)
...
- the history_meta versioning recipe sets “unique=False”
  ...
  References: [#1887](https://www.sqlalchemy.org/trac/ticket/1887)
...
- Fixed bug in Connection whereby if a “disconnect”
  ...
  References: [#1894](https://www.sqlalchemy.org/trac/ticket/1894)
...
- Changed the scheme used to generate truncated
  ...
  have unique names.
  References: [#1855](https://www.sqlalchemy.org/trac/ticket/1855)
- The generated index name also is based on
  ...
  References: [#1412](https://www.sqlalchemy.org/trac/ticket/1412)
...
- Fixed bug whereby replacing composite foreign key
  ...
  References: [#1865](https://www.sqlalchemy.org/trac/ticket/1865)
...
- Added ROWID type to the Oracle dialect, for those
  ...
  References: [#1879](https://www.sqlalchemy.org/trac/ticket/1879)
- Oracle reflection of indexes has been tuned so
  ...
  for the patch.
  References: [#1867](https://www.sqlalchemy.org/trac/ticket/1867)
- Oracle now reflects the names of primary key
  constraints - also thanks to Kent Bower.
  References: [#1868](https://www.sqlalchemy.org/trac/ticket/1868)
...
- Applied patches from to get
  ...
  References: [#1904](https://www.sqlalchemy.org/trac/ticket/1904)
...
- Removed errant many-to-many load in unitofwork
  ...
  References: [#1845](https://www.sqlalchemy.org/trac/ticket/1845)
- Column-entities (i.e. query(Foo.id)) copy their
  ...
  References: [#1853](https://www.sqlalchemy.org/trac/ticket/1853)
...
- Improved the check for an “unmapped class”,
  ...
  UnmappedClassError().
  References: [#1142](https://www.sqlalchemy.org/trac/ticket/1142)
...
- The _extract_error_code() method now works
  ...
  watched the logs.
  References: [#1848](https://www.sqlalchemy.org/trac/ticket/1848)
...
- More tweaks to cx_oracle Decimal handling.
  ...
  References: [#1840](https://www.sqlalchemy.org/trac/ticket/1840)
...
- Fixed bug regarding flushes on self-referential
  ...
  References: [#1824](https://www.sqlalchemy.org/trac/ticket/1824)
...
- The warning emitted by the Unicode and String types
  ...
  References: [#1822](https://www.sqlalchemy.org/trac/ticket/1822)
...
- The argument to “ESCAPE” of a LIKE operator or similar
  ...
  References: [#1400](https://www.sqlalchemy.org/trac/ticket/1400)
...
- Column.copy() takes along the “unique” attribute
  ...
  mixins
  References: [#1829](https://www.sqlalchemy.org/trac/ticket/1829)
...
- Won’t generate “CREATE TYPE” / “DROP TYPE” if
  ...
  honored.
  References: [#1836](https://www.sqlalchemy.org/trac/ticket/1836)
...
- MySQL dialect doesn’t emit CAST() for MySQL version
  ...
  References: [#1826](https://www.sqlalchemy.org/trac/ticket/1826)
...
- If server_version_info is outside the usual
  ...
  References: [#1825](https://www.sqlalchemy.org/trac/ticket/1825)
...
- Fixed ora-8 compatibility flags such that they
  ...
  References: [#1819](https://www.sqlalchemy.org/trac/ticket/1819)
...
- Fixed incorrect signature in do_execute(), error
  introduced in 0.6.1.
  References: [#1823](https://www.sqlalchemy.org/trac/ticket/1823)
- Firebird dialect adds CHAR, VARCHAR types which
  accept a “charset” flag, to support Firebird
  “CHARACTER SET” clause.
  References: [#1813](https://www.sqlalchemy.org/trac/ticket/1813)
- Added support for @classproperty to provide
  ...
  References: [#1751](https://www.sqlalchemy.org/trac/ticket/1751), [#1796](https://www.sqlalchemy.org/trac/ticket/1796), [#1805](https://www.sqlalchemy.org/trac/ticket/1805)
- a mixin class can now define a column that matches
  ...
  here now works.
  References: [#1821](https://www.sqlalchemy.org/trac/ticket/1821)
- The ‘default’ compiler is automatically copied over
  ...
  is invoked.
  References: [#1838](https://www.sqlalchemy.org/trac/ticket/1838)
- Added documentation for the Inspector.
  References: [#1820](https://www.sqlalchemy.org/trac/ticket/1820)
- Fixed @memoized_property and @memoized_instancemethod
  ...
  References: [#1830](https://www.sqlalchemy.org/trac/ticket/1830)
...
- Fixed regression introduced in 0.6.0 involving improper
  ...
  References: [#1782](https://www.sqlalchemy.org/trac/ticket/1782)
...
- expr.in_() now accepts a text() construct as the argument.
  ...
  References: [#1793](https://www.sqlalchemy.org/trac/ticket/1793)
...
- Fixed “table” argument on constructor of ForeignKeyConstraint
  References: [#1571](https://www.sqlalchemy.org/trac/ticket/1571)
- Fixed bug in connection pool cursor wrapper whereby if a
  cursor threw an exception on close(), the logging of the
  message would fail.
  References: [#1786](https://www.sqlalchemy.org/trac/ticket/1786)
...
- func.XXX() doesn’t inadvertently resolve to non-Function
  ...
  References: [#1798](https://www.sqlalchemy.org/trac/ticket/1798)

### mysql

- func.sysdate() emits “SYSDATE()”, i.e. with the ending
  parenthesis, on MySQL.
  References: [#1794](https://www.sqlalchemy.org/trac/ticket/1794)
...
- Fixed concatenation of constraints when “PRIMARY KEY”
  ...
  References: [#1812](https://www.sqlalchemy.org/trac/ticket/1812)
...
- Added a check for cx_oracle versions lower than version 5,
  ...
  References: [#1775](https://www.sqlalchemy.org/trac/ticket/1775)
- Fixed use_ansi=False mode, which was producing broken
  WHERE clauses in pretty much all cases.
  References: [#1790](https://www.sqlalchemy.org/trac/ticket/1790)
- Re-established support for Oracle 8 with cx_oracle,
  ...
  References: [#1808](https://www.sqlalchemy.org/trac/ticket/1808)
- oracle_xe 5 doesn’t accept a Python unicode object in
  ...
  we could use.
  References: [#1670](https://www.sqlalchemy.org/trac/ticket/1670)
- FOR UPDATE is emitted in the syntactically correct position
  ...
  References: [#1815](https://www.sqlalchemy.org/trac/ticket/1815)

### misc

- Fixed building the C extensions on Python 2.4.
  References: [#1781](https://www.sqlalchemy.org/trac/ticket/1781)
...
- the SqlSoup constructor accepts a base argument which specifies
  ...
  object.
  References: [#1783](https://www.sqlalchemy.org/trac/ticket/1783)
...
- Unit of work internals have been rewritten.  Units of work
  ...
  References: [#1081](https://www.sqlalchemy.org/trac/ticket/1081), [#1742](https://www.sqlalchemy.org/trac/ticket/1742)
...
- one-to-many relationships now maintain a list of positive
  ...
  association.
  References: [#1764](https://www.sqlalchemy.org/trac/ticket/1764)
- A collection lazy load will switch off default
  ...
  References: [#1495](https://www.sqlalchemy.org/trac/ticket/1495)
...
- The ‘refresh-expire’ cascade, when reaching a pending object,
  ...
  References: [#1754](https://www.sqlalchemy.org/trac/ticket/1754)
- id(obj) is no longer used internally within topological.py,
  as the sorting functions now require hashable objects
  only.
  References: [#1756](https://www.sqlalchemy.org/trac/ticket/1756)
...
- Usage of version_id_col on a backend that supports
  ...
  as with saves.
  References: [#1761](https://www.sqlalchemy.org/trac/ticket/1761)
...
- Restored some bind-labeling logic from 0.5 which ensures
  ...
  has been added.
  References: [#1755](https://www.sqlalchemy.org/trac/ticket/1755)
...
- the Numeric type raises an *enormous* warning when expected
  ...
  References: [#1759](https://www.sqlalchemy.org/trac/ticket/1759)
...
- Added get_pk_constraint() to reflection.Inspector, similar
  ...
  References: [#1769](https://www.sqlalchemy.org/trac/ticket/1769)
- Table.create() and Table.drop() no longer apply metadata-
  level create/drop events.
  References: [#1771](https://www.sqlalchemy.org/trac/ticket/1771)
...
- PostgreSQL now reflects sequence names associated with
  ...
  References: [#1071](https://www.sqlalchemy.org/trac/ticket/1071)
...
- The C extension now also works with DBAPIs which use custom
  ...
  References: [#1757](https://www.sqlalchemy.org/trac/ticket/1757)
...
- Major feature: Added new “subquery” loading capability to
  ...
  References: [#1675](https://www.sqlalchemy.org/trac/ticket/1675)
...
- Added with_hint() method to Query() construct.  This calls
  ...
  SQL section below.
  References: [#921](https://www.sqlalchemy.org/trac/ticket/921)
...
- Fixed bug introduced in 0.6beta2 where column labels would
  ...
  References: [#1747](https://www.sqlalchemy.org/trac/ticket/1747)

### postgresql

- The psycopg2 dialect will log NOTICE messages via the
  “sqlalchemy.dialects.postgresql” logger name.
  References: [#877](https://www.sqlalchemy.org/trac/ticket/877)
- the TIME and TIMESTAMP types are now available from the
  ...
  TIMEZONE types.
  References: [#997](https://www.sqlalchemy.org/trac/ticket/997)
...
- No longer guessing that TINYINT(1) should be BOOLEAN
  ...
  behavior.
  References: [#1752](https://www.sqlalchemy.org/trac/ticket/1752)
...
- The Oracle dialect will issue VARCHAR type definitions
  ...
  References: [#1744](https://www.sqlalchemy.org/trac/ticket/1744)

### misc

- Using a mixin won’t break if the mixin implements an
  unpredictable __getattribute__(), i.e. Zope interfaces.
  References: [#1746](https://www.sqlalchemy.org/trac/ticket/1746)
- Using @classdecorator and similar on mixins to define
  ...
  subclass.
  References: [#1749](https://www.sqlalchemy.org/trac/ticket/1749)
- relationships and columns with foreign keys aren’t
  allowed on declarative mixins, sorry.
  References: [#1751](https://www.sqlalchemy.org/trac/ticket/1751)
...
- The official name for the relation() function is now
  ...
  References: [#1740](https://www.sqlalchemy.org/trac/ticket/1740)
- Added “version_id_generator” argument to Mapper, this is a
  ...
  References: [#1692](https://www.sqlalchemy.org/trac/ticket/1692)
...
- Fixed bug whereby calling query(A).join(A.bs).add_entity(B)
  ...
  References: [#1188](https://www.sqlalchemy.org/trac/ticket/1188)
- Fixed bug in session.rollback() which involved not removing
  ...
  first.
  References: [#1674](https://www.sqlalchemy.org/trac/ticket/1674)
- Removed a lot of logging that nobody really cares about,
  ...
  References: [#1719](https://www.sqlalchemy.org/trac/ticket/1719)
...
- session.merge() will not expire existing scalar attributes
  ...
  References: [#1681](https://www.sqlalchemy.org/trac/ticket/1681)
- The “allow_null_pks” flag is now called “allow_partial_pks”,
  ...
  References: [#1680](https://www.sqlalchemy.org/trac/ticket/1680)
- Fixed bug in 0.6-reworked “many-to-one” optimizations
  ...
  References: [#1737](https://www.sqlalchemy.org/trac/ticket/1737)
- fixed internal error which would occur if calling has()
  or similar complex expression on a single-table inheritance
  relation().
  References: [#1731](https://www.sqlalchemy.org/trac/ticket/1731)
- query.one() no longer applies LIMIT to the query, this to
  ...
  the query.
  References: [#1688](https://www.sqlalchemy.org/trac/ticket/1688)
- query.get() now returns None if queried for an identifier
  ...
  References: [#1727](https://www.sqlalchemy.org/trac/ticket/1727)
- A major fix in query.join(), when the “on” clause is an
  ...
  References: [#1706](https://www.sqlalchemy.org/trac/ticket/1706)
- Slight improvement to the fix for to not issue
  ...
  with the same PK.
  References: [#1362](https://www.sqlalchemy.org/trac/ticket/1362)
...
- Query.union() retains disambiguating labels within the
  ...
  References: [#1676](https://www.sqlalchemy.org/trac/ticket/1676)
...
- Documentation clarification for query.delete()
  References: [#1689](https://www.sqlalchemy.org/trac/ticket/1689)
...
- Calling query.order_by() or query.distinct() before calling
  ...
  References: [#1736](https://www.sqlalchemy.org/trac/ticket/1736)
- query.scalar() now raises an exception if more than one
  row is returned.  All other behavior remains the same.
  References: [#1735](https://www.sqlalchemy.org/trac/ticket/1735)
...
- join() will now simulate a NATURAL JOIN by default.  Meaning,
  ...
  the left.
  References: [#1714](https://www.sqlalchemy.org/trac/ticket/1714)
...
- SchemaType and subclasses Boolean, Enum are now serializable,
  ...
  References: [#1694](https://www.sqlalchemy.org/trac/ticket/1694), [#1698](https://www.sqlalchemy.org/trac/ticket/1698)
...
- The type/expression system now does a more complete job
  ...
  References: [#1647](https://www.sqlalchemy.org/trac/ticket/1647), [#1683](https://www.sqlalchemy.org/trac/ticket/1683)
...
- A change to the solution for - an end-user
  ...
  References: [#1579](https://www.sqlalchemy.org/trac/ticket/1579)
- Column() requires a type if it has no foreign keys (this is
  not new).  An error is now raised if a Column() has no type
  and no foreign keys.
  References: [#1705](https://www.sqlalchemy.org/trac/ticket/1705)
- the “scale” argument of the Numeric() type is honored when
  ...
  on SQLite, MySQL.
  References: [#1717](https://www.sqlalchemy.org/trac/ticket/1717)
...
- Fixed reflection bug whereby when COLLATE was present,
  ...
  References: [#1655](https://www.sqlalchemy.org/trac/ticket/1655)
...
- Further fixes for the mysql-connector dialect.
  References: [#1668](https://www.sqlalchemy.org/trac/ticket/1668)
- Composite PK table on InnoDB where the “autoincrement” column
  ...
  References: [#1496](https://www.sqlalchemy.org/trac/ticket/1496)
- Added reflection/create table support for a wide range
  of MySQL keywords.
  References: [#1634](https://www.sqlalchemy.org/trac/ticket/1634)
- Fixed import error which could occur reflecting tables on
  a Windows host
  References: [#1580](https://www.sqlalchemy.org/trac/ticket/1580)
...
- Added “native_datetime=True” flag to create_engine().
  ...
  References: [#1685](https://www.sqlalchemy.org/trac/ticket/1685)
...
- Added basic support for mxODBC.
  References: [#1710](https://www.sqlalchemy.org/trac/ticket/1710)
...
- The except_() method now renders as MINUS on Oracle,
  ...
  References: [#1712](https://www.sqlalchemy.org/trac/ticket/1712)
- Added support for rendering and reflecting
  TIMESTAMP WITH TIME ZONE, i.e. TIMESTAMP(timezone=True).
  References: [#651](https://www.sqlalchemy.org/trac/ticket/651)
...
- Added “logging_name” argument to create_engine(), Pool() constructor
  ...
  References: [#1555](https://www.sqlalchemy.org/trac/ticket/1555)
...
- StaticPool now initializes, disposes and recreates without
  ...
  References: [#1728](https://www.sqlalchemy.org/trac/ticket/1728)
...
- declarative now accepts mixin classes directly, as a means
  ...
  on this.
  References: [#1707](https://www.sqlalchemy.org/trac/ticket/1707)
- the __mapper_args__ dict is copied when propagating to a subclass,
  ...
  References: [#1393](https://www.sqlalchemy.org/trac/ticket/1393)
- An exception is raised when a single-table subclass specifies
  a column that is already present on the base class.
  References: [#1732](https://www.sqlalchemy.org/trac/ticket/1732)
...
- Major cleanup work in the docs to link class, function, and
  ...
  References: [#1700](https://www.sqlalchemy.org/trac/ticket/1700)
...
- Enhancements on many-to-one relations:
  ...
  References: [#1186](https://www.sqlalchemy.org/trac/ticket/1186), [#1492](https://www.sqlalchemy.org/trac/ticket/1492), [#1544](https://www.sqlalchemy.org/trac/ticket/1544)
...
- flush() now detects when a primary key column was updated by
  ...
  References: [#1671](https://www.sqlalchemy.org/trac/ticket/1671)
...
- Using a “dynamic” loader with a “secondary” table now produces
  ...
  References: [#1531](https://www.sqlalchemy.org/trac/ticket/1531)
- relation() with uselist=False will emit a warning when
  ...
  References: [#1643](https://www.sqlalchemy.org/trac/ticket/1643)
- an explicit check occurs when a synonym() is used with
  ...
  an error is raised.
  References: [#1633](https://www.sqlalchemy.org/trac/ticket/1633)
...
- mapping to a select() construct now requires that you
  ...
  References: [#1542](https://www.sqlalchemy.org/trac/ticket/1542)
- query.join() has been reworked to provide more consistent
  behavior and more flexibility (includes)
  References: [#1537](https://www.sqlalchemy.org/trac/ticket/1537)
...
- query.get() can be used with a mapping to an outer join
  ...
  References: [#1135](https://www.sqlalchemy.org/trac/ticket/1135)
- query.from_self(), query.union(), others which do a
  ...
  References: [#1568](https://www.sqlalchemy.org/trac/ticket/1568)
- relation primaryjoin and secondaryjoin now check that they
  ...
  References: [#1622](https://www.sqlalchemy.org/trac/ticket/1622)
- expression.null() is fully understood the same way
  ...
  References: [#1415](https://www.sqlalchemy.org/trac/ticket/1415)
- added “make_transient()” helper function which transforms a
  ...
  References: [#1052](https://www.sqlalchemy.org/trac/ticket/1052)
- the allow_null_pks flag on mapper() is deprecated, and
  ...
  References: [#1339](https://www.sqlalchemy.org/trac/ticket/1339)
...
- The version_id_col feature on mapper() will raise a warning when
  ...
  References: [#1569](https://www.sqlalchemy.org/trac/ticket/1569)
...
- Deprecated or removed:
  ...
  - ScopedSession.mapper remains deprecated.  See the
    usage recipe at
    [https://www.sqlalchemy.org/trac/wiki/UsageRecipes/SessionAwareMapper](https://www.sqlalchemy.org/trac/wiki/UsageRecipes/SessionAwareMapper)
...
- an executemany() now requires that all bound parameter
  ...
  against.
  References: [#1566](https://www.sqlalchemy.org/trac/ticket/1566)
...
- union(), intersect(), except() and other “compound” types
  ...
  of a subquery.
  References: [#1665](https://www.sqlalchemy.org/trac/ticket/1665)
...
- the Binary type now returns data as a Python string
  ...
  of binary data.
  References: [#1524](https://www.sqlalchemy.org/trac/ticket/1524)
...
- multi-part schema names, i.e. with dots such as
  ...
  in result sets.
  References: [#1428](https://www.sqlalchemy.org/trac/ticket/1428)
...
- calling expr.in_([]), i.e. with an empty list, emits a warning
  ...
  References: [#1628](https://www.sqlalchemy.org/trac/ticket/1628)
...
- Deprecated or removed:
  ...
  References: [#1131](https://www.sqlalchemy.org/trac/ticket/1131)
...
- the __contains__() method of MetaData now accepts
  ...
  References: [#1541](https://www.sqlalchemy.org/trac/ticket/1541)
...
- The “start” and “increment” attributes on Sequence now
  ...
  References: [#1545](https://www.sqlalchemy.org/trac/ticket/1545)
...
- ForeignKey and ForeignKeyConstraint objects now correctly
  ...
  References: [#1605](https://www.sqlalchemy.org/trac/ticket/1605)
...
- Added new ENUM type, which exists as a schema-level
  ...
  reflection.
  References: [#1511](https://www.sqlalchemy.org/trac/ticket/1511)
...
- somewhat better support for % signs in table/column names;
  ...
  References: [#1279](https://www.sqlalchemy.org/trac/ticket/1279)
- Inserting NULL into a primary key + foreign key column
  ...
  sequence.
  References: [#1516](https://www.sqlalchemy.org/trac/ticket/1516)
...
- postgresql dialect can properly detect pg “devel” version
  ...
  References: [#1636](https://www.sqlalchemy.org/trac/ticket/1636)
- The psycopg2 now respects the statement option
  ...
  connection.
  References: [#1619](https://www.sqlalchemy.org/trac/ticket/1619)
...
- a column of type TIMESTAMP now defaults to NULL if
  ...
  References: [#1539](https://www.sqlalchemy.org/trac/ticket/1539)
...
- Table() supports a keyword argument “sqlite_autoincrement”, which
  ...
  References: [#1016](https://www.sqlalchemy.org/trac/ticket/1016)
...
- added native INTERVAL type to the dialect.  This supports
  ...
  References: [#1467](https://www.sqlalchemy.org/trac/ticket/1467)
...
- the Oracle dialect now features NUMBER which intends
  ...
  parameters.
  References: [#885](https://www.sqlalchemy.org/trac/ticket/885)
...
- using types.BigInteger with Oracle will generate
  NUMBER(19)
  References: [#1125](https://www.sqlalchemy.org/trac/ticket/1125)
...
- For the full set of feature descriptions, see
  [https://docs.sqlalchemy.org/en/latest/changelog/migration_06.html](https://docs.sqlalchemy.org/en/latest/changelog/migration_06.html) .
...
- transaction isolation level may be specified with
  ...
  References: [#443](https://www.sqlalchemy.org/trac/ticket/443)
...
- fixed the import for entrypoint-driven dialects to
  ...
  error status.
  References: [#1630](https://www.sqlalchemy.org/trac/ticket/1630)
...
- ResultProxy internals have been overhauled to greatly reduce
  ...
  improvement !
  References: [#1586](https://www.sqlalchemy.org/trac/ticket/1586)
...
- setting echo=False on create_engine() now sets the loglevel
  ...
  References: [#1554](https://www.sqlalchemy.org/trac/ticket/1554)
...
- All pyodbc-dialects now support extra pyodbc-specific
  ...
  References: [#1621](https://www.sqlalchemy.org/trac/ticket/1621)
...
- types.Binary is renamed to types.LargeBinary, it only
  ...
  References: [#1664](https://www.sqlalchemy.org/trac/ticket/1664)
...
- Added a new Enum generic type. Enum is a schema-aware object
  ...
  References: [#1109](https://www.sqlalchemy.org/trac/ticket/1109), [#1511](https://www.sqlalchemy.org/trac/ticket/1511)
...
- The Boolean type, when used on a backend that doesn’t
  ...
  References: [#1589](https://www.sqlalchemy.org/trac/ticket/1589)
...
- The signature of the proxy_factory callable passed to
  ...
  References: [#1259](https://www.sqlalchemy.org/trac/ticket/1259)
- association_proxy now has basic comparator methods .any(),
  .has(), .contains(), ==, !=, thanks to Scott Torborg.
  References: [#1372](https://www.sqlalchemy.org/trac/ticket/1372)
