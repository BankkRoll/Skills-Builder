...
[Guides](https://nextjs.org/docs/pages/guides)[Testing](https://nextjs.org/docs/pages/guides/testing)JestYou are currently viewing the documentation for Pages Router.
...
[Guides](https://nextjs.org/docs/pages/guides)[Testing](https://nextjs.org/docs/pages/guides/testing)PlaywrightYou are currently viewing the documentation for Pages Router.
...
[Guides](https://nextjs.org/docs/pages/guides)[Testing](https://nextjs.org/docs/pages/guides/testing)VitestYou are currently viewing the documentation for Pages Router.
...
__tests__/index.test.tsxJavaScriptTypeScript
...
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)TestingYou are currently viewing the documentation for Pages Router.
...
[CypressLearn how to set up Next.js with Cypress for End-to-End (E2E) and Component Testing.](https://nextjs.org/docs/pages/guides/testing/cypress)[JestLearn how to set up Next.js with Jest for Unit Testing.](https://nextjs.org/docs/pages/guides/testing/jest)[PlaywrightLearn how to set up Next.js with Playwright for End-to-End (E2E) and Integration testing.](https://nextjs.org/docs/pages/guides/testing/playwright)[VitestLearn how to set up Next.js with Vitest and React Testing Library - two popular unit testing libraries.](https://nextjs.org/docs/pages/guides/testing/vitest)
...
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)Third Party LibrariesYou are currently viewing the documentation for Pages Router.
...
[Guides](https://nextjs.org/docs/pages/guides)[Upgrading](https://nextjs.org/docs/pages/guides/upgrading)CodemodsYou are currently viewing the documentation for Pages Router.
...
[Guides](https://nextjs.org/docs/pages/guides)[Upgrading](https://nextjs.org/docs/pages/guides/upgrading)Version 10You are currently viewing the documentation for Pages Router.
