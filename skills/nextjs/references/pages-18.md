...
[Guides](https://nextjs.org/docs/pages/guides)[Migrating](https://nextjs.org/docs/pages/guides/migrating)Create React AppYou are currently viewing the documentation for Pages Router.
...
[Guides](https://nextjs.org/docs/pages/guides)[Migrating](https://nextjs.org/docs/pages/guides/migrating)ViteYou are currently viewing the documentation for Pages Router.
...
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)MigratingYou are currently viewing the documentation for Pages Router.

# Migrating

Last updated  April 15, 2025[App RouterLearn how to upgrade your existing Next.js application from the Pages Router to the App Router.](https://nextjs.org/docs/pages/guides/migrating/app-router-migration)[Create React AppLearn how to migrate your existing React application from Create React App to Next.js.](https://nextjs.org/docs/pages/guides/migrating/from-create-react-app)[ViteLearn how to migrate your existing React application from Vite to Next.js.](https://nextjs.org/docs/pages/guides/migrating/from-vite)
...
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)Multi-ZonesYou are currently viewing the documentation for Pages Router.

# How to build micro-frontends using multi-zones and Next.js

Last updated  April 16, 2025 Examples
