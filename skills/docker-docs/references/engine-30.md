...
A migration is performed the first time `docker` is run, and can take a significant amount of time depending on the number of images present. Refer to this page on the wiki for more information: [https://github.com/docker/docker/wiki/Engine-v1.10.0-content-addressability-migration](https://github.com/docker/docker/wiki/Engine-v1.10.0-content-addressability-migration)
We also released a cool migration utility that enables you to perform the migration before updating to reduce downtime.
Engine 1.10 migrator can be found on Docker Hub: [https://hub.docker.com/r/docker/v1.10-migrator/](https://hub.docker.com/r/docker/v1.10-migrator/)
...
- Use content-addressable storage for images and layers [#17924](https://github.com/docker/docker/pull/17924)
  ...
  For more information: [https://github.com/docker/docker/wiki/Engine-v1.10.0-content-addressability-migration](https://github.com/docker/docker/wiki/Engine-v1.10.0-content-addressability-migration)
