...
> [has been deprecated](https://docs.docker.com/engine/deprecated/#device-mapper-storage-driver),
...
## Configure Docker with thedevicemapperstorage driver

Before following these procedures, you must first meet all the
[prerequisites](#prerequisites).

### Configureloop-lvmmode for testing
...
| --- | --- | --- | --- | --- |
| dm.directlvm_device | The path to the block device to configure fordirect-lvm. | Yes |  | dm.directlvm_device="/dev/xvdf" |
...
| dm.directlvm_device_force | Whether to format the block device even if a filesystem already exists on it. If set tofalseand a filesystem is present, an error is logged and the filesystem is left intact. | No | false | dm.directlvm_device_force=true |
...
### Activate thedevicemapperafter reboot
...
## How thedevicemapperstorage driver works
...
![Ubuntu and busybox image layers](https://docs.docker.com/engine/storage/drivers/images/two_dm_container.webp)  ![Ubuntu and busybox image layers](https://docs.docker.com/engine/storage/drivers/images/two_dm_container.webp)

## How container reads and writes work withdevicemapper
...
![Reading a block with devicemapper](https://docs.docker.com/engine/storage/drivers/images/dm_container.webp)  ![Reading a block with devicemapper](https://docs.docker.com/engine/storage/drivers/images/dm_container.webp)
...
- **allocate-on demandperformance impact**:
...
- **Usedirect-lvm**: The `loop-lvm` mode is not performant and should never
