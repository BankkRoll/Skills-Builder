...
- [Multi-platform support fordocker image ls](#multi-platform-support-for-docker-image-ls)
...
![device-code-login](https://i.imgur.com/GRGjSjV.gif)Device code login ![device-code-login](https://i.imgur.com/GRGjSjV.gif)

To use the old method, use `docker login -u <username>`.

##### Multi-platform support fordocker image ls
