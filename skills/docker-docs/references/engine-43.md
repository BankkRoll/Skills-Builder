...
- On Windows, we recommend enabling
  [BitLocker](https://technet.microsoft.com/en-us/library/cc732774%28v=ws.11%29.aspx)
...
## Read more aboutdocker secretcommands
...
- [--secret-addand--secret-rm](https://docs.docker.com/reference/cli/docker/service/update/#secret-add) flags for `docker service update`
