...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_3_1)[Python 3.10+ - non-Annotated](#__tabbed_3_2)[Python 3.9+ - non-Annotated](#__tabbed_3_3)
...
- `Field(primary_key=True)` tells SQLModel that the `id` is the **primary key** in the SQL database (you can learn more about SQL primary keys in the SQLModel docs).
  **Note:** We use `int | None` for the primary key field so that in Python code we can *create an object without anid* (`id=None`), assuming the database will *generate it when saving*. SQLModel understands that the database will provide the `id` and *defines the column as a non-nullINTEGER* in the database schema. See [SQLModel docs on primary keys](https://sqlmodel.tiangolo.com/tutorial/create-db-and-table/#primary-key-id) for details.
...
You would have **one singleengineobject** for all your code to connect to the same database.
...
Don't worry, with the way the code is structured, we'll make sure we use **a single SQLModelsessionper request** later, this is actually what the `check_same_thread` is trying to achieve.
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_8_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_9_1)[Python 3.10+ - non-Annotated](#__tabbed_9_2)[Python 3.9+ - non-Annotated](#__tabbed_9_3)
...
A **Session** is what stores the **objects in memory** and keeps track of any changes needed in the data, then it **uses theengine** to communicate with the database.
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_12_1)[Python 3.10+ - non-Annotated](#__tabbed_12_2)[Python 3.9+ - non-Annotated](#__tabbed_12_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_14_1)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_17_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_18_1)[Python 3.10+ - non-Annotated](#__tabbed_18_2)[Python 3.9+ - non-Annotated](#__tabbed_18_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_20_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_21_1)[Python 3.10+ - non-Annotated](#__tabbed_21_2)[Python 3.9+ - non-Annotated](#__tabbed_21_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_23_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_24_1)[Python 3.10+ - non-Annotated](#__tabbed_24_2)[Python 3.9+ - non-Annotated](#__tabbed_24_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_26_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_27_1)[Python 3.10+ - non-Annotated](#__tabbed_27_2)[Python 3.9+ - non-Annotated](#__tabbed_27_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_29_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_30_1)[Python 3.10+ - non-Annotated](#__tabbed_30_2)[Python 3.9+ - non-Annotated](#__tabbed_30_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_32_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_33_1)[Python 3.10+ - non-Annotated](#__tabbed_33_2)[Python 3.9+ - non-Annotated](#__tabbed_33_3)
...
#### HeroPublic- the publicdata model¶
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_35_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_36_1)[Python 3.10+ - non-Annotated](#__tabbed_36_2)[Python 3.9+ - non-Annotated](#__tabbed_36_3)
...
#### HeroCreate- thedata modelto create a hero¶
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_38_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_39_1)[Python 3.10+ - non-Annotated](#__tabbed_39_2)[Python 3.9+ - non-Annotated](#__tabbed_39_3)
...
#### HeroUpdate- thedata modelto update a hero¶
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_41_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_42_1)[Python 3.10+ - non-Annotated](#__tabbed_42_2)[Python 3.9+ - non-Annotated](#__tabbed_42_3)
...
### Create withHeroCreateand return aHeroPublic¶
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_44_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_45_1)[Python 3.10+ - non-Annotated](#__tabbed_45_2)[Python 3.9+ - non-Annotated](#__tabbed_45_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_47_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_48_1)[Python 3.10+ - non-Annotated](#__tabbed_48_2)[Python 3.9+ - non-Annotated](#__tabbed_48_3)
...
### Read One Hero withHeroPublic¶

We can **read** a single hero:

 [Python 3.10+](#__tabbed_49_1)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_50_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_51_1)[Python 3.10+ - non-Annotated](#__tabbed_51_2)[Python 3.9+ - non-Annotated](#__tabbed_51_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_53_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_54_1)[Python 3.10+ - non-Annotated](#__tabbed_54_2)[Python 3.9+ - non-Annotated](#__tabbed_54_3)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_56_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_57_1)[Python 3.10+ - non-Annotated](#__tabbed_57_2)[Python 3.9+ - non-Annotated](#__tabbed_57_3)
...
You can learn a lot more at the **SQLModel** docs, there's a longer mini [tutorial on using SQLModel withFastAPI](https://sqlmodel.tiangolo.com/tutorial/fastapi/). 🚀
