...
## UseAnnotatedin the type for theqparameter¶
...
We had this type annotation:
 ...
 [Python 3.10+](#__tabbed_5_1)[Python 3.9+](#__tabbed_5_2)
...
What we will do is wrap that with `Annotated`, so it becomes:
 ...
 [Python 3.10+](#__tabbed_6_1)[Python 3.9+](#__tabbed_6_2)
...
## AddQuerytoAnnotatedin theqparameter¶
...
## Alternative (old):Queryas the default value¶
...
This is how you would use `Query()` as the default value of your function parameter, setting the parameter `max_length` to 50:
 ...
 [Python 3.10+ - non-Annotated](#__tabbed_9_1)
...
```
     ...
     🤓 Other versions and variants [Python 3.10+](#__tabbed_10_1)[Python 3.9+](#__tabbed_10_2)[Python 3.9+ - non-Annotated](#__tabbed_10_3)
...
### Queryas the default value or inAnnotated¶
...
### Advantages ofAnnotated¶

**UsingAnnotatedis recommended** instead of the default value in function parameters, it is **better** for multiple reasons. 🤓
...
```
     ...
     🤓 Other versions and variants [Python 3.9+](#__tabbed_14_1)[Python 3.10+ - non-Annotated](#__tabbed_14_2)[Python 3.9+ - non-Annotated](#__tabbed_14_3)
...
```
     ...
     🤓 Other versions and variants [Python 3.9+](#__tabbed_22_1)[Python 3.10+ - non-Annotated](#__tabbed_22_2)[Python 3.9+ - non-Annotated](#__tabbed_22_3)
...
```
     ...
     🤓 Other versions and variants [Python 3.9+ - non-Annotated](#__tabbed_24_1)
...
```
     ...
     🤓 Other versions and variants [Python 3.9+ - non-Annotated](#__tabbed_26_1)
...
```
     ...
     🤓 Other versions and variants [Python 3.9+](#__tabbed_28_1)[Python 3.10+ - non-Annotated](#__tabbed_28_2)[Python 3.9+ - non-Annotated](#__tabbed_28_3)
...
```
     ...
     🤓 Other versions and variants [Python 3.9+](#__tabbed_32_1)[Python 3.10+ - non-Annotated](#__tabbed_32_2)[Python 3.9+ - non-Annotated](#__tabbed_32_3)
...
```
     ...
     🤓 Other versions and variants [Python 3.9+](#__tabbed_34_1)[Python 3.10+ - non-Annotated](#__tabbed_34_2)[Python 3.9+ - non-Annotated](#__tabbed_34_3)
...
You can achieve that using [Pydantic'sAfterValidator](https://docs.pydantic.dev/latest/concepts/validators/#field-after-validator) inside of `Annotated`.
...
```
     ...
     🤓 Other versions and variants [Python 3.9+](#__tabbed_38_1)
...
The important point is just using **AfterValidatorwith a function insideAnnotated**. Feel free to skip this part. 🤸
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_40_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_41_1)
...
```
     ...
     👀 Full file preview [Python 3.10+](#__tabbed_43_1)
...
```
      ...
      🤓 Other versions and variants [Python 3.9+](#__tabbed_44_1)
