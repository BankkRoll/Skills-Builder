...
## Code to get theusernameandpassword¶
...
*Pass the keys and values of theuser_dictdirectly as key-value arguments, equivalent to:*
...
For a more complete explanation of `**user_dict` check back in [the documentation forExtra Models](https://fastapi.tiangolo.com/tutorial/extra-models/#about-user-in-dict).
