...
## Declare scopes inpath operationsand dependencies¶
...
## Verify theusernameand data shape¶
...
```
     ...
     🤓 Other versions and variants [Python 3.9+](#__tabbed_16_1)[Python 3.10+ - non-Annotated](#__tabbed_16_2)[Python 3.9+ - non-Annotated](#__tabbed_16_3)
...
## Securityin decoratordependencies¶
