...
1. ![image](https://react.dev/images/docs/illustrations/i_render1.png)React executing the function
2. ![image](https://react.dev/images/docs/illustrations/i_render2.png)Calculating the snapshot
3. ![image](https://react.dev/images/docs/illustrations/i_render3.png)Updating the DOM tree
...
1. ![image](https://react.dev/images/docs/illustrations/i_state-snapshot1.png)You tell React to update the state
2. ![image](https://react.dev/images/docs/illustrations/i_state-snapshot2.png)React updates the state value
3. ![image](https://react.dev/images/docs/illustrations/i_state-snapshot3.png)React passes a snapshot of the state value into the component
...
**Setting state only changes it for thenextrender.** During the first render, `number` was `0`. This is why, in *that render’s* `onClick` handler, the value of `number` is still `0` even after `setNumber(number + 1)` was called:
