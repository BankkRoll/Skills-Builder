...
After the root has finished hydrating, you can call [root.render](#root-render) to update the root React component. **Unlike withcreateRoot, you don’t usually need to do this because the initial content was already rendered as HTML.**
