...
> Glossary • SvelteKit documentation
...
In SvelteKit, client-side rendering will be used by default, but you can turn off JavaScript with [thecsr = falsepage option](https://kit.svelte.dev/docs/page-options#csr).
...
In SvelteKit, pages will be hydrated by default, but you can turn off JavaScript with [thecsr = falsepage option](https://kit.svelte.dev/docs/page-options#csr).

## ISR

Incremental static regeneration (ISR) allows you to generate static pages on your site as visitors request those pages without redeploying. This may reduces build times compared to [SSG](#SSG) sites with a large number of pages. You can do [ISR withadapter-vercel](https://kit.svelte.dev/docs/adapter-vercel#Incremental-Static-Regeneration).
...
In SvelteKit, you can control prerendering with [theprerenderpage option](https://kit.svelte.dev/docs/page-options#prerender) and [prerenderconfig](https://kit.svelte.dev/docs/configuration#prerender) in `svelte.config.js`.

## PWA

A progressive web app (PWA) is an app that’s built using web APIs and technologies, but functions like a mobile or desktop app. Sites served as [PWAs can be installed](https://web.dev/learn/pwa/installation), allowing you to add a shortcut to the application on your launcher, home screen, or start menu. Many PWAs will utilize [service workers](https://kit.svelte.dev/docs/service-workers) to build offline capabilities.
...
In SvelteKit, client-side routing will be used by default, but you can skip it with [data-sveltekit-reload](https://kit.svelte.dev/docs/link-options#data-sveltekit-reload).
...
In SvelteKit, you can [build SPAs withadapter-static](https://kit.svelte.dev/docs/single-page-apps).
...
In SvelteKit, you can do static site generation by using [adapter-static](https://kit.svelte.dev/docs/adapter-static) or by configuring every page to be prerendered using [theprerenderpage option](https://kit.svelte.dev/docs/page-options#prerender) or [prerenderconfig](https://kit.svelte.dev/docs/configuration#prerender) in `svelte.config.js`.
...
In SvelteKit, pages are server-side rendered by default. You can disable SSR with [thessrpage option](https://kit.svelte.dev/docs/page-options#ssr).

[Edit this page on GitHub](https://github.com/sveltejs/kit/edit/main/documentation/docs/60-appendix/60-glossary.md) [[llms.txt](https://kit.svelte.dev/docs/kit/glossary/llms.txt)]

 previous next [[Additional resources](https://kit.svelte.dev/docs/kit/additional-resources)] [[@sveltejs/kit](https://kit.svelte.dev/docs/kit/@sveltejs-kit)]
