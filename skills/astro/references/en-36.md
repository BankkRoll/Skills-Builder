...
Need to upgrade an older project to v1? See our [older migration guide](https://docs.astro.build/en/guides/upgrade-to/v1/).
...
Check that both your development environment and your deployment environment are using **Node16.12.0or later**.
...
2. Check your [deployment environment’s](https://docs.astro.build/en/guides/deploy/) own documentation to verify that they support Node 16.
...
### Changed:Astro.sitetrailing slash
...
You can control this location with the [newbuild.assetsconfiguration option](https://docs.astro.build/en/reference/configuration-reference/#buildassets).
...
#### Replaced:extendPluginschanged toextendMarkdownConfig
...
Astro v2.0 requires a `svelte.config.js` file in your project if you are using [the@astrojs/svelteintegration](https://docs.astro.build/en/guides/integrations-guide/svelte/). This is needed to provide IDE autocompletion.
